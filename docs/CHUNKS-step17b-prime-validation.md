...
`./scrip --dump-sm --run test/icon/palindrome.icn` shows:
...
For Raku: `SCRIP_PROC_ENTRY_PCS=1 ./scrip --run test/raku/rk_given.raku`
...
`args[1] | 6` (E_ALTERNATE, kind 54) under `--run`, printing
