...
After these three changes, `--run /path/to/factorial.icn` should:
...
```bash
# Force --run on Icon and confirm SM_BB_PUMP shape
./scrip --run --dump-sm /home/claude/corpus/programs/icon/rung01_paper_mult.icn
