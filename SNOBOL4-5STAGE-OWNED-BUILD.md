...
- [ ] **B6 STITCH-CAT** — nearest-left-resume β wiring (`P = 'a' LEN(2)`). **FULL RECIPE (derived 2026-06-08 from the proven `wire_seq` lower.c:54-84 + the B3 `bb_pattern_alt.cpp` 59-line stitch precedent; oracle targets probed):**
