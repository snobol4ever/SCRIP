...
scrip:
	...
	$(CXX) $(CXXRT) -c $(SRC)/emitter/BB_templates/bb_repalt.cpp       -o $(OBJ)/bb_repalt.o
	...
	$(CXX) $(CXXRT) -c $(SRC)/emitter/BB_templates/bb_det_type_test.cpp    -o $(OBJ)/bb_det_type_test.o
	$(CXX) $(CXXRT) -c $(SRC)/emitter/BB_templates/bb_det_functor.cpp      -o $(OBJ)/bb_det_functor.o
	$(CXX) $(CXXRT) -c $(SRC)/emitter/BB_templates/bb_det_arg.cpp          -o $(OBJ)/bb_det_arg.o
	$(CXX) $(CXXRT) -c $(SRC)/emitter/BB_templates/bb_det_univ.cpp         -o $(OBJ)/bb_det_univ.o
	$(CXX) $(CXXRT) -c $(SRC)/emitter/BB_templates/bb_det_format.cpp       -o $(OBJ)/bb_det_format.o
	$(CXX) $(CXXRT) -c $(SRC)/emitter/BB_templates/bb_det_succ_plus.cpp    -o $(OBJ)/bb_det_succ_plus.o
	$(CXX) $(CXXRT) -c $(SRC)/emitter/BB_templates/bb_det_atom_op.cpp      -o $(OBJ)/bb_det_atom_op.o
	...
	$(CXX) $(CXXRT) -c $(SRC)/emitter/BB_templates/bb_det_retract.cpp      -o $(OBJ)/bb_det_retract.o
	$(CXX) $(CXXRT) -c $(SRC)/emitter/BB_templates/bb_det_abolish.cpp      -o $(OBJ)/bb_det_abolish.o
	$(CXX) $(CXXRT) -c $(SRC)/emitter/BB_templates/bb_det_assertz.cpp      -o $(OBJ)/bb_det_assertz.o
	$(CXX) $(CXXRT) -c $(SRC)/emitter/BB_templates/bb_cell_dyniter.cpp     -o $(OBJ)/bb_cell_dyniter.o
	...
	$(CXX) $(CXXRT) -c $(SRC)/emitter/BB_templates/bb_pattern_capture.cpp -o $(OBJ)/bb_pattern_capture.o
