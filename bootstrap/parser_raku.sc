...
std_cheat_heredoc = FAIL @rk_cur *rk_star(ANY(rk_h), FAIL, 0) ANY(';}') @rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_la(FENCE(((cr nl | nl | cr)) | ('#'))) *g_ws @rk_cur *rk_marker('endstmt');
...
g_statement_control__use = (FENCE((('DOC' @rk_cur *rk_plus(ANY(rk_h), FAIL, 0))) | epsilon)) 'use' *g_ws (FENCE((*g_version) | (*g_module_name (FENCE((*g_spacey *g_arglist FENCE((*std_cheat_heredoc) | epsilon) epsilon epsilon epsilon) | (epsilon)))))) (FENCE((FAIL *g_eat_terminator *g_statementlist) | (epsilon))) *g_ws;
...
g_infix__lambda = @rk_cur *rk_la(FENCE(('{') | (@rk_cur *rk_mem('g_lambda', '')))) epsilon (FENCE((epsilon) | (FAIL)));
...
g_colonpair = ':' (FENCE(('!' (FENCE((*g_identifier) | (FAIL))) FENCE(((ANY('[(<{'))) | epsilon)) | ((@rk_cur *rk_plus(ANY(rk_digit), FAIL, 0)) *g_identifier FENCE(((@rk_cur *rk_la(ANY('[(<{')) epsilon *g_circumfix)) | epsilon) epsilon) | (*g_identifier (FENCE((FENCE((*g_unsp) | epsilon) *g_coloncircumfix) | (epsilon)))) | ('(' *g_fakesignature ')') | (*g_coloncircumfix) | (*g_colonpair_variable)));
...
g_desigilname = (FENCE((@rk_cur *rk_la(*g_sigil *g_sigil) *g_variable) | (@rk_cur *rk_la(*g_sigil) FENCE(((FAIL FAIL)) | epsilon) *g_variable) | (*g_longname)));
g_desigilmetaname = ((*g_identifier));
g_sigillessx2dvariable = FAIL;
g_variable = (FENCE(('&[' *g_infixish ']') | (*g_sigil (FENCE((('.^') *g_desigilmetaname) | (FENCE((*g_twigil) | epsilon) *g_desigilname))) FENCE(((FAIL)) | epsilon)) | (*g_special_variable) | (*g_sigil (@rk_cur *rk_plus(ANY(rk_digit), FAIL, 0)) FENCE(((FAIL FAIL)) | epsilon)) | (*g_sigil @rk_cur *rk_la(ANY('<')) *g_postcircumfix FENCE(((FAIL FAIL)) | epsilon)) | (@rk_cur *rk_la(*g_sigil @rk_cur *rk_la(ANY('([{'))) @rk_cur *rk_nla(*std_RESTRICTED) epsilon *g_contextualizer) | (('$') (ANY('/_!¢'))) | (*g_sigillessx2dvariable) | (*g_sigil epsilon @rk_cur *rk_marker('baresigil')))) FENCE(((epsilon (FENCE((*g_unsp) | ('\') | (epsilon))) @rk_cur *rk_la(ANY('(:')) @rk_cur *rk_nla(*std_RESTRICTED) (FENCE((':' @rk_cur *rk_la(FENCE((ANY(rk_s)) | ('{'))) epsilon *g_arglist) | ('(' *g_arglist ')'))))) | epsilon);
g_contextualizer = FENCE(((FAIL FAIL)) | epsilon) (FENCE((*g_sigil '(' *g_sequence ')') | (*g_sigil @rk_cur *rk_la(ANY('[{')) *g_circumfix)));
g_sigil = ANY('$@%&');
...
g_term__rand = epsilon 'rand' @rk_cur *rk_rwb() FENCE(((@rk_cur *rk_la(FENCE(('(') | epsilon) @rk_cur *rk_star(ANY(rk_h), FAIL, 0) (FENCE((ANY(rk_digit)) | ('$')))) FAIL)) | epsilon) FENCE(((@rk_cur *rk_la('()') FAIL)) | epsilon) *g_end_keyword;
g_term__x2ex2ex2e = (FENCE(('...') | ('…'))) FENCE(((@rk_cur *rk_lb(',' @rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_plus(ANY('.…'), FAIL, 0)))) | epsilon) FENCE(((FAIL @rk_cur *rk_lb(ANY(rk_alpha ']') @rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_plus(ANY('.…'), FAIL, 0)))) | epsilon) *g_args;
g_term__x3fx3fx3f = '???' *g_args;
g_term__x21x21x21 = '!!!' *g_args;
g_term__identifier = *g_identifier epsilon (FENCE((@rk_cur *rk_la(FENCE((*g_unsp) | epsilon) '(')) | ('\' @rk_cur *rk_la('(')))) *g_args;
...
g_rad_number = ':' (@rk_cur *rk_plus(ANY(rk_digit), FAIL, 0)) FENCE((*g_unsp) | epsilon) (FENCE(('<' (FENCE(((FENCE(('0x' epsilon) | ('0o' epsilon) | ('0d' epsilon) | ('0b' epsilon)))) | epsilon)) *rk_m_rad_digits (FENCE((('.' *rk_m_rad_digits)) | epsilon)) (FENCE((('*' *g_radint '**' *g_radint)) | epsilon)) '>') | (@rk_cur *rk_la(ANY('[')) *g_circumfix) | (@rk_cur *rk_la(ANY('(')) *g_circumfix) | (FAIL)));
g_radint = (*g_integer);
...
g_quote__Q = 'Q' (FENCE((*g_quote_mod *g_qok *g_ws @rk_cur *rk_star((*g_quotepair *g_ws), FAIL, 0) @rk_cur *rk_qscan('Q')) | (*g_qok *g_ws @rk_cur *rk_star((*g_quotepair *g_ws), FAIL, 0) @rk_cur *rk_qscan('Q'))));
g_quote__x2fnullx2f = FENCE((epsilon '/' @rk_cur *rk_star(ANY(rk_s), FAIL, 0) '/' FAIL) | (FAIL '/' @rk_cur *rk_plus(ANY(rk_s), FAIL, 0) '/' FAIL));
...
g_termish = (FENCE(((FENCE((@rk_cur *rk_plus(*g_prefixish, FAIL, 0) (FENCE((*g_arg_flat_nok *g_term) | (FAIL)))) | (*g_arg_flat_nok *g_term)))) | (epsilon @rk_cur *rk_la(*g_infixish)) | (FAIL))) (FENCE((FAIL (FENCE((FAIL (FENCE(((@rk_cur *rk_plus(*g_postfixish, FAIL, 0) FAIL)) | epsilon))) | (@rk_cur *rk_plus(*g_postfixish, FAIL, 0) FAIL)))) | (epsilon @rk_cur *rk_star(*g_postfixish, FAIL, 0))));
...
g_infixish = @rk_cur *rk_nla(@rk_cur *rk_mem('g_stdstopper', 'endstmt')) @rk_cur *rk_nla(@rk_cur *rk_mem('g_infixstopper', 'ws')) (FENCE((epsilon *g_colonpair *g_fake_infix) | ((FENCE(('[' *g_infixish ']') | (@rk_cur *rk_la('[&' FENCE((*g_twigil) | epsilon) (FENCE((ANY(rk_alpha)) | ('(')))) '[' *g_variable ']') | (*g_infix_circumfix_meta_operator) | (*g_infix_prefix_meta_operator) | (*g_infix) | (FAIL FAIL))) FENCE(((@rk_cur *rk_la('=') *g_infix_postfix_meta_operator)) | epsilon)))) epsilon;
g_fake_infix = epsilon;
g_infixstopper = (((@rk_cur *rk_la('!!') epsilon) | (@rk_cur *rk_la((('{') | (@rk_cur *rk_mem('g_lambda', '')))) @rk_cur *rk_marked('ws') epsilon)));
g_postfixish = @rk_cur *rk_nla(@rk_cur *rk_mem('g_stdstopper', 'endstmt')) @rk_cur *rk_postws() FENCE(((epsilon (FENCE((*g_unsp) | ('\'))))) | epsilon) (FENCE(((FENCE((('.' FENCE((*g_unsp) | epsilon))) | epsilon) *g_postfix_prefix_meta_operator FENCE((*g_unsp) | epsilon))) | epsilon)) (FENCE((*g_postfix) | ('.' @rk_cur *rk_la(NOTANY(rk_w)) *g_postfix) | (*g_postcircumfix) | ('.' @rk_cur *rk_la(ANY('[{<')) *g_postcircumfix) | (*g_dotty) | (*g_privop) | (FAIL (FENCE((@rk_cur *rk_la(ANY(rk_s)) FAIL) | (@rk_cur *rk_la(ANY(rk_alpha)) FAIL) | (FAIL))))));
...
g_infix__x3a = FAIL FENCE((*g_unsp) | epsilon) ':' @rk_cur *rk_la(FENCE((ANY(rk_s)) | (@rk_cur *rk_mem('g_terminator', '')) | (RPOS(0)))) epsilon (FENCE((FAIL) | (FAIL)));
...
g_pod_textcontent__regular = (@rk_cur *rk_star(ANY(rk_h), FAIL, 0)) FAIL @rk_cur *rk_plus((@rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_nla('=' ANY(rk_w)) *g_pod_string (FENCE((*g_pod_newline) | (RPOS(0))))), FAIL, 0);
...
g_pod_formatting_code = FAIL ANY('ABCDEFGHIJKLMNOPQRSTUVWXYZ') (FENCE((@rk_cur *rk_plus('<', FAIL, 0) @rk_cur *rk_nla(ANY('<'))) | ('«'))) FAIL FENCE(((epsilon @rk_cur *rk_star((@rk_cur *rk_nla(*rk_var_x24endtag) (FENCE((epsilon) | (@rk_cur *rk_nla(@rk_cur *rk_star(ANY(rk_s), FAIL, 0) '|')))) *g_pod_string_character), FAIL, 0))) | epsilon) FENCE(((FENCE((epsilon @rk_cur *rk_star(ANY(rk_s), FAIL, 0) '|' @rk_cur *rk_star(ANY(rk_s), FAIL, 0) @rk_cur *rk_plus((@rk_cur *rk_nla(*rk_var_x24endtag) LEN(1)), FAIL, 0)) | (epsilon @rk_cur *rk_star(ANY(rk_s), FAIL, 0) '|' @rk_cur *rk_star(ANY(rk_s), FAIL, 0) @rk_cur *rk_plus((@rk_cur *rk_plus((@rk_cur *rk_plus((@rk_cur *rk_nla(FENCE((*rk_var_x24endtag) | (ANY(',;')))) LEN(1)), FAIL, 0)), ',', 2)), ';', 2)) | (epsilon @rk_cur *rk_star(ANY(rk_s), FAIL, 0) '|' @rk_cur *rk_star(ANY(rk_s), FAIL, 0) @rk_cur *rk_plus((@rk_cur *rk_plus((@rk_cur *rk_nla(FENCE((*rk_var_x24endtag) | (';'))) LEN(1)), FAIL, 0)), ';', 2)) | (epsilon @rk_cur *rk_plus((FENCE((*g_integer) | (@rk_cur *rk_plus(ANY(rk_s 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'), FAIL, 0) @rk_cur *rk_nla(ANY('abcdefghijklmnopqrstuvwxyz'))) | (@rk_cur *rk_plus(ANY('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'), FAIL, 0)))), ';', 2))))) | epsilon) (FENCE((*rk_var_x24endtag) | (epsilon)));
