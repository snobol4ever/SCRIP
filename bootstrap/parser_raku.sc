...
ss3_stopper = @rk_cur *rk_ltm2((*rk_stop), (*rk_stop2));
...
std_herestop_stopper = @rk_cur *rk_bol() (@rk_cur *rk_star(ANY(rk_h), FAIL, 0)) *rk_delim @rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_eol() FENCE(((@rk_cur *rk_ltm2((cr (cr nl | nl | cr)), (ANY(rk_v))))) | epsilon);
std_cheat_heredoc = FAIL @rk_cur *rk_star(ANY(rk_h), FAIL, 0) ANY(';}') @rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_la(@rk_cur *rk_ltm2(((cr nl | nl | cr)), ('#'))) *g_ws @rk_cur *rk_marker('endstmt');
...
std_obsbrace = FAIL;
std_experimental = FENCE((FAIL) | (FAIL));
std_RESTRICTED = FENCE(((FAIL (FENCE((RPOS(0)) | (FAIL))))) | epsilon) FAIL;
g_apostrophe = ANY("'-");
g_identifier = *rk_ident @rk_cur *rk_star((*g_apostrophe *rk_ident), FAIL, 0);
g_name = (@rk_cur *rk_ltm2((*g_identifier @rk_cur *rk_star(@rk_cur *rk_mem('g_morename', ''), FAIL, 0)), (@rk_cur *rk_plus(@rk_cur *rk_mem('g_morename', ''), FAIL, 0))));
g_morename = '::' FENCE(((FENCE((@rk_cur *rk_la(@rk_cur *rk_ltm2(('('), (ANY(rk_alpha)))) (@rk_cur *rk_ltm2((*g_identifier), ('(' (*g_ws *rk_EXPR) ')')))) | (@rk_cur *rk_la('::') FAIL) | ((*g_sigil *g_identifier))))) | epsilon);
...
g_defterm = *g_identifier (@rk_cur *rk_ltm2((@rk_cur *rk_plus(*g_colonpair, FAIL, 0)), (epsilon)));
...
g_kok = *g_end_keyword (FENCE((@rk_cur *rk_la(ANY(rk_s '#')) *g_ws) | (FAIL)));
g_tok = *g_end_keyword epsilon;
g_ENDSTMT = FENCE(((@rk_cur *rk_ltm2((@rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_eol() *g_ws @rk_cur *rk_marker('endstmt')), (FENCE((*g_unv) | epsilon) @rk_cur *rk_eol() *g_ws @rk_cur *rk_marker('endstmt'))))) | epsilon);
g__ws = @rk_cur *rk_nla(*rk_ww) @rk_cur *rk_star((@rk_cur *rk_ltm2(((FENCE((cr (cr nl | nl | cr)) | (ANY(rk_v)))) epsilon), (@rk_cur *rk_ltm2((*g_unv), (@rk_cur *rk_ltm2((*g_unsp), (*g_vcsx2dconflict))))))), FAIL, 0) @rk_cur *rk_marker('ws');
g_unsp = '\' @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), ('#'))) @rk_cur *rk_star((@rk_cur *rk_ltm2((*g_vws), (@rk_cur *rk_ltm2((*g_unv), (*g_unsp))))), FAIL, 0);
g_vws = @rk_cur *rk_plus(((@rk_cur *rk_ltm2((ANY(rk_v)), (*g_vcsx2dconflict)))), FAIL, 0);
g_vcsx2dconflict = (@rk_cur *rk_ltm2(('<<<<<<<' @rk_cur *rk_la((@rk_cur *rk_star(LEN(1), FAIL, 0) ANY(rk_v) '=======') @rk_cur *rk_star(LEN(1), FAIL, 0) ANY(rk_v) '>>>>>>>') epsilon @rk_cur *rk_star(NOTANY(rk_v), FAIL, 0) ANY(rk_v)), ('=======' @rk_cur *rk_star(LEN(1), FAIL, 0) ANY(rk_v) '>>>>>>>' @rk_cur *rk_star(NOTANY(rk_v), FAIL, 0) ANY(rk_v))));
g_unv = (@rk_cur *rk_ltm2((@rk_cur *rk_plus(ANY(rk_h), FAIL, 0)), (@rk_cur *rk_ltm2((@rk_cur *rk_star(ANY(rk_h), FAIL, 0) *g_comment), (@rk_cur *rk_la(@rk_cur *rk_star(ANY(rk_h), FAIL, 0) '=' (@rk_cur *rk_ltm2((ANY(rk_w)), ('\')))) @rk_cur *rk_bol() *g_pod_content_toplevel)))));
g_install_doc_phaser = epsilon;
g_vnum = @rk_cur *rk_ltm2((@rk_cur *rk_plus(ANY(rk_w), FAIL, 0)), ('*'));
g_version = @rk_cur *rk_la('v' @rk_cur *rk_plus(ANY(rk_digit), FAIL, 0) @rk_cur *rk_star(ANY(rk_w), FAIL, 0) (FENCE(('.' ANY(rk_digit)) | (epsilon)))) 'v' (@rk_cur *rk_plus(*g_vnum, '.', 1) FENCE(('+') | epsilon)) @rk_cur *rk_nla(@rk_cur *rk_ltm2(('-'), ("'")));
g_comp_unit = FENCE((*g_bom) | epsilon) *g_langx2dversion epsilon *g_statementlist epsilon (FENCE((RPOS(0)) | (FAIL))) epsilon epsilon;
g_langx2dversion = (FENCE((FENCE((*g_ws) | epsilon) *g_ws 'use' *g_ws *g_version *g_ws (FENCE((epsilon *g_ws) | (epsilon))) *g_ws) | (epsilon))) *g_ws;
g_statementlist = *g_ws *g_ws epsilon *g_ws (@rk_cur *rk_ltm2((RPOS(0) *g_ws), (@rk_cur *rk_ltm2((@rk_cur *rk_la(ANY(')]}')) *g_ws), (@rk_cur *rk_star((*g_statement *g_ws *g_eat_terminator *g_ws), FAIL, 0) *g_ws))))) *g_ws epsilon *g_ws epsilon *g_ws;
g_semilist = epsilon *g_ws (@rk_cur *rk_ltm2((@rk_cur *rk_la(ANY(')]}') *g_ws) *g_ws), (@rk_cur *rk_star((*g_statement *g_eat_terminator *g_ws), FAIL, 0) *g_ws))) *g_ws;
g_sequence = epsilon *g_ws (@rk_cur *rk_ltm2((@rk_cur *rk_la(ANY(')]}') *g_ws) *g_ws), (@rk_cur *rk_star((*g_statement *g_eat_terminator *g_ws), FAIL, 0) *g_ws))) *g_ws;
g_label = *g_identifier ':' @rk_cur *rk_la(ANY(rk_s)) *g_ws;
g_statement = epsilon @rk_cur *rk_nla(@rk_cur *rk_ltm2((ANY('])}')), (RPOS(0)))) @rk_cur *rk_nla(*std_stopper) epsilon (@rk_cur *rk_ltm2((*g_label *g_statement), (@rk_cur *rk_ltm2((*g_statement_control), (@rk_cur *rk_ltm2((*rk_EXPR FENCE(((FENCE((@rk_cur *rk_marked('endstmt')) | (*g_ws *g_statement_mod_cond FENCE((*g_statement_mod_loop) | epsilon)) | (*g_ws *g_statement_mod_loop)))) | epsilon)), (@rk_cur *rk_ltm2((@rk_cur *rk_la(ANY(';'))), (@rk_cur *rk_ltm2((@rk_cur *rk_la(*std_stopper)), (FAIL)))))))))));
g_eat_terminator = FENCE((';') | (@rk_cur *rk_marked('endstmt') *g_ws) | (@rk_cur *rk_la(@rk_cur *rk_ltm2((')'), (@rk_cur *rk_ltm2((']'), ('}')))))) | (RPOS(0)) | (@rk_cur *rk_la(*std_stopper)) | (@rk_cur *rk_la((@rk_cur *rk_ltm2(('i' 'f'), (@rk_cur *rk_ltm2(('w' 'h' 'i' 'l' 'e'), (@rk_cur *rk_ltm2(('f' 'o' 'r'), (@rk_cur *rk_ltm2(('l' 'o' 'o' 'p'), (@rk_cur *rk_ltm2(('r' 'e' 'p' 'e' 'a' 't'), (@rk_cur *rk_ltm2(('g' 'i' 'v' 'e' 'n'), ('w' 'h' 'e' 'n'))))))))))))) @rk_cur *rk_rwb())) | (epsilon));
...
g_unitstart = epsilon;
g_you_are_here = FENCE((FAIL) | (epsilon));
g_newpad = epsilon;
g_newthunk = epsilon;
g_finishpad = epsilon;
g_bom = 'x' 'F' 'E' 'F' 'F';
...
g_terminator__ang = @rk_cur *rk_la(ANY('>')) FAIL;
...
g_terminator__arrow = '-->';
g_stdstopper = (FENCE((@rk_cur *rk_marked('endstmt') epsilon) | ((@rk_cur *rk_ltm2((@rk_cur *rk_la(@rk_cur *rk_mem('g_terminator', ''))), (RPOS(0)))))));
g_statement_control = FENCE(*h35_proto_statement_control | *h36_proto_statement_control | *h37_proto_statement_control);
g_statement_control__if = (@rk_cur *rk_ltm2(('i' 'f'), ('w' 'i' 't' 'h'))) *g_kok *g_ws *g_xblock *g_ws @rk_cur *rk_star(((@rk_cur *rk_ltm2(('else' @rk_cur *rk_star(ANY(rk_h), FAIL, 0) 'if' *g_ws FAIL *g_ws), (@rk_cur *rk_ltm2(('elif' *g_ws), (@rk_cur *rk_ltm2(('elsif' *g_ws *g_xblock *g_ws), ('orwith' *g_ws *g_xblock *g_ws))))))) *g_ws), FAIL, 0) *g_ws FENCE((('else' *g_ws *g_pblock *g_ws)) | epsilon) *g_ws;
g_statement_control__unless = 'unless' *g_kok *g_ws *g_xblock *g_ws (FENCE((@rk_cur *rk_nla((@rk_cur *rk_ltm2(('e' 'l' 's' (@rk_cur *rk_ltm2(('e'), ('i' 'f')))), ('o' 'r' 'w' 'i' 't' 'h'))) @rk_cur *rk_rwb() *g_ws) *g_ws) | ((@rk_cur *rk_ltm2(('e' 'l' 's' (@rk_cur *rk_ltm2(('e'), ('i' 'f')))), ('o' 'r' 'w' 'i' 't' 'h'))) @rk_cur *rk_rwb() *g_ws FAIL *g_ws))) *g_ws;
g_statement_control__without = 'without' *g_kok *g_ws *g_xblock *g_ws (FENCE((@rk_cur *rk_nla((@rk_cur *rk_ltm2(('e' 'l' 's' (@rk_cur *rk_ltm2(('e'), ('i' 'f')))), ('o' 'r' 'w' 'i' 't' 'h'))) @rk_cur *rk_rwb() *g_ws) *g_ws) | ((@rk_cur *rk_ltm2(('e' 'l' 's' (@rk_cur *rk_ltm2(('e'), ('i' 'f')))), ('o' 'r' 'w' 'i' 't' 'h'))) @rk_cur *rk_rwb() *g_ws FAIL *g_ws))) *g_ws;
g_statement_control__while = (@rk_cur *rk_ltm2(('w' 'h' 'i' 'l' 'e'), ('u' 'n' 't' 'i' 'l'))) *g_kok *g_ws *g_xblock *g_ws;
g_statement_control__repeat = 'repeat' *g_kok *g_ws (@rk_cur *rk_ltm2(((@rk_cur *rk_ltm2(('w' 'h' 'i' 'l' 'e'), ('u' 'n' 't' 'i' 'l'))) *g_kok *g_ws *g_xblock *g_ws), (*g_pblock *g_ws (FENCE(((@rk_cur *rk_ltm2(('while'), ('until'))) *g_kok *g_ws) | (FAIL))) *g_ws *rk_EXPR *g_ws))) *g_ws;
...
g_statement_control__whenever = 'whenever' *g_kok *g_ws (FENCE((FAIL *g_ws) | (FAIL *g_ws))) *g_ws *g_xblock *g_ws;
g_statement_control__foreach = 'foreach' *g_end_keyword *g_ws FAIL *g_ws;
g_statement_control__loop = 'loop' *g_kok epsilon *g_ws FENCE((('(' *g_ws FENCE(((FENCE((*rk_EXPR) | epsilon) *g_ws FENCE(((';' *g_ws FENCE((*rk_EXPR) | epsilon) *g_ws FENCE(((';' *g_ws FENCE((*rk_EXPR) | epsilon) *g_ws)) | epsilon) *g_ws)) | epsilon) *g_ws)) | epsilon) *g_ws (FENCE((epsilon *g_ws ')' *g_ws) | (@rk_cur *rk_la(')') *g_ws (FENCE((epsilon *g_ws FAIL *g_ws) | (FAIL *g_ws))) *g_ws) | (@rk_cur *rk_la(';') *g_ws FAIL *g_ws) | (FAIL *g_ws))) *g_ws)) | epsilon) *g_ws *g_block *g_ws;
g_statement_control__need = 'need' *g_ws @rk_cur *rk_plus((@rk_cur *rk_ltm2((*g_version *g_ws epsilon *g_ws), (*g_module_name *g_ws))), ',', 1) *g_ws;
...
g_statement_control__use = (FENCE((('DOC' @rk_cur *rk_plus(ANY(rk_h), FAIL, 0))) | epsilon)) 'use' *g_ws (@rk_cur *rk_ltm2((*g_version), (*g_module_name (FENCE((*g_spacey *g_arglist FENCE((*std_cheat_heredoc) | epsilon) epsilon epsilon epsilon) | (epsilon)))))) (FENCE((FAIL *g_eat_terminator *g_statementlist) | (epsilon))) *g_ws;
g_statement_control__require = 'require' *g_ws (@rk_cur *rk_ltm2((*g_module_name *g_ws), (@rk_cur *rk_ltm2((*g_variable *g_ws), (@rk_cur *rk_nla(*g_sigil) *g_ws *g_term *g_ws))))) *g_ws FENCE((*rk_EXPR) | epsilon) *g_ws;
...
g_statement_prefix__race = 'race' *g_kok (@rk_cur *rk_ltm2((@rk_cur *rk_la('for' *g_kok) *g_statement_control), (*g_blorst)));
g_statement_prefix__hyper = 'hyper' *g_kok (@rk_cur *rk_ltm2((@rk_cur *rk_la('for' *g_kok) *g_statement_control), (*g_blorst)));
g_statement_prefix__lazy = 'lazy' *g_kok (@rk_cur *rk_ltm2((@rk_cur *rk_la('for' *g_kok) *g_statement_control), (*g_blorst)));
...
g_term__multi_declarator = @rk_cur *rk_la(@rk_cur *rk_ltm2(('multi'), (@rk_cur *rk_ltm2(('proto'), ('only'))))) *g_multi_declarator;
...
g_term__unquote = '{{{' FAIL *g_statementlist '}}}';
...
g_infix__lambda = @rk_cur *rk_la(@rk_cur *rk_ltm2(('{'), (@rk_cur *rk_mem('g_lambda', '')))) epsilon (FENCE((epsilon) | (FAIL)));
g_term__undef = epsilon 'undef' @rk_cur *rk_rwb() FENCE(((@rk_cur *rk_la(@rk_cur *rk_star(ANY(rk_h), FAIL, 0) '$/') FAIL)) | epsilon) FENCE(((@rk_cur *rk_la((FENCE(('(') | (@rk_cur *rk_star(ANY(rk_h), FAIL, 0) *g_sigil FENCE((*g_twigil) | epsilon) ANY(rk_w))))) FAIL)) | epsilon) FAIL;
g_term__new = epsilon 'new' @rk_cur *rk_plus(ANY(rk_h), FAIL, 0) *g_longname @rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_nla(ANY(':')) FAIL;
g_fatarrow = *g_identifier @rk_cur *rk_star(ANY(rk_h), FAIL, 0) '=>' *g_ws *rk_EXPR;
g_coloncircumfix = (@rk_cur *rk_ltm2(('<>' epsilon), (*g_circumfix)));
g_colonpair = ':' (@rk_cur *rk_ltm2(('!' (FENCE((*g_identifier) | (FAIL))) FENCE(((ANY('[(<{'))) | epsilon)), (@rk_cur *rk_ltm2(((@rk_cur *rk_plus(ANY(rk_digit), FAIL, 0)) *g_identifier FENCE(((@rk_cur *rk_la(ANY('[(<{')) epsilon *g_circumfix)) | epsilon) epsilon), (@rk_cur *rk_ltm2((*g_identifier (FENCE((FENCE((*g_unsp) | epsilon) *g_coloncircumfix) | (epsilon)))), (@rk_cur *rk_ltm2(('(' *g_fakesignature ')'), (@rk_cur *rk_ltm2((*g_coloncircumfix), (*g_colonpair_variable)))))))))));
g_colonpair_variable = *g_sigil (@rk_cur *rk_ltm2((FENCE((*g_twigil) | epsilon) *g_desigilname), ('<' *g_desigilname '>')));
...
g_special_variable__x24x21x7bx20x7d = (@rk_cur *rk_ltm2(('$!{' @rk_cur *rk_star(LEN(1), FAIL, 0) '}'), ('%!'))) FAIL;
g_special_variable__x24x60 = '$`' @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), (@rk_cur *rk_ltm2((','), (@rk_cur *rk_mem('g_terminator', '')))))) FAIL;
...
g_special_variable__x24x26 = '$&' @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), (@rk_cur *rk_ltm2((','), (@rk_cur *rk_mem('g_terminator', '')))))) FAIL;
g_special_variable__x40x2b = '@+' @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), (@rk_cur *rk_ltm2((','), (@rk_cur *rk_mem('g_terminator', '')))))) FAIL;
g_special_variable__x25x2b = '%+' @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), (@rk_cur *rk_ltm2((','), (@rk_cur *rk_mem('g_terminator', '')))))) FAIL;
g_special_variable__x24x2bx5bx20x5d = '$+[' FAIL;
g_special_variable__x40x2bx5bx20x5d = '@+[' FAIL;
g_special_variable__x40x2bx7bx20x7d = '@+{' FAIL;
g_special_variable__x40x2d = '@-' @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), (@rk_cur *rk_ltm2((','), (@rk_cur *rk_mem('g_terminator', '')))))) FAIL;
g_special_variable__x25x2d = '%-' @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), (@rk_cur *rk_ltm2((','), (@rk_cur *rk_mem('g_terminator', '')))))) FAIL;
...
g_special_variable__x24x5cx5c = '$\' @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), (@rk_cur *rk_ltm2((','), (@rk_cur *rk_ltm2(('='), (@rk_cur *rk_mem('g_terminator', '')))))))) FAIL;
...
g_special_variable__x24x27 = "$'" @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), (@rk_cur *rk_ltm2((','), (@rk_cur *rk_mem('g_terminator', '')))))) FAIL;
...
g_special_variable__x24x2e = '$.' @rk_cur *rk_nla(@rk_cur *rk_ltm2((ANY(rk_w)), (@rk_cur *rk_ltm2(('('), (@rk_cur *rk_ltm2((':'), ('^'))))))) FAIL;
g_special_variable__x24x3f = '$?' @rk_cur *rk_nla(@rk_cur *rk_ltm2((ANY(rk_w)), ('('))) FAIL;
g_special_variable__x24x5d = '$]' @rk_cur *rk_nla(@rk_cur *rk_ltm2((ANY(rk_w)), ('('))) FAIL;
g_special_variable__x24x7bx20x7d = *g_sigil '{' (ARBNO(LEN(1))) '}' epsilon epsilon epsilon FAIL;
g_desigilname = (@rk_cur *rk_ltm2((@rk_cur *rk_la(*g_sigil *g_sigil) *g_variable), (@rk_cur *rk_ltm2((@rk_cur *rk_la(*g_sigil) FENCE(((FAIL FAIL)) | epsilon) *g_variable), (*g_longname)))));
g_desigilmetaname = ((*g_identifier));
g_sigillessx2dvariable = FAIL;
g_variable = (@rk_cur *rk_ltm2(('&[' *g_infixish ']'), (@rk_cur *rk_ltm2((*g_sigil (@rk_cur *rk_ltm2((('.^') *g_desigilmetaname), (FENCE((*g_twigil) | epsilon) *g_desigilname))) FENCE(((FAIL)) | epsilon)), (@rk_cur *rk_ltm2((*g_special_variable), (@rk_cur *rk_ltm2((*g_sigil (@rk_cur *rk_plus(ANY(rk_digit), FAIL, 0)) FENCE(((FAIL FAIL)) | epsilon)), (@rk_cur *rk_ltm2((*g_sigil @rk_cur *rk_la(ANY('<')) *g_postcircumfix FENCE(((FAIL FAIL)) | epsilon)), (@rk_cur *rk_ltm2((@rk_cur *rk_la(*g_sigil @rk_cur *rk_la(ANY('([{'))) @rk_cur *rk_nla(*std_RESTRICTED) epsilon *g_contextualizer), (@rk_cur *rk_ltm2((('$') (ANY('/_!¢'))), (@rk_cur *rk_ltm2((*g_sigillessx2dvariable), (*g_sigil epsilon @rk_cur *rk_marker('baresigil')))))))))))))))))) FENCE(((epsilon (@rk_cur *rk_ltm2((*g_unsp), (@rk_cur *rk_ltm2(('\'), (epsilon))))) @rk_cur *rk_la(ANY('(:')) @rk_cur *rk_nla(*std_RESTRICTED) (@rk_cur *rk_ltm2((':' @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), ('{'))) epsilon *g_arglist), ('(' *g_arglist ')'))))) | epsilon);
g_contextualizer = FENCE(((FAIL FAIL)) | epsilon) (@rk_cur *rk_ltm2((*g_sigil '(' *g_sequence ')'), (*g_sigil @rk_cur *rk_la(ANY('[{')) *g_circumfix)));
g_sigil = ANY('$@%&');
...
g_package_def = FENCE((epsilon *g_ws epsilon *g_ws (FENCE(((*g_longname *g_ws)) | epsilon) *g_ws epsilon *g_ws FENCE(((epsilon *g_ws '[' *g_ws *g_signature ']' *g_ws)) | epsilon) *g_ws @rk_cur *rk_star(*g_trait, FAIL, 0) *g_ws (FENCE((@rk_cur *rk_la(ANY('{')) (*g_blockoid)) | (';' (FENCE((epsilon epsilon *g_statementlist) | (epsilon)))) | (FAIL))))) | (epsilon));
g_declarator = (@rk_cur *rk_ltm2(('\' *g_deftermnow (FENCE((*g_ws *g_initializer) | (FAIL)))), (@rk_cur *rk_ltm2((*g_variable_declarator (FENCE((epsilon epsilon FENCE(((*g_ws *g_initializer)) | epsilon)) | (FENCE(((*g_ws *g_initializer)) | epsilon))))), (@rk_cur *rk_ltm2(('(' *g_signature ')' FENCE(((*g_ws @rk_cur *rk_plus(*g_trait, FAIL, 0))) | epsilon) FENCE(((*g_ws *g_initializer)) | epsilon)), (@rk_cur *rk_ltm2((':(' *g_signature ')' FENCE(((*g_ws @rk_cur *rk_plus(*g_trait, FAIL, 0))) | epsilon) (FENCE(((*g_ws *g_initializer)) | (FAIL)))), (@rk_cur *rk_ltm2((*g_routine_declarator), (@rk_cur *rk_ltm2((*g_regex_declarator), (*g_type_declarator)))))))))))));
...
g_scoped = *g_end_keyword (FENCE((*g_ws (@rk_cur *rk_ltm2((*g_declarator), (@rk_cur *rk_ltm2((*g_regex_declarator), (@rk_cur *rk_ltm2((*g_package_declarator), (@rk_cur *rk_ltm2((@rk_cur *rk_plus((*g_typename *g_ws), FAIL, 0) *g_multi_declarator), (*g_multi_declarator)))))))))) | (*g_ws @rk_cur *rk_star((*g_typename *g_ws), FAIL, 0) *rk_ident @rk_cur *rk_la(*g_ws (@rk_cur *rk_ltm2((FENCE((':') | epsilon) FENCE((':') | epsilon) '='), (@rk_cur *rk_ltm2((@rk_cur *rk_mem('g_terminator', '')), (@rk_cur *rk_ltm2((*g_trait), (@rk_cur *rk_ltm2(('where' *g_ws *rk_EXPR), (RPOS(0))))))))))) FAIL) | (*g_ws *g_typename *g_ws @rk_cur *rk_la('where' *g_ws *rk_EXPR) FAIL) | (*g_ws *g_typename *g_ws @rk_cur *rk_la(*g_trait) FAIL) | (*g_ws *g_typename *g_ws @rk_cur *rk_la((@rk_cur *rk_ltm2((@rk_cur *rk_mem('g_terminator', '')), (RPOS(0))))) FAIL) | (*g_ws @rk_cur *rk_nla(*g_typename) *g_typo_typename FAIL) | (FAIL)));
g_variable_declarator = *g_variable FENCE(((FENCE((*g_unsp) | epsilon) @rk_cur *rk_plus((@rk_cur *rk_ltm2(('(' *g_signature ')'), (@rk_cur *rk_ltm2(('[' *g_semilist ']'), (@rk_cur *rk_ltm2(('{' *g_semilist '}'), (@rk_cur *rk_la(ANY('<')) *g_postcircumfix FAIL))))))), FAIL, 0))) | epsilon) FENCE(((*g_ws @rk_cur *rk_plus(*g_trait, FAIL, 0))) | epsilon) FENCE(((*g_ws @rk_cur *rk_plus(*g_post_constraint, FAIL, 0))) | epsilon);
...
g_method_def = FENCE((epsilon *g_ws (epsilon *g_ws (@rk_cur *rk_ltm2(((FENCE((ANY('!^')) | epsilon)) *g_longname *g_ws FENCE((('(' *g_ws *g_multisig *g_ws ')' *g_ws)) | epsilon) *g_ws @rk_cur *rk_star(*g_trait, FAIL, 0) *g_ws), (@rk_cur *rk_ltm2(('(' *g_ws *g_multisig *g_ws ')' *g_ws @rk_cur *rk_star(*g_trait, FAIL, 0) *g_ws), (@rk_cur *rk_ltm2((*g_sigil '.' (@rk_cur *rk_ltm2(('(' *g_multisig ')'), (@rk_cur *rk_ltm2(('[' *g_multisig ']'), ('{' *g_multisig '}'))))) @rk_cur *rk_star(*g_trait, FAIL, 0) *g_ws), (epsilon *g_ws))))))) *g_ws (FENCE((*g_onlystar *g_ws) | (*g_blockoid *g_ws))) *g_ws) *g_ws) | (FAIL *g_ws));
...
g_onlystar = FAIL '{' *g_ws '*' *g_ws '}' @rk_cur *rk_la(*g_ENDSTMT) epsilon;
g_capterm = '\' (@rk_cur *rk_ltm2(('(' *g_semiarglist ')'), (@rk_cur *rk_ltm2((@rk_cur *rk_la(@rk_cur *rk_ltm2(('$'), (@rk_cur *rk_ltm2(('@'), (@rk_cur *rk_ltm2(('%'), ('&'))))))) epsilon *g_termish), (@rk_cur *rk_ltm2((@rk_cur *rk_la(ANY(rk_digit)) epsilon *g_termish), (@rk_cur *rk_ltm2((@rk_cur *rk_la(NOTANY(rk_s)) *g_termish), (FAIL)))))))));
g_param_sep = epsilon *g_ws (@rk_cur *rk_ltm2((','), (@rk_cur *rk_ltm2((':'), (@rk_cur *rk_ltm2((';;'), (';'))))))) *g_ws;
g_multisig = *g_signature;
g_sigterm = ':(' *g_fakesignature ')';
g_fakesignature = epsilon *g_signature;
g_signature = *g_ws @rk_cur *rk_plus((@rk_cur *rk_ltm2((@rk_cur *rk_la(@rk_cur *rk_ltm2(('-->'), (@rk_cur *rk_ltm2((')'), (@rk_cur *rk_ltm2((']'), (@rk_cur *rk_ltm2(('{'), (@rk_cur *rk_ltm2((':' ANY(rk_s)), (';;')))))))))))), (*g_parameter))), *g_param_sep, 1) *g_ws (FENCE((@rk_cur *rk_la(@rk_cur *rk_ltm2(('-->'), (@rk_cur *rk_ltm2((')'), (@rk_cur *rk_ltm2((']'), (@rk_cur *rk_ltm2(('{'), (@rk_cur *rk_ltm2((':' ANY(rk_s)), (';;')))))))))))) | (FAIL))) FENCE((('-->' *g_ws (FENCE(((FENCE((*g_typename) | (*g_value) | (*g_typo_typename))) *g_ws (FENCE((@rk_cur *rk_la(ANY('{)'))) | (@rk_cur *rk_la(FENCE((*g_param_sep) | epsilon) *g_parameter) FAIL)))) | (FAIL))))) | epsilon);
g_parameter = (@rk_cur *rk_ltm2((@rk_cur *rk_plus(*g_type_constraint, FAIL, 0) (@rk_cur *rk_ltm2(((@rk_cur *rk_ltm2(('**'), (@rk_cur *rk_ltm2(('*'), ('+'))))) *g_param_var), (@rk_cur *rk_ltm2(((@rk_cur *rk_ltm2(('\'), ('|'))) *g_param_var), (@rk_cur *rk_ltm2(((@rk_cur *rk_ltm2(('\'), (@rk_cur *rk_ltm2(('|'), ('+'))))) *g_param_term), (@rk_cur *rk_ltm2(((@rk_cur *rk_ltm2((*g_param_var), (*g_named_param))) (@rk_cur *rk_ltm2(('?'), (@rk_cur *rk_ltm2(('!'), (epsilon)))))), (epsilon)))))))))), (@rk_cur *rk_ltm2(((@rk_cur *rk_ltm2(('**'), (@rk_cur *rk_ltm2(('*'), ('+'))))) *g_param_var), (@rk_cur *rk_ltm2(((@rk_cur *rk_ltm2(('\'), ('|'))) *g_param_var), (@rk_cur *rk_ltm2(((@rk_cur *rk_ltm2(('\'), (@rk_cur *rk_ltm2(('|'), ('+'))))) *g_param_term), (@rk_cur *rk_ltm2(((@rk_cur *rk_ltm2((*g_param_var), (*g_named_param))) (@rk_cur *rk_ltm2(('?'), (@rk_cur *rk_ltm2(('!'), (epsilon)))))), (*g_longname))))))))))) *g_ws @rk_cur *rk_star(*g_trait, FAIL, 0) @rk_cur *rk_star(*g_post_constraint, FAIL, 0) epsilon (FENCE(((*g_default_value FENCE(((*g_trait)) | epsilon) FENCE(((*g_post_constraint)) | epsilon))) | epsilon));
g_param_var = epsilon (@rk_cur *rk_ltm2(('[' *g_signature ']'), (@rk_cur *rk_ltm2(('(' *g_signature ')'), ((*g_sigil FENCE((*g_twigil) | epsilon) FENCE(((FENCE((FAIL (@rk_cur *rk_ltm2((@rk_cur *rk_la(*g_identifier) *g_sublongname), (*g_sigterm)))) | (*g_identifier) | (*hll_decint) | ((ANY('/!')))))) | epsilon)) FENCE(((@rk_cur *rk_ltm2((@rk_cur *rk_la(':(') ':'), (@rk_cur *rk_ltm2((@rk_cur *rk_la('(') epsilon), (@rk_cur *rk_ltm2((@rk_cur *rk_la('[') *g_postcircumfix), (@rk_cur *rk_la(ANY('{<«')) epsilon *g_postcircumfix)))))))) | epsilon))))));
g_param_term = FENCE((*g_defterm) | epsilon);
g_named_param = ':' (@rk_cur *rk_ltm2((*g_identifier '(' *g_ws (@rk_cur *rk_ltm2((*g_named_param), (*g_param_var))) *g_ws (FENCE((')') | (FAIL)))), (*g_param_var)));
g_default_value = '=' *g_ws *rk_EXPR *g_ws;
g_type_constraint = (@rk_cur *rk_ltm2((*g_value), (@rk_cur *rk_ltm2(((@rk_cur *rk_ltm2((ANY('-−')), ('+'))) *g_numish), (@rk_cur *rk_ltm2((*g_typename), ('w' 'h' 'e' 'r' 'e' *g_ws *rk_EXPR))))))) *g_ws;
g_post_constraint = (@rk_cur *rk_ltm2(('[' *g_ws *g_signature ']' *g_ws), (@rk_cur *rk_ltm2(('(' *g_ws *g_signature ')' *g_ws), ('w' 'h' 'e' 'r' 'e' *g_ws *rk_EXPR *g_ws))))) *g_ws;
...
g_regex_def = FENCE((epsilon *g_ws (FENCE((*g_deflongname) | epsilon) *g_ws epsilon *g_ws @rk_cur *rk_star((@rk_cur *rk_ltm2(((FENCE((':') | epsilon) '(' *g_ws *g_signature *g_ws ')' *g_ws) *g_ws), (*g_trait *g_ws))), FAIL, 0) *g_ws '{' *g_ws (@rk_cur *rk_ltm2(((@rk_cur *rk_ltm2(('*'), (@rk_cur *rk_ltm2(('<...>'), ('<*>'))))) *g_ws FAIL *g_ws *g_ws), (@rk_cur *rk_nib('{', '}', 'rx') *g_ws))) *g_ws '}' @rk_cur *rk_nla(*std_RESTRICTED) @rk_cur *rk_la(*g_ENDSTMT) *g_ws) *g_ws) | (FAIL *g_ws));
g_type_declarator = FENCE(*g_type_declarator__constant | *g_type_declarator__subset | *g_type_declarator__enum);
g_type_declarator__enum = 'enum' *g_kok epsilon (@rk_cur *rk_ltm2((*g_longname), (@rk_cur *rk_ltm2((*g_variable), (epsilon))))) *g_ws @rk_cur *rk_star(*g_trait, FAIL, 0) (FENCE((@rk_cur *rk_la(ANY('<(«')) *g_term *g_ws) | (FAIL))) epsilon epsilon;
...
g_type_declarator__constant = 'constant' *g_kok (@rk_cur *rk_ltm2((FENCE(('\') | epsilon) *g_defterm), (@rk_cur *rk_ltm2((*g_variable), (epsilon))))) *g_ws @rk_cur *rk_star(*g_trait, FAIL, 0) (FENCE((*g_initializer epsilon epsilon) | (FAIL))) FENCE((*std_cheat_heredoc) | epsilon);
g_initializer = FENCE(*g_initializer__x3ax3ax3d | *g_initializer__x3ax3d | *g_initializer__x2ex3d | *g_initializer__x3d);
g_initializer__x3d = (FENCE((epsilon) | (FAIL))) '=' (FENCE((*g_ws (FENCE((epsilon *rk_EXPR) | (*rk_EXPR)))) | (FAIL)));
...
g_term__nano = FAIL 'nano' *g_tok;
g_term__empty_set = '∅' @rk_cur *rk_nla(FENCE((ANY("(\'-")) | (@rk_cur *rk_star(ANY(rk_h), FAIL, 0) '=>')));
g_term__rand = epsilon 'rand' @rk_cur *rk_rwb() FENCE(((@rk_cur *rk_la(FENCE(('(') | epsilon) @rk_cur *rk_star(ANY(rk_h), FAIL, 0) (@rk_cur *rk_ltm2((ANY(rk_digit)), ('$')))) FAIL)) | epsilon) FENCE(((@rk_cur *rk_la('()') FAIL)) | epsilon) *g_end_keyword;
g_term__x2ex2ex2e = (@rk_cur *rk_ltm2(('...'), ('…'))) FENCE(((@rk_cur *rk_lb(',' @rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_plus(ANY('.…'), FAIL, 0)))) | epsilon) FENCE(((FAIL @rk_cur *rk_lb(ANY(rk_alpha ']') @rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_plus(ANY('.…'), FAIL, 0)))) | epsilon) *g_args;
g_term__x3fx3fx3f = '???' *g_args;
g_term__x21x21x21 = '!!!' *g_args;
g_term__identifier = *g_identifier epsilon (@rk_cur *rk_ltm2((@rk_cur *rk_la(FENCE((*g_unsp) | epsilon) '(')), ('\' @rk_cur *rk_la('(')))) *g_args;
...
g_term__name = *g_longname (FENCE((@rk_cur *rk_isname(0) FENCE((*g_unsp) | epsilon) FENCE(((@rk_cur *rk_la(ANY('[')) @rk_cur *rk_istype(0) '[' *g_arglist ']')) | epsilon) FENCE((*g_unsp) | epsilon) FENCE(((@rk_cur *rk_la(ANY('{')) @rk_cur *rk_istype(0) *g_postcircumfix FAIL)) | epsilon) FENCE((*g_unsp) | epsilon) FENCE(((@rk_cur *rk_la(ANY('(')) @rk_cur *rk_istype(0) '(' *g_ws (FENCE((*rk_m_maybe_typename epsilon) | (epsilon))) *g_ws ')')) | epsilon) FENCE(((epsilon epsilon)) | epsilon)) | (FENCE((('\' @rk_cur *rk_la('('))) | epsilon) *g_args)));
g_term__dotty = *g_dotty;
g_term__capterm = *g_capterm;
g_term__onlystar = '{*}' @rk_cur *rk_la(*g_ENDSTMT) (FENCE((FAIL) | (FAIL)));
g_args = (@rk_cur *rk_ltm2(('(' *g_semiarglist ')'), (@rk_cur *rk_ltm2((*g_unsp '(' *g_semiarglist ')'), (@rk_cur *rk_ltm2(((ANY(rk_s) *g_arglist)), (epsilon)))))));
g_semiarglist = @rk_cur *rk_plus(*g_arglist, ';', 1) *g_ws;
g_arglist = *g_ws (@rk_cur *rk_ltm2((@rk_cur *rk_la(@rk_cur *rk_mem('g_stdstopper', 'endstmt'))), (@rk_cur *rk_ltm2((*rk_EXPR), (epsilon)))));
...
g_numish = (@rk_cur *rk_ltm2(('NaN' @rk_cur *rk_rwb()), (@rk_cur *rk_ltm2((*g_integer), (@rk_cur *rk_ltm2((*g_dec_number), (@rk_cur *rk_ltm2((*g_rad_number), (@rk_cur *rk_ltm2((*g_rat_number), (@rk_cur *rk_ltm2((*g_complex_number), (@rk_cur *rk_ltm2(('Inf' @rk_cur *rk_rwb()), (@rk_cur *rk_ltm2(('∞'), (FAIL)))))))))))))))));
g_dec_number = (@rk_cur *rk_ltm2((('.' *hll_decint) FENCE((*g_escale) | epsilon)), (@rk_cur *rk_ltm2(((*hll_decint '.' *hll_decint) FENCE((*g_escale) | epsilon)), ((*hll_decint) *g_escale)))));
g_signedx2dinteger = *g_sign *g_integer;
g_integer = (@rk_cur *rk_ltm2(('0' (@rk_cur *rk_ltm2(('b' FENCE(('_') | epsilon) *hll_binint), (@rk_cur *rk_ltm2(('o' FENCE(('_') | epsilon) *hll_octint), (@rk_cur *rk_ltm2(('x' FENCE(('_') | epsilon) *hll_hexint), (@rk_cur *rk_ltm2(('d' FENCE(('_') | epsilon) *hll_decint), (*hll_decint epsilon)))))))))), (*hll_decint))) @rk_cur *rk_la(FENCE((('.' @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), (@rk_cur *rk_ltm2((','), (@rk_cur *rk_ltm2(('='), (@rk_cur *rk_ltm2((':' @rk_cur *rk_nla(*g_prefix)), (@rk_cur *rk_ltm2((@rk_cur *rk_mem('g_terminator', '')), (RPOS(0)))))))))))) epsilon)) | epsilon)) FENCE(((@rk_cur *rk_la('_' @rk_cur *rk_plus('_', FAIL, 0) ANY(rk_digit)) epsilon)) | epsilon);
g_rad_number = ':' (@rk_cur *rk_plus(ANY(rk_digit), FAIL, 0)) FENCE((*g_unsp) | epsilon) (FENCE(('<' (FENCE(((@rk_cur *rk_ltm2(('0x' epsilon), (@rk_cur *rk_ltm2(('0o' epsilon), (@rk_cur *rk_ltm2(('0d' epsilon), ('0b' epsilon)))))))) | epsilon)) *rk_m_rad_digits (FENCE((('.' *rk_m_rad_digits)) | epsilon)) (FENCE((('*' *g_radint '**' *g_radint)) | epsilon)) '>') | (@rk_cur *rk_la(ANY('[')) *g_circumfix) | (@rk_cur *rk_la(ANY('(')) *g_circumfix) | (FAIL)));
g_radint = (*g_integer);
g_escale = ANY('Ee') *g_sign *hll_decint;
g_sign = @rk_cur *rk_ltm2(('+'), (@rk_cur *rk_ltm2(('-'), (@rk_cur *rk_ltm2(('−'), (epsilon))))));
...
g_typename = (@rk_cur *rk_ltm2(('::?' *g_identifier @rk_cur *rk_star(*g_colonpair, FAIL, 0)), (*g_longname FAIL))) FENCE((*g_unsp) | epsilon) FENCE(((@rk_cur *rk_la(ANY('[')) '[' *g_arglist ']' epsilon epsilon)) | epsilon) FENCE((*g_unsp) | epsilon) FENCE(((@rk_cur *rk_la('{') *g_postcircumfix)) | epsilon) FENCE((*g_unsp) | epsilon) FENCE(((@rk_cur *rk_la(ANY('(')) '(' (*g_ws (FENCE((*g_typename) | (epsilon))) *g_ws) ')')) | epsilon) FENCE(((*g_ws 'of' *g_ws *g_typename)) | epsilon) FENCE(((epsilon epsilon)) | epsilon);
g_typo_typename = *g_longname;
g_quotepair = ':' (@rk_cur *rk_ltm2(('!' *g_identifier FENCE(((@rk_cur *rk_la(ANY('(')) epsilon)) | epsilon)), (@rk_cur *rk_ltm2((*g_identifier (FENCE((@rk_cur *rk_la(ANY('(')) *g_circumfix) | (epsilon)))), ((@rk_cur *rk_plus(ANY(rk_digit), FAIL, 0)) *g_identifier FENCE(((@rk_cur *rk_la(ANY('(')) *g_circumfix epsilon)) | epsilon))))));
...
g_quote__q = 'q' (@rk_cur *rk_ltm2((*g_quote_mod *g_qok *g_ws @rk_cur *rk_star((*g_quotepair *g_ws), FAIL, 0) @rk_cur *rk_qscan('q')), (*g_qok *g_ws @rk_cur *rk_star((*g_quotepair *g_ws), FAIL, 0) @rk_cur *rk_qscan('q'))));
g_quote__qq = 'qq' (@rk_cur *rk_ltm2((*g_quote_mod *g_qok *g_ws @rk_cur *rk_star((*g_quotepair *g_ws), FAIL, 0) @rk_cur *rk_qscan('qq')), (*g_qok *g_ws @rk_cur *rk_star((*g_quotepair *g_ws), FAIL, 0) @rk_cur *rk_qscan('qq'))));
g_quote__Q = 'Q' (@rk_cur *rk_ltm2((*g_quote_mod *g_qok *g_ws @rk_cur *rk_star((*g_quotepair *g_ws), FAIL, 0) @rk_cur *rk_qscan('Q')), (*g_qok *g_ws @rk_cur *rk_star((*g_quotepair *g_ws), FAIL, 0) @rk_cur *rk_qscan('Q'))));
g_quote__x2fnullx2f = @rk_cur *rk_ltm2((epsilon '/' @rk_cur *rk_star(ANY(rk_s), FAIL, 0) '/' FAIL), (FAIL '/' @rk_cur *rk_plus(ANY(rk_s), FAIL, 0) '/' FAIL));
...
g_sibble = *g_ws @rk_cur *rk_star((*g_quotepair *g_ws), FAIL, 0) @rk_cur *rk_qscan('Q') *rk_start @rk_cur *rk_nib(rk_dstart, rk_dstop, rk_dkind) (FENCE((*rk_stop) | (epsilon))) (FENCE((epsilon *g_ws FENCE(((@rk_cur *rk_la(ANY('[{(<')) FAIL)) | epsilon) (FENCE((*g_infixish) | (FAIL))) (FENCE((FAIL) | (FAIL))) *g_ws (FENCE((*rk_EXPR) | (FAIL)))) | (@rk_cur *rk_nib(rk_dstart, rk_dstop, rk_dkind) *rk_stop) | (FAIL)));
g_quote__s = ANY('Ss') (FENCE((('s')) | epsilon)) *g_qok *g_rx_adverbs *g_sibble (FENCE((FAIL) | (FENCE((*g_old_rx_mods) | epsilon))));
g_tribble = *g_ws @rk_cur *rk_star((*g_quotepair *g_ws), FAIL, 0) @rk_cur *rk_qscan('Q') *rk_start @rk_cur *rk_nib(rk_dstart, rk_dstop, rk_dkind) (FENCE((*rk_stop) | (epsilon))) (FENCE((epsilon *rk_start @rk_cur *rk_nib(rk_dstart, rk_dstop, rk_dkind) (FENCE((*rk_stop) | (epsilon)))) | (@rk_cur *rk_nib(rk_dstart, rk_dstop, rk_dkind) *rk_stop) | (FAIL)));
g_quote__tr = (@rk_cur *rk_ltm2(('tr'), ('TR'))) *g_qok *g_rx_adverbs *g_tribble FENCE((*g_old_rx_mods) | epsilon);
...
g_termish = (FENCE(((@rk_cur *rk_ltm2((@rk_cur *rk_plus(*g_prefixish, FAIL, 0) (FENCE((*g_arg_flat_nok *g_term) | (FAIL)))), (*g_arg_flat_nok *g_term)))) | (epsilon @rk_cur *rk_la(*g_infixish)) | (FAIL))) (FENCE((FAIL (FENCE((FAIL (FENCE(((@rk_cur *rk_plus(*g_postfixish, FAIL, 0) FAIL)) | epsilon))) | (@rk_cur *rk_plus(*g_postfixish, FAIL, 0) FAIL)))) | (epsilon @rk_cur *rk_star(*g_postfixish, FAIL, 0))));
g_arg_flat_nok = epsilon;
g_prefixish = (@rk_cur *rk_ltm2((*g_prefix), (*g_prefix_circumfix_meta_operator))) (FENCE((*g_prefix_postfix_meta_operator) | epsilon)) *g_ws;
g_infixish = @rk_cur *rk_nla(@rk_cur *rk_mem('g_stdstopper', 'endstmt')) @rk_cur *rk_nla(@rk_cur *rk_mem('g_infixstopper', 'ws')) (@rk_cur *rk_ltm2((epsilon *g_colonpair *g_fake_infix), ((@rk_cur *rk_ltm2(('[' *g_infixish ']'), (@rk_cur *rk_ltm2((@rk_cur *rk_la('[&' FENCE((*g_twigil) | epsilon) (@rk_cur *rk_ltm2((ANY(rk_alpha)), ('(')))) '[' *g_variable ']'), (@rk_cur *rk_ltm2((*g_infix_circumfix_meta_operator), (@rk_cur *rk_ltm2((*g_infix_prefix_meta_operator), (@rk_cur *rk_ltm2((*g_infix), (FAIL FAIL))))))))))) FENCE(((@rk_cur *rk_la('=') *g_infix_postfix_meta_operator)) | epsilon)))) epsilon;
g_fake_infix = epsilon;
g_infixstopper = (((@rk_cur *rk_la('!!') epsilon) | (@rk_cur *rk_la((('{') | (@rk_cur *rk_mem('g_lambda', '')))) @rk_cur *rk_marked('ws') epsilon)));
g_postfixish = @rk_cur *rk_nla(@rk_cur *rk_mem('g_stdstopper', 'endstmt')) @rk_cur *rk_postws() FENCE(((epsilon (@rk_cur *rk_ltm2((*g_unsp), ('\'))))) | epsilon) (FENCE(((FENCE((('.' FENCE((*g_unsp) | epsilon))) | epsilon) *g_postfix_prefix_meta_operator FENCE((*g_unsp) | epsilon))) | epsilon)) (@rk_cur *rk_ltm2((*g_postfix), (@rk_cur *rk_ltm2(('.' @rk_cur *rk_la(NOTANY(rk_w)) *g_postfix), (@rk_cur *rk_ltm2((*g_postcircumfix), (@rk_cur *rk_ltm2(('.' @rk_cur *rk_la(ANY('[{<')) *g_postcircumfix), (@rk_cur *rk_ltm2((*g_dotty), (@rk_cur *rk_ltm2((*g_privop), (FAIL (FENCE((@rk_cur *rk_la(ANY(rk_s)) FAIL) | (@rk_cur *rk_la(ANY(rk_alpha)) FAIL) | (FAIL))))))))))))))));
g_postop = @rk_cur *rk_ltm2((*g_postfix), (*g_postcircumfix));
...
g_term__reduce = @rk_cur *rk_la('[' @rk_cur *rk_plus(NOTANY(rk_s), FAIL, 0) ']') @rk_cur *rk_nla(@rk_cur *rk_plus('[', FAIL, 0) ANY('-+?~^') ANY(rk_w '$@')) '[' (((*g_infixish @rk_cur *rk_la(ANY(']'))) | (('\') *g_infixish @rk_cur *rk_la(ANY(']'))) | (FAIL))) ']' epsilon (((epsilon) | (FAIL) | (epsilon))) *g_args;
g_postfix_prefix_meta_operator__u00bb = (@rk_cur *rk_ltm2(('»'), ('>>'))) (FENCE((epsilon) | (@rk_cur *rk_nla(ANY('(')))));
g_prefix_postfix_meta_operator__u00ab = @rk_cur *rk_ltm2(('«'), ('<<'));
g_infix_circumfix_meta_operator__u00abx20u00bb = (@rk_cur *rk_ltm2(('«'), ('»'))) *g_infixish (FENCE(('«') | ('»') | (FAIL))) epsilon epsilon;
g_infix_circumfix_meta_operator__x3cx3cx20x3ex3e = (@rk_cur *rk_ltm2(('<<'), ('>>'))) *g_infixish (FENCE(('<<') | ('>>') | (FAIL))) epsilon;
g_revO = epsilon;
g_dotty = FENCE(*g_dotty__x2ex2a | *g_dotty__x2e);
g_dotty__x2e = '.' *g_dottyop epsilon;
g_dotty__x2ex2a = ('.' (@rk_cur *rk_ltm2((ANY('+*?=')), ('^' FENCE(('!') | epsilon))))) *g_dottyop epsilon;
g_dottyop = FENCE((*g_unsp) | epsilon) (@rk_cur *rk_ltm2((*g_methodop), (@rk_cur *rk_ltm2((*g_colonpair), (@rk_cur *rk_nla(ANY(rk_alpha)) *g_postop)))));
g_privop = '!' *g_methodop epsilon;
g_methodop = (@rk_cur *rk_ltm2((*g_longname), (@rk_cur *rk_ltm2((@rk_cur *rk_la(ANY('$@&')) *g_variable), (@rk_cur *rk_la(ANY("'" '"')) (FENCE((epsilon) | (@rk_cur *rk_nla('"' @rk_cur *rk_star(NOTANY('"'), FAIL, 0) (@rk_cur *rk_ltm2((ANY(rk_s)), (RPOS(0)))))))) *g_quote (FENCE((@rk_cur *rk_la(@rk_cur *rk_ltm2(('('), (@rk_cur *rk_ltm2(('.('), ('\')))))) | (FAIL)))))))) FENCE((*g_unsp) | epsilon) (FENCE(((@rk_cur *rk_ltm2((@rk_cur *rk_la(ANY('(')) *g_args), (':' @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), ('{'))) epsilon *g_arglist)))) | (epsilon epsilon) | (FAIL @rk_cur *rk_la(ANY('.')) epsilon))) FENCE((*g_unsp) | epsilon);
...
g_postcircumfix__ang = '<' (FENCE((@rk_cur *rk_nib('<', '>', 'q') '>') | (@rk_cur *rk_star('=', FAIL, 0) @rk_cur *rk_la(@rk_cur *rk_star(ANY(rk_h), FAIL, 0) (@rk_cur *rk_ltm2((ANY(rk_digit)), (@rk_cur *rk_ltm2((*g_sigil), (':'))))))) | (epsilon))) epsilon;
...
g_postfix__x2dx3e = '->' (@rk_cur *rk_ltm2(((@rk_cur *rk_ltm2(('['), (@rk_cur *rk_ltm2(('{'), ('('))))) FAIL), (FAIL)));
...
g_infix__x3cx3c = '<<' epsilon @rk_cur *rk_la(ANY(rk_s)) FAIL epsilon;
g_infix__x3ex3e = '>>' epsilon @rk_cur *rk_la(ANY(rk_s)) FAIL epsilon;
...
g_infix__x2e = '.' *g_ws epsilon FENCE(((@rk_cur *rk_nla(ANY(rk_alpha)))) | epsilon) epsilon;
...
g_infix__x21x3d = '!=' @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), (']'))) epsilon;
...
g_infix__x3fx3fx20x21x21 = '??' *g_ws *rk_EXPR (FENCE(('!!') | (@rk_cur *rk_la('::' NOTANY('='))) | (@rk_cur *rk_la(':' NOTANY(rk_w '='))) | (*g_infixish) | (FAIL) | (@rk_cur *rk_la(@rk_cur *rk_star(NOTANY(nl cr), FAIL, 0) FENCE((((cr nl | nl | cr) @rk_cur *rk_star(NOTANY(nl cr), FAIL, 0))) | epsilon) '!!')) | (epsilon))) epsilon;
g_infix_prefix_meta_operator__x21 = '!' @rk_cur *rk_nla(ANY('!')) (FENCE((*g_infixish) | (FAIL))) (FENCE((FAIL epsilon) | (epsilon epsilon epsilon) | (epsilon)));
...
g_infix__x3a = FAIL FENCE((*g_unsp) | epsilon) ':' @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), (@rk_cur *rk_ltm2((@rk_cur *rk_mem('g_terminator', '')), (RPOS(0)))))) epsilon (FENCE((FAIL) | (FAIL)));
...
g_infix__x3d = '=' (FENCE((FAIL epsilon) | (epsilon)));
...
g_infix__x2ex2e = '..' FENCE(((epsilon @rk_cur *rk_la(ANY(')]')) FAIL)) | epsilon) epsilon;
...
g_pod_textcontent__regular = (@rk_cur *rk_star(ANY(rk_h), FAIL, 0)) FAIL @rk_cur *rk_plus((@rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_nla('=' ANY(rk_w)) *g_pod_string (@rk_cur *rk_ltm2((*g_pod_newline), (RPOS(0))))), FAIL, 0);
g_pod_textcontent__code = (@rk_cur *rk_star(ANY(rk_h), FAIL, 0)) FAIL (@rk_cur *rk_plus((@rk_cur *rk_nla('=' ANY(rk_w)) @rk_cur *rk_plus(NOTANY(nl cr), FAIL, 0)), (@rk_cur *rk_plus(*g_pod_newline, FAIL, 0) *rk_var_x24x3cspacesx3e), 1));
g_pod_formatting_code = FAIL ANY('ABCDEFGHIJKLMNOPQRSTUVWXYZ') (@rk_cur *rk_ltm2((@rk_cur *rk_plus('<', FAIL, 0) @rk_cur *rk_nla(ANY('<'))), ('«'))) FAIL FENCE(((epsilon @rk_cur *rk_star((@rk_cur *rk_nla(*rk_var_x24endtag) (FENCE((epsilon) | (@rk_cur *rk_nla(@rk_cur *rk_star(ANY(rk_s), FAIL, 0) '|')))) *g_pod_string_character), FAIL, 0))) | epsilon) FENCE(((@rk_cur *rk_ltm2((epsilon @rk_cur *rk_star(ANY(rk_s), FAIL, 0) '|' @rk_cur *rk_star(ANY(rk_s), FAIL, 0) @rk_cur *rk_plus((@rk_cur *rk_nla(*rk_var_x24endtag) LEN(1)), FAIL, 0)), (@rk_cur *rk_ltm2((epsilon @rk_cur *rk_star(ANY(rk_s), FAIL, 0) '|' @rk_cur *rk_star(ANY(rk_s), FAIL, 0) @rk_cur *rk_plus((@rk_cur *rk_plus((@rk_cur *rk_plus((@rk_cur *rk_nla(@rk_cur *rk_ltm2((*rk_var_x24endtag), (ANY(',;')))) LEN(1)), FAIL, 0)), ',', 2)), ';', 2)), (@rk_cur *rk_ltm2((epsilon @rk_cur *rk_star(ANY(rk_s), FAIL, 0) '|' @rk_cur *rk_star(ANY(rk_s), FAIL, 0) @rk_cur *rk_plus((@rk_cur *rk_plus((@rk_cur *rk_nla(@rk_cur *rk_ltm2((*rk_var_x24endtag), (';'))) LEN(1)), FAIL, 0)), ';', 2)), (epsilon @rk_cur *rk_plus((FENCE((*g_integer) | (@rk_cur *rk_plus(ANY(rk_s 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'), FAIL, 0) @rk_cur *rk_nla(ANY('abcdefghijklmnopqrstuvwxyz'))) | (@rk_cur *rk_plus(ANY('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'), FAIL, 0)))), ';', 2))))))))) | epsilon) (FENCE((*rk_var_x24endtag) | (epsilon)));
g_pod_balanced_braces = FAIL (FENCE(((FENCE((@rk_cur *rk_plus('<', FAIL, 0) @rk_cur *rk_nla(ANY('<'))) | (@rk_cur *rk_plus('>', FAIL, 0) @rk_cur *rk_nla(ANY('>'))))) FAIL) | (FAIL (@rk_cur *rk_plus('<', FAIL, 0)) @rk_cur *rk_nla(ANY('<')) FAIL (@rk_cur *rk_star(*g_pod_string_character, FAIL, 0)) @rk_cur *rk_nlb('>') (*rk_var_x24endtag))));
g_pod_string = @rk_cur *rk_plus(*g_pod_string_character, FAIL, 0);
g_pod_string_character = FENCE((*g_pod_balanced_braces) | (*g_pod_formatting_code) | ((FENCE((NOTANY(nl cr)) | ((FAIL (cr nl | nl | cr) (FENCE((FAIL @rk_cur *rk_nla(@rk_cur *rk_star(ANY(rk_h), FAIL, 0) '=end' @rk_cur *rk_plus(ANY(rk_h), FAIL, 0) *g_podx2ddelimx2dcodex2dtyp)) | (@rk_cur *rk_nla(@rk_cur *rk_star(ANY(rk_h), FAIL, 0) '=' ANY(rk_w)))))))))));
...
g_pod_block__delimited_table = @rk_cur *rk_bol() (@rk_cur *rk_star(ANY(rk_h), FAIL, 0)) '=begin' @rk_cur *rk_plus(ANY(rk_h), FAIL, 0) 'table' *g_pod_configuration @rk_cur *rk_plus(*g_pod_newline, FAIL, 0) (@rk_cur *rk_star((*g_table_row_or_blank), FAIL, 0) @rk_cur *rk_bol() @rk_cur *rk_star(ANY(rk_h), FAIL, 0) '=end' @rk_cur *rk_plus(ANY(rk_h), FAIL, 0) (FENCE(('table' (@rk_cur *rk_ltm2((*g_pod_newline), (RPOS(0))))) | (FENCE((*g_identifier) | epsilon)))));
g_podx2ddelimx2dcodex2dtyp = @rk_cur *rk_ltm2(('c' 'o' 'd' 'e'), (@rk_cur *rk_ltm2(('i' 'n' 'p' 'u' 't'), ('o' 'u' 't' 'p' 'u' 't'))));
...
g_delimited_code_content = @rk_cur *rk_bol() @rk_cur *rk_star((@rk_cur *rk_ltm2((*rk_var_x24spaces @rk_cur *rk_nla('=end' @rk_cur *rk_plus(ANY(rk_h), FAIL, 0) *g_podx2ddelimx2dcodex2dtyp (@rk_cur *rk_ltm2((*g_pod_newline), (RPOS(0))))) (FENCE((*g_pod_string) | epsilon)) *g_pod_newline), (*g_pod_newline))), FAIL, 0);
g_table_row = @rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_nla('=' ANY(rk_w)) @rk_cur *rk_plus(NOTANY(nl cr), FAIL, 0) (@rk_cur *rk_ltm2(((cr nl | nl | cr)), (RPOS(0))));
g_table_row_or_blank = @rk_cur *rk_ltm2((*g_table_row), ((@rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_nla('=' ANY(rk_w)) (cr nl | nl | cr))));
g_pod_block__finish = @rk_cur *rk_bol() @rk_cur *rk_star(ANY(rk_h), FAIL, 0) (@rk_cur *rk_ltm2(('=begin' @rk_cur *rk_plus(ANY(rk_h), FAIL, 0) 'finish' *g_pod_newline), (@rk_cur *rk_ltm2(('=for' @rk_cur *rk_plus(ANY(rk_h), FAIL, 0) 'finish' *g_pod_newline), ('=finish' *g_pod_newline))))) @rk_cur *rk_star(LEN(1), FAIL, 0);
...
g_pod_block__paragraph_comment = @rk_cur *rk_bol() (@rk_cur *rk_star(ANY(rk_h), FAIL, 0)) '=for' @rk_cur *rk_plus(ANY(rk_h), FAIL, 0) 'comment' *g_pod_configuration *g_pod_newline @rk_cur *rk_star((@rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_nla('=' ANY(rk_w)) @rk_cur *rk_plus(NOTANY(nl cr), FAIL, 0) (@rk_cur *rk_ltm2(((cr nl | nl | cr)), (RPOS(0))))), FAIL, 0);
...
g_numberedx2dalias = @rk_cur *rk_lb((@rk_cur *rk_ltm2((POS(0)), (ANY(rk_s))))) '#' @rk_cur *rk_la(ANY(rk_s));
g_pod_block__abbreviated = @rk_cur *rk_bol() (@rk_cur *rk_star(ANY(rk_h), FAIL, 0)) '=' @rk_cur *rk_nla(FENCE(('b' 'e' 'g' 'i' 'n') | ('e' 'n' 'd') | ('f' 'o' 'r') | ('f' 'i' 'n' 'i' 's' 'h') | ('c' 'o' 'n' 'f' 'i' 'g'))) ((FENCE((*g_pod_code_parent) | (*g_identifier))) FENCE(((@rk_cur *rk_plus(ANY(rk_h), FAIL, 0) *g_numberedx2dalias)) | epsilon) (@rk_cur *rk_ltm2((@rk_cur *rk_star(ANY(rk_h), FAIL, 0) (cr nl | nl | cr)), (@rk_cur *rk_plus(ANY(rk_h), FAIL, 0))))) (FENCE((*g_pod_textcontent) | epsilon));
g_pod_block__abbreviated_comment = @rk_cur *rk_bol() (@rk_cur *rk_star(ANY(rk_h), FAIL, 0)) '=comment' (@rk_cur *rk_ltm2((@rk_cur *rk_star(ANY(rk_h), FAIL, 0) (cr nl | nl | cr)), (@rk_cur *rk_plus(ANY(rk_h), FAIL, 0)))) @rk_cur *rk_star((@rk_cur *rk_star(ANY(rk_h), FAIL, 0) @rk_cur *rk_nla('=' ANY(rk_w)) @rk_cur *rk_plus(NOTANY(nl cr), FAIL, 0) (@rk_cur *rk_ltm2(((cr nl | nl | cr)), (RPOS(0))))), FAIL, 0);
...
g_pod_block__abbreviated_code = @rk_cur *rk_bol() (@rk_cur *rk_star(ANY(rk_h), FAIL, 0)) '=' *g_podx2ddelimx2dcodex2dtyp FENCE(((@rk_cur *rk_plus(ANY(rk_h), FAIL, 0) '#' ANY(rk_s))) | epsilon) (@rk_cur *rk_ltm2((@rk_cur *rk_star(ANY(rk_h), FAIL, 0) (cr nl | nl | cr)), (@rk_cur *rk_plus(ANY(rk_h), FAIL, 0)))) @rk_cur *rk_star((@rk_cur *rk_nla(@rk_cur *rk_star(ANY(rk_h), FAIL, 0) '=' ANY(rk_w)) *g_pod_line), FAIL, 0);
g_pod_line = (*g_pod_string) (@rk_cur *rk_ltm2((*g_pod_newline), (RPOS(0))));
g_pod_newline = @rk_cur *rk_star(ANY(rk_h), FAIL, 0) (cr nl | nl | cr);
g_pod_code_parent = (@rk_cur *rk_ltm2(((@rk_cur *rk_ltm2(('pod'), (@rk_cur *rk_ltm2(('item' @rk_cur *rk_star(ANY(rk_digit), FAIL, 0)), (@rk_cur *rk_ltm2(('nested'), (@rk_cur *rk_ltm2(('defn'), ('finish')))))))))), (@rk_cur *rk_plus(ANY(rk_upper), FAIL, 0)))) @rk_cur *rk_nla(ANY(rk_w));
q_escape = FAIL;
q_backslash = FAIL;
...
q_b1_backslash__n = 'n';
q_b1_backslash__o = 'o' (@rk_cur *rk_ltm2((*hll_octint), (@rk_cur *rk_ltm2(('[' *hll_octints ']'), ('{' *std_obsbrace)))));
q_b1_backslash__r = 'r';
q_b1_backslash__rn = 'r\n';
q_b1_backslash__t = 't';
q_b1_backslash__x = 'x' (@rk_cur *rk_ltm2((*hll_hexint), (@rk_cur *rk_ltm2(('[' *hll_hexints ']'), ('{' *std_obsbrace)))));
q_b1_backslash__0 = '0';
...
q_cc_escape__x2ex2e = '..' (FENCE((epsilon epsilon) | (@rk_cur *rk_la(@rk_cur *rk_star(ANY(rk_s), FAIL, 0) @rk_cur *rk_nla(*q_cc_stopper) @rk_cur *rk_nla('..') NOTANY(rk_s))) | (epsilon)));
q_cc_escape__x2d = '-' epsilon @rk_cur *rk_star(ANY(rk_s), FAIL, 0) @rk_cur *rk_nla(*q_cc_stopper) NOTANY(rk_s) FAIL;
...
q_cc_backslash__n = 'n';
q_cc_backslash__o = 'o' (@rk_cur *rk_ltm2((*hll_octint), (@rk_cur *rk_ltm2(('[' *hll_octints ']'), ('{' *std_obsbrace)))));
q_cc_backslash__r = 'r';
q_cc_backslash__s = 's';
q_cc_backslash__t = 't';
q_cc_backslash__v = 'v';
q_cc_backslash__w = 'w';
q_cc_backslash__x = 'x' (@rk_cur *rk_ltm2((*hll_hexint), (@rk_cur *rk_ltm2(('[' *hll_hexints ']'), ('{' *std_obsbrace)))));
q_cc_backslash__0 = '0';
rx_normspace = @rk_cur *rk_la(@rk_cur *rk_ltm2((ANY(rk_s)), ('#'))) *rk_lang_ws;
rx_rxstopper = *std_stopper;
rx_metachar__x3amy = ':' @rk_cur *rk_la(@rk_cur *rk_ltm2(('my'), (@rk_cur *rk_ltm2(('constant'), (@rk_cur *rk_ltm2(('state'), (@rk_cur *rk_ltm2(('our'), (@rk_cur *rk_ltm2(('temp'), ('let'))))))))))) *g_statement @rk_cur *rk_nla(*std_RESTRICTED) *g_eat_terminator;
rx_metachar__x7bx20x7d = @rk_cur *rk_la(ANY('{')) *rx_codeblock;
rx_metachar__rakvar = @rk_cur *rk_la(*rk_m_sigil (@rk_cur *rk_ltm2((ANY(rk_alpha)), (@rk_cur *rk_ltm2((*rk_cdiff('W', rk_s) ANY(rk_alpha)), ('(')))))) @rk_cur *rk_nla(*rk_m_sigil *rx_rxstopper) *g_variable (FENCE(((@rk_cur *rk_star(ANY(rk_s), FAIL, 0) '=' @rk_cur *rk_star(ANY(rk_s), FAIL, 0) *rk_m_quantified_atom)) | (FENCE(((@rk_cur *rk_la(FENCE(('.') | epsilon) ANY('[{<')) epsilon)) | epsilon)))) epsilon;
...
rx_assertion__var = (@rk_cur *rk_ltm2((@rk_cur *rk_la(ANY('&')) @rk_cur *rk_nla(*std_RESTRICTED) *g_term__variable FENCE(((@rk_cur *rk_ltm2((':' *rx_arglist), ('(' *rx_arglist ')')))) | epsilon)), (@rk_cur *rk_la(*rk_m_sigil) @rk_cur *rk_nla(*std_RESTRICTED) *g_term__variable)));
rx_assertion__x7ex7e = '~~' @rk_cur *rk_nla(*std_RESTRICTED) (@rk_cur *rk_ltm2((@rk_cur *rk_la(ANY('>'))), (@rk_cur *rk_ltm2(((@rk_cur *rk_plus(ANY(rk_digit), FAIL, 0))), (*g_desigilname)))));
rx_codeblock = @rk_cur *rk_nla(*std_RESTRICTED) *g_block;
rx_arglist = @rk_cur *rk_nla(*std_RESTRICTED) *g_arglist;
rx_assertion__name = *g_longname FENCE(((@rk_cur *rk_ltm2((@rk_cur *rk_la(ANY('>'))), (@rk_cur *rk_ltm2(('=' *rx_assertion), (@rk_cur *rk_ltm2((':' *rx_arglist), (@rk_cur *rk_ltm2(('(' *rx_arglist ')'), (*rx_normspace *rk_m_nibbler)))))))))) | epsilon);
...
hll_postfixish = @rk_cur *rk_ltm2((*g_postfix), (*g_postcircumfix));
...
hll_quote_atom = @rk_cur *rk_nla(*std_stopper) (@rk_cur *rk_ltm2((*hll_quote_escape), (@rk_cur *rk_ltm2((@rk_cur *rk_plus((NOTANY(rk_alpha rk_alpha rk_alpha)), FAIL, 0)), (*std_starter @rk_cur *rk_star(*hll_quote_atom, FAIL, 0) *std_stopper)))));
hll_decint = @rk_cur *rk_plus((@rk_cur *rk_plus(ANY(rk_digit), FAIL, 0)), '_', 1);
hll_decints = @rk_cur *rk_plus((*g_ws *hll_decint *g_ws), ',', 1);
hll_hexint = @rk_cur *rk_plus((@rk_cur *rk_plus((@rk_cur *rk_ltm2((ANY(rk_digit)), (ANY('abcdefABCDEFａｆＡＦ')))), FAIL, 0)), '_', 1);
...
hll_integer = (@rk_cur *rk_ltm2(('0' (@rk_cur *rk_ltm2(('b' *hll_binint), (@rk_cur *rk_ltm2(('o' *hll_octint), (@rk_cur *rk_ltm2(('x' *hll_hexint), ('d' *hll_decint)))))))), (*hll_decint)));
hll_dec_number = @rk_cur *rk_ltm2((('.' @rk_cur *rk_plus(ANY(rk_digit), FAIL, 0)) FENCE((*g_escale) | epsilon)), (@rk_cur *rk_ltm2(((@rk_cur *rk_plus(ANY(rk_digit), FAIL, 0) '.' @rk_cur *rk_plus(ANY(rk_digit), FAIL, 0)) FENCE((*g_escale) | epsilon)), ((@rk_cur *rk_plus(ANY(rk_digit), FAIL, 0)) *g_escale))));
...
hll_quote_escape__hex = '\' 'x' @rk_cur *rk_la(*hll_quotemod_check) (@rk_cur *rk_ltm2((*hll_hexint), ('[' *hll_hexints ']')));
hll_quote_escape__oct = '\' 'o' @rk_cur *rk_la(*hll_quotemod_check) (@rk_cur *rk_ltm2((*hll_octint), ('[' *hll_octints ']')));
...
hll_quote_escape__misc = '\' (FENCE((@rk_cur *rk_la(*hll_quotemod_check) (@rk_cur *rk_ltm2(((NOTANY(rk_w))), ((ANY(rk_w)))))) | ((LEN(1)))));
...
hll_charspec = (@rk_cur *rk_ltm2(('[' *hll_charnames ']'), (@rk_cur *rk_ltm2((@rk_cur *rk_plus(ANY(rk_digit), FAIL, 0) @rk_cur *rk_star(('_' @rk_cur *rk_plus(ANY(rk_digit), FAIL, 0)), FAIL, 0)), (@rk_cur *rk_ltm2((ANY('?@ABCDEFGHIJKLMNOPQRSTUVWXYZ')), (FAIL)))))));
