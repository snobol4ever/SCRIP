...
# `corpus/demo/json/json.ref`, pinned `root=JOBJ` for a `DATATYPE()` bug that upper-cased
...
selftest() {
  ...
  st="$(mktemp -d)"; witness="$CORPUS/demo/json/json.sno"; win="$CORPUS/demo/json/json.input"
