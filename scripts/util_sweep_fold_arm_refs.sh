...
# `corpus/demos/snobol4/json/json.ref`, pinned `root=JOBJ` for a `DATATYPE()` bug that upper-cased
...
selftest() {
  ...
  st="$(mktemp -d)"; witness="$CORPUS/demos/snobol4/json/json.sno"; win="$CORPUS/demos/snobol4/json/json.input"
