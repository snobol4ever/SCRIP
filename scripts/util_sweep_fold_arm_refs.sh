...
# (programs/snobol4/demo's numbered/lettered variants -- calculator-1, calculator-2, treebank-alloc -- all
...
selftest() {
  ...
  st="$(mktemp -d)"; witness="$CORPUS/programs/snobol4/demo/json.sno"; win="$CORPUS/programs/snobol4/demo/json.input"
