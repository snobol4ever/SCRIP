...
echo "------------------------------------------------------------"
echo "------------------------------------------------------------"
echo "GC ACCEPTANCE — the four numbers of CEO-1039 — WARN-ONLY, does not affect the verdict below"
echo "    (Lon 2026-09-21 ordered the metrics displayed periodically; a handoff is the boundary where a stale"
