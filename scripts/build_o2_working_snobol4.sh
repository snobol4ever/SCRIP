...
for f in src/runtime/rt/rt.c src/runtime/pattern_match.c; do
  b="$(basename "${f%.*}").o"
  inc="-I$ROOT/src -I$ROOT/src/include -I$ROOT/src/contracts -I$ROOT/src/lower -I$ROOT/src/machine -I$ROOT/src/emitter -I$ROOT/src/runtime/core -I$ROOT/src/runtime/builtins -I$ROOT/src/runtime -I$ROOT/src/runtime/rt -I$ROOT/src/parsers/snobol4 -I$ROOT/src/parsers/raku -I$ROOT/src/optimizer"
