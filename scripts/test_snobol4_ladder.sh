...
# ⛔ STATE OF THIS LADDER RIGHT NOW (hq_T 2026-09-03, measured): corpus/tests/snobol4/ALL.csv carries ZERO
...
# rungs is row snobol4-construct-ladder-from-rung-0-with-trace-refs (seat12); the runner is ready for them now.
