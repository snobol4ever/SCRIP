...
#
# Default corpus: corpus/programs/prolog/*.pl + corpus/benchmarks/prolog/bench/*.pl.
...
if [ ${#FILES[@]} -eq 0 ]; then
    mapfile -t FILES < <(ls "$S4E"/corpus/programs/prolog/*.pl "$S4E"/corpus/benchmarks/prolog/bench/*.pl 2>/dev/null)
fi
