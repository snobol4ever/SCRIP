...
#   JASMIN        path to jasmin.jar                (default: <root>/src/backends/jasmin.jar)
...
run_snobol4_js() {
  ...
  local W="$WORK/$cell"; mkdir -p "$W"
  local SNO_RT="$ROOT/src/backends/runtime/js/sno_runtime.js"
  local SNO_ENG="$ROOT/src/backends/runtime/js/sno_engine.js"
