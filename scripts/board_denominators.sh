...
case "$SEL" in
    ...
    "")
        ...
        row beauty_total    "$(d_beauty_total)"      ".sno files in beauty_suite/ — DRIVERS ONLY since 2026-08-29: the 17 include-sources were deduplicated into corpus/library/*.inc, so no non-driver .sno remains here"
