...
#   (a) every census trips on a PLANTED violation and passes a clean fixture -- util_gc_census.py --selftest, 32 arms COUNTED as they run (the arm asserts >= 25; the tool itself refuses below its own floor)
