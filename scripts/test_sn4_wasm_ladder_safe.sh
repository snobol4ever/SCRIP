...
WASM_RUNTIME_WAT="${WASM_RUNTIME_WAT:-$HERE/../interpreters/runtime/wasm/sno_runtime.wat}"
WASM_RUNTIME_WASM="${WASM_RUNTIME_WAT%.wat}.wasm"
WASM_BB_WAT="${WASM_BB_WAT:-$HERE/../interpreters/runtime/wasm/bb_boxes.wat}"
WASM_BB_WASM="${WASM_BB_WAT%.wat}.wasm"
HOST_MJS="${HOST_MJS:-$HERE/../interpreters/runtime/wasm/sno_host.mjs}"
TIMEOUT="${TIMEOUT:-6}"
