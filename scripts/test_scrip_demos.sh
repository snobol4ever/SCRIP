#!/usr/bin/env bash
# scripts/test_scrip_demos.sh — run all scrip demo/*.md files via --run and compare to .expected
#
...
# Each demo's .expected reflects what --run produces for the full polyglot .md.
