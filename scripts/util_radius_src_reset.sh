...
DIRS=${*:-"$S4E/corpus/library/probe_reference/bb $S4E/corpus/tests/snobol4 $S4E/corpus/crosscheck $S4E/corpus/probe/eval $S4E/corpus/tests/icon $S4E/corpus/tests/prolog"}
