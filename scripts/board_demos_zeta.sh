...
declare -A IN=(
  ...
  [treebank-array]=treebank.input
  [treebank-match]=treebank.input
  [treebank-match-fence]=treebank.input
)

ORDER="claws5 claws5-match claws5-match-fence json json-match json-match-fence calculator-1 calculator-1-match calculator-1-match-fence calculator-2 calculator-2-match calculator-2-match-fence treebank-list treebank-array treebank-match treebank-match-fence"
