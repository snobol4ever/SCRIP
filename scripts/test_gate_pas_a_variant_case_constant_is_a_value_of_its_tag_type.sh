...
if [ "$RC" = 0 ]; then echo "GATE PASS [$G]: $N variant-parts whose case-constants are not exactly the values of their tag-type refused with a NAMED diagnostic in both modes, and legal ones are untouched"
