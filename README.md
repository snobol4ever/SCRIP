...
<!-- SUITE-TABLE:BEGIN generated by .github/scripts/util_suite_banner.py --readme from .github/SUITES.tsv at .github@8ffe9ce6 -- do not edit by hand; scripts/test_gate_readme_suite_table_matches_suites_tsv.sh holds it -->
...
|---|---|---|---|---|---|
| SNOBOL4 | Gimpel | **129/144** | `55f6339b9` | 2026-09-23 | `test_snobol4_gimpel_suite.sh` |
| SNOBOL4 | Budne | **71/93** | `55f6339b9` | 2026-09-23 | `test_snobol4_csnobol4_suite.sh` |
| SNOBOL4 | Flake | **118/180** | `55f6339b9` | 2026-09-23 | `test_snoflake_suite.sh` |
...
| SNOBOL4 | SnoM (master) | **1960/1982** | `55f6339b9` | 2026-09-23 | `test_corpus_snobol4.sh` |
| SNOBOL4 | SnoBench | not graded |  |  | — |
| Icon | Zona | **88/88** | `7ca372ff6` | 2026-09-23 | `test_icon_arizona_suite.sh` |
| Icon | Jcon | **81/82** | `7ca372ff6` | 2026-09-23 | `test_icon_jcon_suite.sh` |
| Icon | IPL | **194/194** | `7ca372ff6` | 2026-09-23 | `test_icon_ipl_suite.sh` |
| Icon | IcnM (master) | **826/826** | `7ca372ff6` | 2026-09-23 | `board_icon_master.sh` |
| Icon | IcnBench | **26/26** | `7ca372ff6` | 2026-09-23 | `test_icon_bench_suite.sh` |
| Prolog | INRIA | **439/442** | `10f6dd939` | 2026-09-23 | `test_prolog_inria_suite.sh` |
| Prolog | SWI | **1051/2935** | `a5240e77a` | 2026-09-23 | `test_prolog_swi_suite.sh` |
| Prolog | GNU | **11/11** | `ffbf5f3e6` | 2026-09-21 | `test_prolog_gnu_suite.sh` |
| Prolog | Logtalk | **2941/3600** | `30d3340cd` | 2026-09-23 | `test_prolog_logtalk_suite.sh` |
| Prolog | ProM (master) | **563/563** | `a5240e77a` | 2026-09-23 | `corpus_suite_harness.py run tests/prolog/ALL.pl` |
| Prolog | ProBench | **23/23** | `3b5f301f1` | 2026-09-23 | `test_prolog_bench_suite.sh` |
| Pascal | FPC | **149/181** | `8b6cb3607` | 2026-09-24 | `test_pascal_fpc_suite.sh` |
| Pascal | PAT | **362/427** | `8b6cb3607` | 2026-09-24 | `test_pascal_pat_suite.sh` |
| Pascal | PasM (master) | **246/246** | `8b6cb3607` | 2026-09-24 | `corpus_suite_harness.py run tests/pascal/ALL.pas` |
| Pascal | PasBench | **11/11** | `8b6cb3607` | 2026-09-24 | `test_pascal_bench_suite.sh` |
...
| Raku — IN DEVELOPMENT | RakBench | not graded |  |  | — |
| Snocone | SncM (master) | **337/337** | `ecf3aea38` | 2026-09-23 | `corpus_suite_harness.py run tests/snocone/ALL.sc` |
