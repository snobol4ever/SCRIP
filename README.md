...
|---|---|---|---|---|---|
| SNOBOL4 | Gimpel | **129/144** | `0dfb3871b` | 2026-09-24 | `test_snobol4_gimpel_suite.sh` |
| SNOBOL4 | Budne | **71/93** | `55f6339b9` | 2026-09-23 | `test_snobol4_csnobol4_suite.sh` |
| SNOBOL4 | Flake | **118/180** | `0dfb3871b` | 2026-09-24 | `test_snoflake_suite.sh` |
| SNOBOL4 | AIS | **5/7** | `55f6339b9` | 2026-09-23 | `test_snobol4_aisnobol_suite.sh` |
| SNOBOL4 | Dotnet | **5/14** | `55f6339b9` | 2026-09-23 | `test_snobol4_dotnet_suite.sh` |
| SNOBOL4 | TPgm | **1/8** | `61315eaa9` | 2026-09-16 | `test_snobol4_spitbol_testpgms_suite.sh` |
| SNOBOL4 | X64T | **28/36** | `55f6339b9` | 2026-09-23 | `test_snobol4_spitbol_x64_suite.sh` |
| SNOBOL4 | SnoM (master) | **1971/1988** | `096684141` | 2026-09-24 | `test_corpus_snobol4.sh` |
| SNOBOL4 | SnoBench | not graded |  |  | — |
| Icon | Zona | **88/88** | `5d751c855` | 2026-09-24 | `test_icon_arizona_suite.sh` |
| Icon | Jcon | **82/82** | `5d751c855` | 2026-09-24 | `test_icon_jcon_suite.sh` |
| Icon | IPL | **194/194** | `5d751c855` | 2026-09-24 | `test_icon_ipl_suite.sh` |
| Icon | IcnM (master) | **826/826** | `5d751c855` | 2026-09-24 | `board_icon_master.sh` |
| Icon | IcnBench | **26/26** | `5d751c855` | 2026-09-24 | `test_icon_bench_suite.sh` |
| Prolog | INRIA | **442/442** | `825d2ca80` | 2026-09-24 | `test_prolog_inria_suite.sh` |
| Prolog | SWI | **1051/2935** | `a5240e77a` | 2026-09-23 | `test_prolog_swi_suite.sh` |
| Prolog | GNU | **11/11** | `825d2ca80` | 2026-09-24 | `test_prolog_gnu_suite.sh` |
| Prolog | Logtalk | **3235/3600** | `985b89273` | 2026-09-24 | `test_prolog_logtalk_suite.sh` |
| Prolog | ProM (master) | **563/563** | `825d2ca80` | 2026-09-24 | `corpus_suite_harness.py run tests/prolog/ALL.pl` |
| Prolog | ProBench | **23/23** | `3b5f301f1` | 2026-09-23 | `test_prolog_bench_suite.sh` |
| Pascal | FPC | **156/181** | `0595c3ede` | 2026-09-24 | `test_pascal_fpc_suite.sh` |
| Pascal | PAT | **368/427** | `0595c3ede` | 2026-09-24 | `test_pascal_pat_suite.sh` |
| Pascal | PasM (master) | **247/247** | `0595c3ede` | 2026-09-24 | `corpus_suite_harness.py run tests/pascal/ALL.pas` |
| Pascal | PasBench | **11/11** | `0595c3ede` | 2026-09-24 | `test_pascal_bench_suite.sh` |
| Raku — IN DEVELOPMENT | Roast | **9/1464** | `5cc7ba393` | 2026-09-16 | `raku_roast_scoreboard.sh --run` |
| Raku — IN DEVELOPMENT | RakM (master) | **867/929** | `59a62ca3a` | 2026-09-23 | `corpus_suite_harness.py run tests/raku/ALL.raku` |
| Raku — IN DEVELOPMENT | RakBench | **5/17** | `fa8d8fe6d` | 2026-09-24 | `test_raku_bench_suite.sh` |
| Snocone | SncM (master) | **338/338** | `669054c29` | 2026-09-24 | `corpus_suite_harness.py run tests/snocone/ALL.sc` |
| Snocone | SncBench | **16/16** | `8a2e9bdff` | 2026-09-23 | `test_snocone_bench_suite.sh` |
| Rebus | RebM (master) | **43/43** | `fa27bcdf9` | 2026-09-23 | `corpus_suite_harness.py run tests/rebus/ALL.reb` |
| Rebus | RebBench | **3/3** | `84f956364` | 2026-09-23 | `test_rebus_bench_suite.sh` |
<!-- SUITE-TABLE:END -->
