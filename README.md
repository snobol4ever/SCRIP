...
<!-- SUITE-TABLE:BEGIN generated by .github/scripts/util_suite_banner.py --readme from .github/SUITES.tsv at .github@9b6fb3b4 -- do not edit by hand; scripts/test_gate_readme_suite_table_matches_suites_tsv.sh holds it -->
...
| Icon | Zona | **88/88** | `de65960d8` | 2026-09-23 | `test_icon_arizona_suite.sh` |
| Icon | Jcon | **81/82** | `de65960d8` | 2026-09-23 | `test_icon_jcon_suite.sh` |
| Icon | IPL | **194/194** | `de65960d8` | 2026-09-23 | `test_icon_ipl_suite.sh` |
| Icon | IcnM (master) | **826/826** | `9f4da0b64` | 2026-09-23 | `board_icon_master.sh` |
| Icon | IcnBench | **26/26** | `de65960d8` | 2026-09-23 | `test_icon_bench_suite.sh` |
...
| Pascal | FPC | **149/181** | `eb9d2f411` | 2026-09-23 | `test_pascal_fpc_suite.sh` |
| Pascal | PAT | **339/427** | `eb9d2f411` | 2026-09-23 | `test_pascal_pat_suite.sh` |
| Pascal | PasM (master) | **246/246** | `eb9d2f411` | 2026-09-23 | `corpus_suite_harness.py run tests/pascal/ALL.pas` |
| Pascal | PasBench | **11/11** | `eb9d2f411` | 2026-09-23 | `test_pascal_bench_suite.sh` |
