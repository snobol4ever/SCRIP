...
<!-- SUITE-TABLE:BEGIN generated by .github/scripts/util_suite_banner.py --readme from .github/SUITES.tsv at .github@823ff463 -- do not edit by hand; scripts/test_gate_readme_suite_table_matches_suites_tsv.sh holds it -->
...
| Pascal | FPC | **147/181** | `922c376ae` | 2026-09-23 | `test_pascal_fpc_suite.sh` |
| Pascal | PAT | **313/427** | `922c376ae` | 2026-09-23 | `test_pascal_pat_suite.sh` |
| Pascal | PasM (master) | **246/246** | `922c376ae` | 2026-09-23 | `corpus_suite_harness.py run tests/pascal/ALL.pas` |
...
| Snocone | SncM (master) | **337/337** | `ff2300d0e` | 2026-09-23 | `corpus_suite_harness.py run tests/snocone/ALL.sc` |
