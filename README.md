...
<!-- SUITE-TABLE:BEGIN generated by .github/scripts/util_suite_banner.py --readme from .github/SUITES.tsv at .github@4f4ca80f -- do not edit by hand; scripts/test_gate_readme_suite_table_matches_suites_tsv.sh holds it -->
...
|---|---|---|---|---|---|
| SNOBOL4 | Gimpel | **127/132** | `6ea8abdde` | 2026-09-22 | `test_snobol4_gimpel_suite.sh` |
| SNOBOL4 | Budne | **71/71** | `3312ba787` | 2026-09-23 | `test_snobol4_csnobol4_suite.sh` |
| SNOBOL4 | Flake | **110/124** | `58820a280` | 2026-09-22 | `test_snoflake_suite.sh` |
| SNOBOL4 | AIS | **4/7** | `9dc4d12d4` | 2026-09-23 | `test_snobol4_aisnobol_suite.sh` |
| SNOBOL4 | Dotnet | **5/5** | `8f567e685` | 2026-09-16 | `test_snobol4_dotnet_suite.sh` |
| SNOBOL4 | TPgm | **1/8** | `61315eaa9` | 2026-09-16 | `test_snobol4_spitbol_testpgms_suite.sh` |
| SNOBOL4 | X64T | **20/36** | `9dc4d12d4` | 2026-09-23 | `test_snobol4_spitbol_x64_suite.sh` |
| SNOBOL4 | SnoM (master) | **1956/1982** | `9dc4d12d4` | 2026-09-23 | `test_corpus_snobol4.sh` |
| SNOBOL4 | SnoBench | not graded |  |  | — |
| Icon | Zona | **88/88** | `9f4da0b64` | 2026-09-23 | `test_icon_arizona_suite.sh` |
| Icon | Jcon | **82/82** | `9f4da0b64` | 2026-09-23 | `test_icon_jcon_suite.sh` |
| Icon | IPL | **194/194** | `3fab59506` | 2026-09-23 | `test_icon_ipl_suite.sh` |
| Icon | IcnM (master) | **826/826** | `9f4da0b64` | 2026-09-23 | `board_icon_master.sh` |
| Icon | IcnBench | not graded |  |  | — |
...
| Prolog | ProBench | not graded |  |  | — |
| Pascal | FPC | **149/181** | `863e3e3b2` | 2026-09-23 | `test_pascal_fpc_suite.sh` |
| Pascal | PAT | **332/427** | `863e3e3b2` | 2026-09-24 | `test_pascal_pat_suite.sh` |
| Pascal | PasM (master) | **246/246** | `863e3e3b2` | 2026-09-24 | `corpus_suite_harness.py run tests/pascal/ALL.pas` |
| Pascal | PasBench | **11/11** | `863e3e3b2` | 2026-09-23 | `test_pascal_bench_suite.sh` |
