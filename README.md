...
<!-- SUITE-TABLE:BEGIN generated by .github/scripts/util_suite_banner.py --readme from .github/SUITES.tsv at .github@93f235da -- do not edit by hand; scripts/test_gate_readme_suite_table_matches_suites_tsv.sh holds it -->
...
*Measured 2026-09-25 13:2x CDT on SCRIP `3a936a797` / corpus `4d805e1bc`, **RT_OPT=-O0**, load 1.0–1.4 on 16 cores under MODE CEO (the
fleet stood down), **500 ms of repetitions per point**, five iterations (`BENCH_BUD_MS=500 BENCH_ITER_N=5`, one warm-up repetition
first; the 500 ms budget was proven against 5 s points kernel for kernel on 444e9893d), oracle `spitbol-bench-oracle/sbl -bf` (the
clean benchmark oracle, never the monitor-hooked correctness fork). **Both engines at SPITBOL's own defaults** (`-d128m -i1m -s4m`:
SCRIP's shipped defaults since CEO-1261), SCRIP with every diagnostic off (`SCRIP_DIAG=0`, CEO-1262). 23 of 23 kernels printed their
ref on every angle in all three engines.* The per-repetition figure is the fixed-time twin's (microseconds per repetition of the
kernel's own function); the x-factor is SPITBOL time / SCRIP time on that same twin (1.5x is one and a half times faster, 0.5x half
as fast). The last two columns are the mode-4 x-factor of the grid this one replaces (`80ee6bb5c`, 09:2x the same day, at the
then-shipped 128 KB window) and of the 2026-09-03 tree `380cc4162`, rebuilt and run 2026-09-24, for the regression story below.

| kernel | SPITBOL µs/rep | m3 µs/rep | m4 µs/rep | m3 | m4 | `80ee6bb5c` m4 | `380cc4162` m4 |
|---|---:|---:|---:|:---:|:---:|:---:|:---:|
| arith_loop | 26.4 | 6.9 | 6.6 | 3.80x | 4.03x | 3.68x | 4.03x |
| arith_loop_twin | 7436.1 | 2121.6 | 2215.7 | 3.50x | 3.36x | 3.19x | 3.47x |
| array_sum | 569.9 | 261.2 | 261.6 | 2.18x | 2.18x | 1.50x | 0.27x |
| eval_fixed | 138.4 | 198.0 | 198.5 | 0.70x | 0.70x | 0.65x | 0.96x |
| fib_recur | 3807.4 | 2158.9 | 2367.4 | 1.76x | 1.61x | 1.61x | 1.78x |
| fibonacci | 237.7 | 137.3 | 145.4 | 1.73x | 1.63x | 1.55x | 1.66x |
| func_call | 33.9 | 16.0 | 16.6 | 2.12x | 2.04x | 2.09x | 2.01x |
| ident_call1 | 28.7 | 10.9 | 10.8 | 2.62x | 2.65x | 2.61x | 2.46x |
| ident_call2 | 29.3 | 10.6 | 10.0 | 2.77x | 2.92x | 3.18x | 2.36x |
| indirect_dispatch | 26.9 | 46.3 | 47.3 | 0.58x | 0.57x | 0.47x | 0.62x |
| mixed_workload | 31.1 | 36.8 | 36.1 | 0.85x | 0.86x | 0.44x | 0.28x |
| name_indirection | 968.3 | 1328.1 | 1344.0 | 0.73x | 0.72x | 0.42x | — |
| op_dispatch | 54.4 | 15.7 | 13.7 | 3.46x | 3.96x | 3.37x | 3.73x |
| pattern_bt | 219.7 | 178.5 | 162.7 | 1.23x | 1.35x | 1.10x | 1.47x |
| roman | 160.9 | 190.6 | 170.4 | 0.84x | 0.94x | 0.67x | 0.78x |
| string_concat | 34.3 | 37.6 | 39.4 | 0.91x | 0.87x | 0.88x | 0.65x |
| string_concat_twin | 205.0 | 161.0 | 158.8 | 1.27x | 1.29x | 1.84x | 0.98x |
| string_manip | 64.8 | 60.8 | 60.3 | 1.07x | 1.07x | 0.64x | 0.66x |
| string_pattern | 67.5 | 75.9 | 75.7 | 0.89x | 0.89x | 0.86x | 0.92x |
| table_access | 739.8 | 581.3 | 578.7 | 1.27x | 1.28x | 0.36x | 1.29x |
| table_variety | 580.6 | 535.6 | 545.3 | 1.08x | 1.06x | 0.46x | 0.68x |
| test_icon | 1.0 | 0.3 | 0.3 | 3.58x | 4.06x | 3.31x | 4.12x |
| var_access | 59.8 | 17.1 | 16.5 | 3.50x | 3.63x | 3.83x | 4.25x |

Geometric mean over the 23 kernels: **1.55x** in mode 3, **1.57x** in mode 4; SCRIP is ahead of SPITBOL on 16 of 23
kernels (2026-09-25 09:2x on 80ee6bb5c: 1.16x / 1.26x; 03:2x on 82b4a61a8: 1.13x / 1.23x; 02:5x on bf9613327: 1.14x / 1.23x; 02:2x on 40a7bac3c: 1.12x / 1.21x; 00:4x on 6134f316c: 1.04x / 1.14x; 2026-09-24 22:04 on 74729b18b: 0.94x / 1.00x; 20:16 that day, on 73295fba6: 0.78x / 0.84x; 17:2x, before the by-name landing: 0.70x / 0.75x; that morning
...
collector's pacing (`3a936a797`, CEO-1264) moved no kernel; it moved treebank (below). Where SCRIP still trails, the operation is reached
...
**The workhorse demos on their large inputs, whole program, best of 5, mode 4, tree `3a936a797`, 2026-09-25 13:2x CDT, load 1.0,
...
|---|---:|---:|---:|:---:|
| claws5 (CLAWS5inTASA.dat ×16) | 1,043 KB | 68 | 64 | 1.06x |
| treebank (treebank.input ×1024) | 327 KB | 112 | 169 | 0.66x |
| json (citm_catalog.json) | 1,686 KB | 34 | 42 | 0.81x |
| porter (porter.input ×4) | 742 KB | 220 | 268 | 0.82x |
| calculator-1 (calculator.input ×4) | 127 KB | 28 | 60 | 0.47x |
| calculator-2 (calculator.input ×4) | 127 KB | 33 | 59 | 0.56x |
