...
.Lx76_240:              mov              qword ptr [rsp + 0], rax                       # result
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]; jmp   n21_lit_integer_α
...
.Lx102_0:               lea              rdi, [rsp + 32]
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]; jmp   n40_coerce_numeric_α
...
.Lx104_0:               lea              rdi, [rsp + 32]
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]; jmp   n41_cmp_test_α
...
n41_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]
                        test             eax, eax;                  je    .Lx106_240
                        add              rsp, 16;                   jmp   n40_coerce_numeric_β
.Lx106_240:             mov              qword ptr [rsp + 0], 0                         # result
...
#-----------------------------------------------------------------------------------------------------------------------
n44_goto_α:                                                         jmp   n11_statement_begin_α
