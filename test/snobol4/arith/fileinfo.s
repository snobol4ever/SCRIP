...
n23_binop_α:            sub              rsp, 16
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]; jmp   n24_var_α
...
n25_binop_α:            sub              rsp, 16
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]; jmp   n26_lit_string_α
...
#-----------------------------------------------------------------------------------------------------------------------
n30_goto_α:                                                         jmp   n7_statement_begin_α
n30_goto_β:                                                         jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n31_goto_α:                                                         jmp   n20_statement_begin_α
n31_goto_β:                                                         jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
main_β:
                                                                    jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
