...
n105_var_α:
                        ...
                        mov              qword ptr [rsp + 232], rdx
                                                                                        jmp   n106_coerce_numeric_α
n105_var_β:
                                                                                        jmp   n102_statement_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n106_coerce_numeric_α:
...
.Lx551_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n142_cmp_test_α
n141_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n140_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n142_cmp_test_α:
                        sub              rsp, 16
...
.Lx606_19:
                        add              rsp, 32
                                                                                        jmp   n179_match_pos_β
#-----------------------------------------------------------------------------------------------------------------------
n181_match_assign_save_α:
                        sub              rsp, 16
                        mov              dword ptr [rsp + 0], r14d
                                                                                        jmp   n182_match_rem_α
n181_match_assign_save_β:
                        add              rsp, 16
                                                                                        jmp   n180_match_alternate_β
#-----------------------------------------------------------------------------------------------------------------------
n182_match_rem_α:
                        sub              rsp, 16
                        mov              dword ptr [rsp + 0], r14d
...
n187_statement_end_α:
                                                                                        jmp   n190_statement_begin_α
n187_statement_end_β:
                                                                                        jmp   n190_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n188_match_lit_α:
                                                                                        jmp   n180_match_alternate_s1
n188_match_lit_β:
                                                                                        jmp   n180_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
n189_match_span_α:
                        lea              rdi, [rip + .S1]
                        lea              rsi, [rsp + 1440]
...
.Lx622_1:
                        ...
                        test             eax, eax
                                                                                        jle   n180_match_alternate_af
                        mov              edx, r14d
                        mov              dword ptr [rsp + 1444], edx
                        add              edx, eax
                        mov              r14d, edx
                                                                                        jmp   n180_match_alternate_s0
n189_match_span_β:
...
n197_func_activate_β:
                                                                                        jmp   n196_statement_begin_β
.Lx636_0:
                        .quad            .Lx636_0_s
.Lx636_0_s:
                        .string          "rtrim"
...
n198_statement_end_α:
                                                                                        jmp   n252_statement_begin_α
n198_statement_end_β:
                                                                                        jmp   n252_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
rtrim_body:
                                                                                        jmp   n200_lit_string_α
n199_statement_begin_β:
                                                                                        jmp   n212_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n200_lit_string_α:
...
n210_assign_α:
                        ...
                        mov              qword ptr [r9 + 96], rax                       # ws
                        mov              qword ptr [r9 + 104], rdx
                                                                                        jmp   n211_statement_end_α
n210_assign_β:
                                                                                        jmp   n199_statement_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n211_statement_end_α:
                                                                                        jmp   n212_statement_begin_α
n211_statement_end_β:
                                                                                        jmp   n212_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n212_statement_begin_α:
                                                                                        jmp   n213_var_α
n212_statement_begin_β:
...
n233_var_α:
                        ...
                        mov              qword ptr [rsp + 2184], rdx
                                                                                        jmp   n234_coerce_string_α
n233_var_β:
                                                                                        jmp   n245_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n234_coerce_string_α:
                        lea              rdi, [rsp + 2176]
                        lea              rsi, [rsp + 2160]
                        mov              rdx, 3866683
                        mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        ...
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n235_match_begin_α
n234_coerce_string_β:
                                                                                        jmp   n245_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n235_match_begin_α:
                        mov              qword ptr [rsp + 48], r13                      # outer_Σ
...
n283_var_α:
                        ...
                        mov              qword ptr [rsp + 2776], rdx
                                                                                        jmp   n284_coerce_string_α
n283_var_β:
                                                                                        jmp   FRETURN
#-----------------------------------------------------------------------------------------------------------------------
n284_coerce_string_α:
                        lea              rdi, [rsp + 2768]
                        lea              rsi, [rsp + 2752]
                        mov              rdx, 4522053
                        mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
...
n317_statement_end_α:
                                                                                        jmp   RETURN
n317_statement_end_β:
                                                                                        jmp   FRETURN
#-----------------------------------------------------------------------------------------------------------------------
n318_statement_begin_α:
                                                                                        jmp   n319_statement_end_α
n318_statement_begin_β:
                                                                                        jmp   n320_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n319_statement_end_α:
                                                                                        jmp   n320_statement_begin_α
n319_statement_end_β:
                                                                                        jmp   n320_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n320_statement_begin_α:
                                                                                        jmp   n321_func_activate_α
n320_statement_begin_β:
                                                                                        jmp   n348_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n321_func_activate_α:
...
n321_func_activate_β:
                                                                                        jmp   n320_statement_begin_β
.Lx835_0:
                        .quad            .Lx835_0_s
.Lx835_0_s:
                        .string          "index"
...
n333_var_α:
                        ...
                        mov              qword ptr [rsp + 3352], rdx
                                                                                        jmp   n334_coerce_string_α
n333_var_β:
                                                                                        jmp   RETURN
#-----------------------------------------------------------------------------------------------------------------------
n334_coerce_string_α:
                        lea              rdi, [rsp + 3344]
                        lea              rsi, [rsp + 3328]
                        mov              rdx, 4522053
                        mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        ...
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n335_match_begin_α
n334_coerce_string_β:
                                                                                        jmp   RETURN
#-----------------------------------------------------------------------------------------------------------------------
n335_match_begin_α:
                        mov              qword ptr [rsp + 48], r13                      # outer_Σ
...
n336_match_assign_save_α:
                        sub              rsp, 16
                        mov              dword ptr [rsp + 0], r14d
                                                                                        jmp   n337_match_break_α
n336_match_assign_save_β:
                        add              rsp, 16
                                                                                        jmp   n335_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n337_match_break_α:
                        sub              rsp, 16
                        mov              dword ptr [rsp + 0], 0
...
n338_match_assign_cond_α:
                        ...
                        mov              qword ptr [r12 + 16], rdx
                        add              r12, 24
                                                                                        jmp   n339_match_end_α
n338_match_assign_cond_β:
                        sub              r12, 24
                                                                                        jmp   n337_match_break_β
#-----------------------------------------------------------------------------------------------------------------------
n339_match_end_α:
                        mov              r8, r12
.Lx865_9:
...
n404_statement_end_α:
                                                                                        jmp   n409_statement_begin_α
n404_statement_end_β:
                                                                                        jmp   n409_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n405_statement_begin_α:
...
.Lx972_0_s:
                        .string          "OUTPUT"
#-----------------------------------------------------------------------------------------------------------------------
n408_statement_end_α:
                                                                                        jmp   n409_statement_begin_α
n408_statement_end_β:
                                                                                        jmp   n409_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n409_statement_begin_α:
                                                                                        jmp   n410_statement_end_α
n409_statement_begin_β:
                                                                                        jmp   n411_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n410_statement_end_α:
                                                                                        jmp   n411_statement_begin_α
n410_statement_end_β:
                                                                                        jmp   n411_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx990_0_s:
                        .string          "OUTPUT"
#-----------------------------------------------------------------------------------------------------------------------
n419_statement_end_α:
                                                                                        jmp   n424_statement_begin_α
n419_statement_end_β:
                                                                                        jmp   n424_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n420_statement_begin_α:
                                                                                        jmp   n421_lit_string_α
n420_statement_begin_β:
                                                                                        jmp   n424_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n421_lit_string_α:
...
n423_statement_end_α:
                                                                                        jmp   n424_statement_begin_α
n423_statement_end_β:
                                                                                        jmp   n424_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n424_statement_begin_α:
                                                                                        jmp   n425_statement_end_α
n424_statement_begin_β:
                                                                                        jmp   n426_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n425_statement_end_α:
                                                                                        jmp   n426_statement_begin_α
n425_statement_end_β:
                                                                                        jmp   n426_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n426_statement_begin_α:
                                                                                        jmp   n427_lit_string_α
n426_statement_begin_β:
                        add              rsp, 448
