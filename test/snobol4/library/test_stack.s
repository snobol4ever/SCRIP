...
# IR_MATCH_SEQ_NARY
 xchain0_n51_α:
 mov dword ptr [r12 + 1696], r14d
 mov dword ptr [r12 + 1700], 0
 jmp xchain0_n54_α
xchain0_n51_as:
 mov eax, dword ptr [r12 + 1700]
 add eax, 1
 mov dword ptr [r12 + 1700], eax
 cmp eax, 1
 je xchain0_n56_α
 cmp eax, 2
 je xchain0_n57_α
...
.Lx71_1:
 ...
 xchain0_n60_β:
 mov eax, r14d
 sub eax, dword ptr [r12 + 1776]
 mov r14d, eax
 jmp xchain0_n54_β
# IR_MATCH_REM
 xchain0_n61_α:
 mov dword ptr [r12 + 1872], r14d
 mov r14d, r15d
 jmp xchain0_n58_α
 xchain0_n61_β:
 mov r14d, dword ptr [r12 + 1872]
 jmp xchain0_n57_β
# IR_MATCH_REPLACE
 xchain0_n62_α:
 push rsp
