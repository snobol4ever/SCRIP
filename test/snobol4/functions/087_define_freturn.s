...
#-----------------------------------------------------------------------------------------------------------------------
n1_define_α:            mov              rdi, qword ptr [rip + .Lx46_0]
...
.Lx47_80:               mov              rax, qword ptr [rsp + 48]
                        ...
                        mov              qword ptr [r9 + 24], rax
.Lx47_110:              mov              r10, qword ptr [rsp + 16]
...
.Lx47_150:              mov              rax, qword ptr [rsp + 48]
                        ...
                        mov              rax, qword ptr [rsp + 56]
                        mov              qword ptr [r9 + 24], rax
.Lx47_180:              mov              r10, qword ptr [rsp + 16]
                        mov              r11, qword ptr [rsp + 24]
...
n3_statement_begin_β:                                                         jmp   FRETURN
#-----------------------------------------------------------------------------------------------------------------------
n4_var_α:               sub              rsp, 16
...
#-----------------------------------------------------------------------------------------------------------------------
n9_statement_end_α:     add              rsp, 80;                             jmp   RETURN
#=======================================================================================================================
