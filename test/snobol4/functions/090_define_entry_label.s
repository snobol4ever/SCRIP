...
#-----------------------------------------------------------------------------------------------------------------------
n24_func_activate_α:
                        lea              rax, [rip + bumpit_act_α]
                        mov              r11, qword ptr [rip + fn_cell$bumpit@GOTPCREL]
...
n30_call_α:
                        ...
                        lea              rcx, [rip + .Lx56_10]
                        lea              rdx, [rip + .Lx56_11]
                        mov              rax, qword ptr [rip + fn_cell$bumpit@GOTPCREL]
                                                                                        jmp   rax
.Lx56_10:
                        add              rsp, 32
                                                                                        jmp   .Lx56_2
...
.Lx72_3:
                        ...
                        mov              qword ptr [rbp + -96], rdx
.Lx72_4:
                        mov              rcx, qword ptr [rbp + -112]                    # bumpit
