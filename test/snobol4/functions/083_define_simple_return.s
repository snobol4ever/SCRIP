...
#-----------------------------------------------------------------------------------------------------------------------
n1_goto_deferred_α:     lea              rax, [rip + LBL__double];            jmp   rax
...
.Lx8_41:                lea              r10, [rip + double_γ]
                        lea              r11, [rip + double_ω]
                        push             r11
                        push             r10
                        lea              rax, [rip + LBL__double];            jmp   rax
double_γ:               mov              rdi, qword ptr [r9 + 0]              # double
...
.Lx8_110:               mov              r10, qword ptr [rsp + 16]
                        ...
                        mov              rax, rdi
                        mov              rdx, rsi;                            jmp   rcx
double_ω:               mov              rcx, qword ptr [rsp + 32]
                        mov              rdx, qword ptr [rcx + 0]
                        lea              r8, [rsp + 64]
                        mov              rax, qword ptr [rsp + 0]
...
#-----------------------------------------------------------------------------------------------------------------------
LBL__double:                                                                  jmp   n13_lit_integer_α
...
n15_binop_α:            sub              rsp, 16
                        ...
                        mov              edx, eax
                        and              edx, ecx
                        cmp              edx, 3;                              jne   .Lx41_2
                        mov              rax, qword ptr [rsp + 40]            # lit_integer
                        mov              rdx, qword ptr [rsp + 24]            # var
                        imul             rax, rdx
                        mov              qword ptr [rsp + 0], 3               # result
                        mov              qword ptr [rsp + 8], rax;            jmp   .Lx41_7
.Lx41_2:                and              edx, 1;                              jz    .Lx41_0
                        mov              rsi, qword ptr [rsp + 40]            # lit_integer
                        mov              rdi, qword ptr [rsp + 24]            # var
                        cmp              eax, 5;                              je    .Lx41_3
                        cvtsi2sd         xmm0, rsi;                           jmp   .Lx41_4
.Lx41_3:                movq             xmm0, rsi
.Lx41_4:                cmp              ecx, 5;                              je    .Lx41_5
                        cvtsi2sd         xmm1, rdi;                           jmp   .Lx41_6
.Lx41_5:                movq             xmm1, rdi
.Lx41_6:                mulsd            xmm0, xmm1
                        movq             rax, xmm0
                        mov              qword ptr [rsp + 0], 5               # result
                        mov              qword ptr [rsp + 8], rax
.Lx41_7:                                                                      jmp   n16_assign_α
.Lx41_0:                mov              rdi, qword ptr [rsp + 32]            # lit_integer
