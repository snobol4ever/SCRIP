...
.Lx303_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n38_cmp_test_α
n37_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n36_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n38_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
...
.Lx383_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n85_cmp_test_α
n84_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n83_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n85_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
...
.Lx417_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n105_cmp_test_α
n104_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n103_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n105_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
...
.Lx453_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n127_cmp_test_α
n126_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n125_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n127_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
...
.Lx499_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n154_cmp_test_α
n153_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n152_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n154_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
...
.Lx517_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n165_cmp_test_α
n164_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n163_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n165_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
