...
.Lx327_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n64_cmp_test_α
n63_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n62_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n64_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
...
.Lx349_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n77_cmp_test_α
n76_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n75_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n77_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
...
.Lx387_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n100_coerce_numeric_α
n99_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n98_lit_integer_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx389_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n101_cmp_test_α
n100_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n99_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n101_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
...
.Lx447_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n136_cmp_test_α
n135_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n134_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n136_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
...
.Lx485_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n159_coerce_numeric_α
n158_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n157_lit_integer_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx521_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n181_coerce_numeric_α
n180_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n179_lit_integer_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx523_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n182_cmp_test_α
n181_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n180_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n182_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
...
n207_lit_integer_α:
                        ...
                        mov              qword ptr [rsp + 8], rax
                                                                                        jmp   n208_coerce_numeric_α
n207_lit_integer_β:
                        add              rsp, 16
                        add              rsp, 16
                                                                                        jmp   n205_statement_begin_β
.Lx565_0:
                        .quad            12
#-----------------------------------------------------------------------------------------------------------------------
n208_coerce_numeric_α:
                        sub              rsp, 16
...
.Lx567_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n209_coerce_numeric_α
n208_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n207_lit_integer_β
#-----------------------------------------------------------------------------------------------------------------------
n209_coerce_numeric_α:
                        sub              rsp, 16
                        mov              eax, dword ptr [rsp + 32]                      # lit_integer
                        cmp              eax, 5
                                                                                        je    .Lx569_1
...
.Lx569_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n210_cmp_test_α
n209_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n208_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n210_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
