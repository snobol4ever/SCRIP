...
.Lstartup_pname0:       .string          "lfunc"
                        ...
                        .section         .rodata
.Lstartup_pname1:       .string          "checklocal"
                        .section         .text
                        .intel_syntax    noprefix
...
#-----------------------------------------------------------------------------------------------------------------------
n38_statement_end_α:                                                          jmp   n43_statement_begin_α
#=======================================================================================================================
...
n43_statement_begin_β:  add              rsp, 48;                             jmp   n45_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n70_binop_α:            sub              rsp, 16
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64];          jmp   n71_var_α
...
n72_binop_α:            sub              rsp, 16
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64];          jmp   n73_assign_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx276_2:               mov              qword ptr [rsp + 0], rax                       # result
                        mov              qword ptr [rsp + 8], rdx
...
#-----------------------------------------------------------------------------------------------------------------------
n105_statement_end_α:                                                         jmp   n110_statement_begin_α
#=======================================================================================================================
...
n110_statement_begin_β: add              rsp, 48;                             jmp   n112_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n116_statement_end_α:                                                         jmp   n121_statement_begin_α
#=======================================================================================================================
...
n119_assign_α:          mov              rsi, qword ptr [rsp + 0]                       # lit_string
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64];          jmp   n120_statement_end_α
...
n121_statement_begin_β: add              rsp, 48;                             jmp   n123_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n124_func_activate_α:   mov              rdi, qword ptr [rip + .Lx331_0]
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64];          jmp   n125_statement_end_α
...
.Lx368_2:               mov              qword ptr [rsp + 0], rax                       # result
                        mov              qword ptr [rsp + 8], rdx
...
n150_assign_α:          mov              rsi, qword ptr [rsp + 0]                       # lit_string
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64];          jmp   n151_statement_end_α
