...
n0_statement_begin_α:
                                                                                        jmp   n1_func_activate_α
n0_statement_begin_β:
                                                                                        jmp   n3_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n1_func_activate_α:
...
#-----------------------------------------------------------------------------------------------------------------------
n293_save_restore_α:
                                                                                        jmp   n294_goto_deferred_α
#-----------------------------------------------------------------------------------------------------------------------
n294_goto_deferred_α:
                        lea              rax, [rip + proc_LBL__jlab_α]
                                                                                        jmp   rax
...
.Lx301_43:
                        lea              r10, [rip + jlab_gamma]
                        lea              r11, [rip + jlab_omega]
                        lea              rax, [rip + proc_LBL__jlab_α]
                                                                                        jmp   rax
jlab_gamma:
                        mov              rdi, qword ptr [r9 + 0]                        # jlab
