...
# IR_MATCH_ALT_NARY
 ...
 mov dword ptr [r12 + 148], 0
 jmp xchain356_n9_α
xchain356_n5_as:
 jmp xchain356_n1_as
 xchain356_n5_β:
 mov eax, dword ptr [r12 + 148]
 cmp eax, 0
 je xchain356_n9_β
 jmp xchain356_n10_β
xchain356_n5_af:
 add dword ptr [r12 + 148], 1
...
# IR_MATCH_ALT_NARY
 ...
 mov dword ptr [r12 + 244], 0
 jmp xchain356_n11_α
xchain356_n6_as:
 jmp xchain356_n1_as
 xchain356_n6_β:
 mov eax, dword ptr [r12 + 244]
 cmp eax, 0
 je xchain356_n11_β
 jmp xchain356_n12_β
xchain356_n6_af:
 add dword ptr [r12 + 244], 1
