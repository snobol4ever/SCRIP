...
# IR_MATCH_DEFER
 ...
 mov rcx, qword ptr [r12 + 3424]
 mov rdi, rax
 xor esi, esi
 call rcx
 cmp eax, 1
 je .Lx718_1
 mov rdi, qword ptr [r12 + 3432]
 push rbp
 mov rbp, rsp
 and rsp, -16
 call rt_zls_release@PLT
