...
n156_lit_string_α:
                        ...
                        mov              qword ptr [rsp + 8], rax
                                                                                        jmp   n157_assign_var_α
n156_lit_string_β:
                        add              rsp, 16
                                                                                        jmp   n155_subscript_β
.Lx485_0:
                        .quad            .Lx485_0_s
.Lx485_0_s:
                        .string          "XC"
...
n203_lit_integer_α:
                        ...
                        mov              qword ptr [rsp + 8], rax
                                                                                        jmp   n204_subscript_α
n203_lit_integer_β:
                        add              rsp, 16
                        add              rsp, 16
                                                                                        jmp   n201_statement_begin_β
.Lx546_0:
                        .quad            13
#-----------------------------------------------------------------------------------------------------------------------
n204_subscript_α:
...
n205_lit_string_α:
                        ...
                        mov              qword ptr [rsp + 8], rax
                                                                                        jmp   n206_assign_var_α
n205_lit_string_β:
                        add              rsp, 16
                                                                                        jmp   n204_subscript_β
.Lx548_0:
                        .quad            .Lx548_0_s
.Lx548_0_s:
                        .string          "I"
...
.Lx563_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n216_coerce_numeric_α
n215_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n214_lit_integer_β
#-----------------------------------------------------------------------------------------------------------------------
n216_coerce_numeric_α:
                        sub              rsp, 16
...
.Lx565_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n217_cmp_test_α
n216_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n215_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n217_cmp_test_α:
                        sub              rsp, 16
...
n224_deref_α:
                        ...
                        cmp              eax, 104
                                                                                        jne   .Lx576_240
                        add              rsp, 16
                                                                                        jmp   n223_subscript_β
.Lx576_240:
                        mov              qword ptr [rsp + 0], rax                       # result
                        mov              qword ptr [rsp + 8], rdx
                                                                                        jmp   n225_coerce_numeric_α
n224_deref_β:
                        add              rsp, 16
                                                                                        jmp   n223_subscript_β
#-----------------------------------------------------------------------------------------------------------------------
n225_coerce_numeric_α:
                        sub              rsp, 16
...
.Lx580_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n227_cmp_test_α
n226_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n225_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n227_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
