...
# marshal arg1 = producer-box slot [zr+2128] -> [zr+1936]
 ...
 mov qword ptr [r12 + 1944], rax
  .section .rodata
  .Lbynamefn118: .string "differ"
  .section .text
  .intel_syntax noprefix
   lea rdi, [rip + .Lbynamefn118]
 lea rsi, [r12 + 1920]
 mov edx, 2
 call rt_call_arr@PLT
