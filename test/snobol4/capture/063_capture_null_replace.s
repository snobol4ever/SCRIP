...
.Lx26_0:                mov              r14d, dword ptr [rsp + 0];           jmp   n7_match_lit_α
...
n7_match_lit_α:         mov              eax, r14d
                        ...
                        cmp              edx, 1919907616;                     jne   n6_match_begin_β
                        movzx            eax, byte ptr [r13+rcx+4]
                        cmp              eax, 108;                            jne   n6_match_begin_β
...
.Lx30_4:                mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        mov              qword ptr [rax + 40], r8
                        mov              qword ptr [rax + 56], r10
                        mov              qword ptr [rax + 64], r11
...
.Lx30_10:               sub              r12, 24                                        # cas_mark
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64];          jmp   n9_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
