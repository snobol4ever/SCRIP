...
.Lx36_0:                mov              r14d, dword ptr [rsp + 0]; jmp   n7_match_pos_α
...
n9_match_arbno_β:                                                   jmp   n18_match_lit_α
n9_match_arbno_as:      mov              eax, dword ptr [rsp + 4]
                        cmp              r14d, eax;                 je    n18_match_lit_β
                        mov              dword ptr [rsp + 4], r14d; jmp   n10_match_assign_cond_α
n9_match_arbno_af:      mov              eax, dword ptr [rsp + 0]
                        cmp              r14d, eax;                 jne   n18_match_lit_β
...
.Lx46_3:                mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        mov              qword ptr [rax + 40], r8
                        mov              qword ptr [rax + 56], r10
                        mov              qword ptr [rax + 64], r11
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]; jmp   .Lx46_1
.Lx46_4:                mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        mov              qword ptr [rax + 40], r8
                        mov              qword ptr [rax + 56], r10
                        mov              qword ptr [rax + 64], r11
                        ...
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]; jmp   .Lx46_1
.Lx46_2:                mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        mov              qword ptr [rax + 40], r8
                        mov              qword ptr [rax + 56], r10
                        mov              qword ptr [rax + 64], r11
...
n18_match_lit_β:        sub              r14d, 1;                   jmp   n9_match_arbno_af
#=======================================================================================================================
#         OUTPUT = 'fail'
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n25_goto_α:                                                         jmp   n14_statement_begin_α
