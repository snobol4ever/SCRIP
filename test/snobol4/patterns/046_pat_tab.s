...
.Lx34_0:                mov              r14d, dword ptr [rsp + 0]; jmp   n7_match_tab_α
...
n7_match_tab_α:         sub              rsp, 16
                        ...
                        mov              rax, 3
                        cmp              r14d, eax;                 jle   .Lx35_239
                        add              rsp, 16;                   jmp   n6_match_begin_β
.Lx35_239:              cmp              r15d, eax;                 jge   .Lx35_240
                        add              rsp, 16;                   jmp   n6_match_begin_β
.Lx35_240:              mov              r14d, eax;                 jmp   n8_match_assign_save_α
...
n9_match_len_α:         mov              eax, r14d
                        add              eax, 2
                        cmp              eax, r15d;                 jle   .Lx38_240
                        add              rsp, 16;                   jmp   n7_match_tab_β
.Lx38_240:              add              r14d, 2;                   jmp   n10_match_assign_cond_α
