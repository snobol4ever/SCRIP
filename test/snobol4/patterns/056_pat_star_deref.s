...
.Lx34_0_s:              .string          "say hello world"
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx42_0:                mov              r14d, dword ptr [rsp + 0]; jmp   n11_match_assign_save_α
...
n12_match_defer_α:      sub              rsp, 16
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]; jmp   .Lx45_10
.Lx45_9:                xor              eax, eax
.Lx45_10:               test             rax, rax;                  jz    .Lx45_0
                        mov              r8d, 0
                        lea              r10, [rip + .Lx45_4]
                        lea              r11, [rip + .Lx45_5];      jmp   rax
.Lx45_4:                                                            jmp   n13_match_assign_cond_α
.Lx45_5:                add              rsp, 16;                   jmp   n11_match_assign_save_β
.Lx45_0:                push             r14
                        push             r15
                        push             r13
                        sub              rsp, 8
...
.Lx45_7:                mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        mov              qword ptr [rax + 40], r8
                        mov              qword ptr [rax + 56], r10
                        mov              qword ptr [rax + 64], r11
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]; jmp   .Lx45_2
.Lx45_8:                mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        mov              qword ptr [rax + 40], r8
                        mov              qword ptr [rax + 56], r10
                        mov              qword ptr [rax + 64], r11
...
#-----------------------------------------------------------------------------------------------------------------------
n15_statement_end_α:    add              rsp, 80;                   jmp   n22_statement_begin_α
#=======================================================================================================================
#         OUTPUT = 'fail'
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n21_statement_end_α:                                                jmp   main_γ
#=======================================================================================================================
# YES     OUTPUT = V
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n24_assign_α:           mov              rsi, qword ptr [rsp + 0]                       # var
                        mov              rdx, qword ptr [rsp + 8]
