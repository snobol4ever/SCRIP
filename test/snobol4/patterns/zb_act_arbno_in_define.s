...
n90_match_assign_cond_β:
                        ...
                        sub              rax, 24
                        mov              qword ptr [1879048192], rax
                                                                                        jmp   n89_match_arbno_β
#-----------------------------------------------------------------------------------------------------------------------
n91_match_lit_α:
                        mov              eax, r14d
                        add              eax, 1
                        cmp              eax, r15d
                                                                                        jg    n89_match_arbno_af
                        movsxd           rcx, r14d
                        movzx            eax, byte ptr [r13+rcx]
                        cmp              eax, 97
                                                                                        jne   n89_match_arbno_af
                        add              r14d, 1
