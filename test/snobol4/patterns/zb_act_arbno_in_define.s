...
n6_assign_α:
                        ...
                        mov              qword ptr [1879052296], rdx                    # MATCHIT
                                                                                        jmp   n17_save_restore_α
n6_assign_β:
                                                                                        jmp   n17_save_restore_α
#-----------------------------------------------------------------------------------------------------------------------
n7_lit_integer_α:
                        mov              qword ptr [rsp + 256], 3                       # lit_integer
...
#-----------------------------------------------------------------------------------------------------------------------
n13_lit_integer_α:
                        mov              qword ptr [rsp + 128], 3                       # lit_integer
...
n50_lit_string_α:
                        ...
                        mov              qword ptr [rsp + 128], 0                       # stmt_claim
                        mov              qword ptr [rsp + 136], 0                       # stmt_claim
                        mov              qword ptr [rsp + 256], 2                       # lit_string
                        mov              dword ptr [rsp + 260], 3                       # lit_string
...
n51_call_α:
                        ...
                        mov              qword ptr [rsp + 16], rax
                        mov              rax, qword ptr [1879052296]                    # MATCHIT
                        mov              qword ptr [rsp + 24], rax
...
.Lx75_6:
                        ...
                        mov              rsi, qword ptr [1879052296]                    # MATCHIT
                        mov              rax, qword ptr [rsp + 16]
                        mov              qword ptr [1879052288], rax                    # MATCHIT
                        mov              rax, qword ptr [rsp + 24]
                        mov              qword ptr [1879052296], rax                    # MATCHIT
