...
n0_statement_begin_β:   mov              r11, 1;                              jmp   n22_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx34_80:               mov              rax, qword ptr [rsp + 48]
                        ...
                        mov              qword ptr [r9 + 24], rax
.Lx34_110:              mov              rcx, qword ptr [rcx + 8]
                        add              rsp, 64
                        mov              rax, rdi
                        mov              rdx, rsi;                            jmp   rcx
...
.Lx34_150:              mov              rax, qword ptr [rsp + 48]
                        ...
                        mov              rax, qword ptr [rsp + 56]
                        mov              qword ptr [r9 + 24], rax
.Lx34_180:              mov              rcx, qword ptr [rcx + 16]
                        add              rsp, 64
                        mov              eax, 104
                        xor              edx, edx;                            jmp   rcx
.Lx34_245:
...
#-----------------------------------------------------------------------------------------------------------------------
n6_match_pos_α:         mov              r11, 7
                        mov              rax, 0
                        cmp              r14d, eax;                           jne   n5_match_begin_β
                                                                              jmp   n7_match_assign_save_α
n6_match_pos_β:         mov              r11, 7;                              jmp   n5_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
...
n8_match_arbno_β:       mov              r11, 9;                              jmp   n13_match_lit_α
...
n9_match_assign_cond_β: mov              r11, 10
                        sub              r12, 24;                             jmp   n8_match_arbno_β
#-----------------------------------------------------------------------------------------------------------------------
...
n26_call_β:             mov              r11, 27;                             jmp   n24_statement_begin_β
...
module_init:
                        sub              rsp, 8
                        .section         .rodata
.Lseala1:               .string          "MATCHIT"
                        .section         .text
                        .intel_syntax    noprefix
                        .weak            MATCHIT_α
                        lea              rdi, [rip + .Lseala1]
                        mov              rsi, qword ptr [rip + MATCHIT_α@GOTPCREL]
