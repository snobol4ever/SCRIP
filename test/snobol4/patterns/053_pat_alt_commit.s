...
.Lx43_0:                mov              r14d, dword ptr [rsp + 0]; jmp   n9_match_assign_save_α
n8_match_begin_β:       mov              rsp, qword ptr [r12 + -16]                     # rsp_restore
                        sub              rsp, 32
                        add              dword ptr [rsp + 0], 1                         # start_δ
                        mov              eax, dword ptr [rsp + 0]
                        cmp              eax, r15d;                 jg    .Lx43_1
                        mov              rcx, qword ptr [rip + rt_anchor_g@GOTPCREL]
                        mov              rax, qword ptr [rcx]
                        cmp              rax, 0;                    jne   .Lx43_1
                                                                    jmp   .Lx43_0
.Lx43_1:
n8_match_begin_af:      sub              r12, 24                                        # cas_mark
...
.Lx47_21:               lea              rax, [rip + .Lx47_22]
                        mov              qword ptr [rsp + 16], rax; jmp   n21_match_lit_α
.Lx47_22:               lea              rax, [rip + .Lx47_19]
                        mov              qword ptr [rsp + 16], rax; jmp   n20_match_lit_α
n10_match_alternate_s0: lea              rax, [rip + .Lx47_40]
                        mov              qword ptr [rsp + 8], rax;  jmp   n10_match_alternate_as
n10_match_alternate_s1: lea              rax, [rip + .Lx47_41]
                        mov              qword ptr [rsp + 8], rax;  jmp   n10_match_alternate_as
n10_match_alternate_s2: lea              rax, [rip + .Lx47_42]
                        mov              qword ptr [rsp + 8], rax;  jmp   n10_match_alternate_as
.Lx47_40:                                                           jmp   n22_match_lit_β
.Lx47_41:                                                           jmp   n21_match_lit_β
.Lx47_42:                                                           jmp   n20_match_lit_β
...
.Lx47_19:               add              rsp, 32;                   jmp   n9_match_assign_save_β
#-----------------------------------------------------------------------------------------------------------------------
n11_match_assign_cond_α: mov              eax, dword ptr [rsp + 0]
                        lea              rcx, [rip + .S0]
...
n11_match_assign_cond_β: sub              r12, 24;                  jmp   n10_match_alternate_β
#-----------------------------------------------------------------------------------------------------------------------
n12_match_end_α:        mov              r8, r12
.Lx51_9:                sub              r8, 24
                        mov              rax, qword ptr [r8 + 0]
                        test             rax, rax;                  jne   .Lx51_9
...
.Lx51_3:                mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        mov              qword ptr [rax + 40], r8
                        mov              qword ptr [rax + 56], r10
                        mov              qword ptr [rax + 64], r11
...
.Lx51_4:                mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        mov              qword ptr [rax + 40], r8
                        mov              qword ptr [rax + 56], r10
                        mov              qword ptr [rax + 64], r11
                        ...
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]; jmp   .Lx51_1
.Lx51_2:                mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        mov              qword ptr [rax + 40], r8
                        mov              qword ptr [rax + 56], r10
                        mov              qword ptr [rax + 64], r11
...
n15_var_β:              add              rsp, 16;                   jmp   n14_statement_begin_β
#-----------------------------------------------------------------------------------------------------------------------
...
n20_match_lit_β:        sub              r14d, 1;                   jmp   n10_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
...
n21_match_lit_β:        sub              r14d, 1;                   jmp   n10_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
...
n22_match_lit_β:        sub              r14d, 1;                   jmp   n10_match_alternate_af
#=======================================================================================================================
# NO      OUTPUT = 'no match'
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n27_goto_α:                                                         jmp   n14_statement_begin_α
n27_goto_β:                                                         jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n28_goto_α:                                                         jmp   n23_statement_begin_α
n28_goto_β:                                                         jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
main_β:
                                                                    jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
