...
n7_match_assign_save_α: sub              rsp, 16
                        mov              dword ptr [rsp + 0], r14d; jmp   n8_match_rtab_α
n7_match_assign_save_β: add              rsp, 16;                   jmp   n6_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n8_match_rtab_α:        sub              rsp, 16
                        mov              dword ptr [rsp + 0], r14d
                        mov              rax, 2
                        mov              ecx, r15d
                        sub              ecx, eax
                        cmp              r14d, ecx;                 jle   .Lx36_240
                        add              rsp, 16
                        add              rsp, 16;                   jmp   n6_match_begin_β
.Lx36_240:              mov              r14d, ecx;                 jmp   n9_match_assign_cond_α
n8_match_rtab_β:        mov              r14d, dword ptr [rsp + 0]
                        add              rsp, 16
                        add              rsp, 16;                   jmp   n6_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
...
n9_match_assign_cond_β: sub              r12, 24;                   jmp   n8_match_rtab_β
#-----------------------------------------------------------------------------------------------------------------------
