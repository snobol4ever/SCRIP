...
.Lx32_0:                mov              r14d, dword ptr [rsp + 0];           jmp   n7_match_assign_save_α
...
n8_match_rtab_α:        sub              rsp, 16
                        ...
                        mov              ecx, r15d
                        sub              ecx, eax
                        cmp              r14d, ecx;                           jle   .Lx35_240
                        add              rsp, 16
                        add              rsp, 16;                             jmp   n6_match_begin_β
.Lx35_240:              mov              r14d, ecx;                           jmp   n9_match_assign_cond_α
...
.Lx39_3:                mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        mov              qword ptr [rax + 40], r8
                        mov              qword ptr [rax + 56], r10
                        mov              qword ptr [rax + 64], r11
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64];          jmp   .Lx39_1
.Lx39_4:                mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        mov              qword ptr [rax + 40], r8
                        mov              qword ptr [rax + 56], r10
                        mov              qword ptr [rax + 64], r11
                        ...
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64];          jmp   .Lx39_1
.Lx39_2:                mov              rax, qword ptr [rip + g_rtcc_block@GOTPCREL]
                        mov              qword ptr [rax + 40], r8
                        mov              qword ptr [rax + 56], r10
                        mov              qword ptr [rax + 64], r11
