...
typedef enum tree_e {
    ...
    TT_SUSPEND,           TT_TO,                TT_TO_BY,             TT_LIMIT,             TT_CREATE,            TT_ACTIVATE,
    ...
    TT_SEQ_EXPR,          TT_EVERY,             TT_WHILE,             TT_UNTIL,             TT_REPEAT,            TT_FOR,               TT_DO_WHILE,          TT_CLOOP,
    TT_IF,                TT_UNLESS,            TT_CASE,              TT_RETURN,            TT_PROC_FAIL,         TT_NRETURN,
    TT_LOOP_BREAK,        TT_LOOP_NEXT,         TT_BANG_BINARY,       TT_DEFINE,
    ...
    TT_LINK,              TT_INVOCABLE,
    TT_PROGRAM,           TT_STMT,              TT_END,               TT_ATTR,
    TT_GOTO_S,            TT_GOTO_F,            TT_GOTO_U,            TT_GOTO_DIRECT,       TT_LABEL_DEF,
    TT_GATHER,
    ...
    TT_CATCH,
    TT_YADA,
    TT_ANON_BLOCK,        TT_INVOKE,            TT_TERNARY,
    ...
    TT_NEW,
    TT_METHCALL,
    TT_MAP,               TT_GREP,              TT_SORT,      TT_REVERSE,
...
static inline tree_e augop_binop_tt(int a) {
    ...
    case AUGOP_CONCAT: return TT_CAT; case AUGOP_LCONCAT: return TT_LCONCAT; case AUGOP_EQ: return TT_EQ; case AUGOP_LT: return TT_LT; case AUGOP_LE: return TT_LE;
    ...
    case AUGOP_ACTIVATE: return TT_ACTIVATE; case AUGOP_IDENTICAL: return TT_IDENTICAL; case AUGOP_NIDENTICAL: return TT_NIDENTICAL;
    case AUGOP_CONJ: return TT_CONJ;
...
static const char * const tt_e_name[TT_KIND_COUNT] = {
    ...
    [TT_XREP]             = "TT_XREP",           [TT_DIVIS]            = "TT_DIVIS",
    ...
    [TT_LIMIT]            = "TT_LIMIT",          [TT_CREATE]           = "TT_CREATE",         [TT_ACTIVATE]         = "TT_ACTIVATE",
    [TT_ALTERNATE]        = "TT_ALTERNATE",       [TT_ITERATE]          = "TT_ITERATE",
    ...
    [TT_UNTIL]            = "TT_UNTIL",          [TT_REPEAT]           = "TT_REPEAT",          [TT_FOR]              = "TT_FOR",
    [TT_CLOOP]            = "TT_CLOOP",
    [TT_DO_WHILE]         = "TT_DO_WHILE",        [TT_IF]               = "TT_IF",             [TT_UNLESS]           = "TT_UNLESS",
    ...
    [TT_LINK]             = "TT_LINK",           [TT_INVOCABLE]        = "TT_INVOCABLE",
    [TT_PROGRAM]          = "TT_PROGRAM",        [TT_STMT]             = "TT_STMT",            [TT_END]              = "TT_END",
    [TT_ATTR]             = "TT_ATTR",           [TT_GOTO_S]           = "TT_GOTO_S",          [TT_GOTO_F]           = "TT_GOTO_F",
    [TT_GOTO_U]           = "TT_GOTO_U",         [TT_GOTO_DIRECT]      = "TT_GOTO_DIRECT",     [TT_LABEL_DEF]        = "TT_LABEL_DEF",       [TT_GATHER]           = "TT_GATHER",
    ...
    [TT_TRY]              = "TT_TRY",
    [TT_CATCH]            = "TT_CATCH",
    [TT_YADA]             = "TT_YADA",           [TT_ANON_BLOCK]       = "TT_ANON_BLOCK",      [TT_INVOKE]           = "TT_INVOKE",           [TT_TERNARY]          = "TT_TERNARY",
    ...
    [TT_ROLE_DECL]        = "TT_ROLE_DECL",
    [TT_MODULE_DECL]      = "TT_MODULE_DECL",
