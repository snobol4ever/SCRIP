/* ATTIC: dead code excised from src/parser/raku/raku.lex.c (commit base 2c38d15) — unreachable from main per --gc-sections oracle. Provenance only; not compiled. */
...
/* DEAD CODE — excised from src/parser/raku/raku.lex.c
