/* ATTIC: dead code excised from src/runtime/builtins/resolution.c (commit base 2a35216) — unreachable from main per --gc-sections oracle. Provenance only; not compiled. */
