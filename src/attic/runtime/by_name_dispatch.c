/* ATTIC: dead code excised from src/runtime/by_name_dispatch.c (commit base 2a35216) — unreachable from main per --gc-sections oracle. Provenance only; not compiled. */
