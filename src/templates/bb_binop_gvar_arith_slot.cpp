...
std::string bb_binop_gvar_arith_slot() {
    if (PLATFORM_X86 && _.op_arith_descr && _.op_sa >= 0 && _.op_sb >= 0 && _.op_off >= 0)
        return x86_alpha()
             ...
             + IF(_.bb_lk == (int)IR_VAR && _.op_name1 && _.op_parts_lbl[0], x86("call", "NV_GET_fn", (uint64_t)(uintptr_t)(void *) NV_GET_fn))
             + IF(_.bb_lk == (int)IR_VAR && _.op_name1 && _.op_parts_lbl[0], x86("mov", FRQ(_.op_sa), "rax"))
             + IF(_.bb_lk == (int)IR_VAR && _.op_name1 && _.op_parts_lbl[0], x86("mov", FRQ(_.op_sa + 8), "rdx"))
             ...
             + IF(_.bb_rk == (int)IR_VAR && _.op_name2 && _.op_parts_lbl[1], x86("call", "NV_GET_fn", (uint64_t)(uintptr_t)(void *) NV_GET_fn))
             + IF(_.bb_rk == (int)IR_VAR && _.op_name2 && _.op_parts_lbl[1], x86("mov", FRQ(_.op_sb), "rax"))
             + IF(_.bb_rk == (int)IR_VAR && _.op_name2 && _.op_parts_lbl[1], x86("mov", FRQ(_.op_sb + 8), "rdx"))
