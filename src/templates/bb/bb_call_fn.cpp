...
std::string bb_call_fn_str(IR_t * pBB) {
    ...
    if (_.op_zres) {
        ...
        s += x86("call", (_.op_sn4 ? "rt_call_arr_bl_sn4" : _.op_strict ? "rt_call_arr_bl_strict" : "rt_call_arr_bl"), (uint64_t)(uintptr_t)(void *)(_.op_sn4 ? rt_call_arr_bl_sn4 : _.op_strict ? rt_call_arr_bl_strict : rt_call_arr_bl));
        }
    ...
    if (dfp && cui >= 0) {
        ...
        s += x86("rtcc_wb");
        s += x86("mov32", "ecx", bid_bake_of(fn));
        s += x86("call_bare", (_.op_sn4 ? "rt_call_arr_bl_sn4" : _.op_strict ? "rt_call_arr_bl_strict" : "rt_call_arr_bl"), (uint64_t)(uintptr_t)(void *)(_.op_sn4 ? rt_call_arr_bl_sn4 : _.op_strict ? rt_call_arr_bl_strict : rt_call_arr_bl));
        s += x86("rtcc_rl");
    }
