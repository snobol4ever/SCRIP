...
static std::string na_ndl_r8()  { return _.op_sa >= 0 ? x86("mov", "r8",  XSAQ(8)) + x86("mov", "ecx", XSAD(4)) : x86("lea", "r8",  "[rip + __]", (uint64_t)(uintptr_t)(_.op_sval ? _.op_sval : ""), na_nlb) + x86("mov32", "ecx", CSK()); }
