...
DESCR_t rt_pl_dop_close(DESCR_t *, int); DESCR_t rt_pl_dop_read_s(DESCR_t *, int); DESCR_t rt_pl_dop_get_char_s(DESCR_t *, int); DESCR_t rt_pl_dop_peek_char_s(DESCR_t *, int); DESCR_t rt_pl_dop_current_output(DESCR_t *, int);
...
DESCR_t rt_pl_dop_current_input(DESCR_t *, int); DESCR_t rt_pl_dop_open(DESCR_t *, int); DESCR_t rt_pl_dop_open4(DESCR_t *, int); DESCR_t rt_pl_dop_keysort(DESCR_t *, int); DESCR_t rt_pl_dop_set_stream_position(DESCR_t *, int); DESCR_t rt_pl_dop_format3(DESCR_t *, int); DESCR_t rt_pl_dop_write_term(DESCR_t *, int); DESCR_t rt_pl_dop_write_term_s(DESCR_t *, int); DESCR_t rt_pl_dop_write_sb(DESCR_t *, int); DESCR_t rt_pl_dop_writeq_sb(DESCR_t *, int); DESCR_t rt_pl_dop_write_canonical_sb(DESCR_t *, int); DESCR_t rt_pl_dop_writeln_sb(DESCR_t *, int); DESCR_t rt_pl_dop_nl_sb(DESCR_t *, int); DESCR_t rt_pl_dop_tab_sb(DESCR_t *, int); DESCR_t rt_pl_dop_put_char_sb(DESCR_t *, int); DESCR_t rt_pl_dop_put_code_sb(DESCR_t *, int); DESCR_t rt_pl_dop_flush_output_sb(DESCR_t *, int); DESCR_t rt_pl_dop_op(DESCR_t *, int); DESCR_t rt_pl_dop_pl_op_check(DESCR_t *, int); DESCR_t rt_pl_dop_pl_sp_check(DESCR_t *, int); DESCR_t rt_pl_dop_pl_ioarg(DESCR_t *, int); DESCR_t rt_pl_dop_pl_op_count(DESCR_t *, int); DESCR_t rt_pl_dop_pl_op_nth(DESCR_t *, int); DESCR_t rt_pl_dop_pl_sp_count(DESCR_t *, int); DESCR_t rt_pl_dop_pl_sp_nth(DESCR_t *, int); DESCR_t rt_pl_dop_pl_cs_count(DESCR_t *, int); DESCR_t rt_pl_dop_pl_cs_nth(DESCR_t *, int);
...
void * dop_direct_fp(const char * fn, int64_t narg, const char ** sym) {
    static const struct { const char * nm; int ar; const char * sy; DESCR_t (*fp)(DESCR_t *, int); } t[] = {
        ...
        { "$db_erase", 2, "rt_pl_dop_db_erase", rt_pl_dop_db_erase }, { "$db_abolish", 1, "rt_pl_dop_db_abolish", rt_pl_dop_db_abolish }, { "$db_n", 1, "rt_pl_dop_db_n", rt_pl_dop_db_n }, { "$db_gen", 1, "rt_pl_dop_db_gen", rt_pl_dop_db_gen }, { "$db_gen_t", 1, "rt_pl_dop_db_gen_t", rt_pl_dop_db_gen_t }, { "$db_at", 3, "rt_pl_dop_db_at", rt_pl_dop_db_at }, { "$db_nonempty", 1, "rt_pl_dop_db_nonempty", rt_pl_dop_db_nonempty }, { "$ball_pending", 0, "rt_pl_dop_ball_pending", rt_pl_dop_ball_pending }, { "$db_seed_once", 3, "rt_pl_dop_db_seed_once", rt_pl_dop_db_seed_once },
        { "$db_retractall", 2, "rt_pl_dop_db_retractall", rt_pl_dop_db_retractall },
        { "$db_alive", 2, "rt_pl_dop_db_alive", rt_pl_dop_db_alive },
        { "$db_decl", 3, "rt_pl_dop_db_decl", rt_pl_dop_db_decl }, { "$pl_cp_count", 1, "rt_pl_dop_pl_cp_count", rt_pl_dop_pl_cp_count }, { "$pl_cp_nth", 3, "rt_pl_dop_pl_cp_nth", rt_pl_dop_pl_cp_nth }, { "$pl_cp_guard", 1, "rt_pl_dop_pl_cp_guard", rt_pl_dop_pl_cp_guard },
        ...
        { "$pl_goal_guard", 1, "rt_pl_dop_goal_guard", rt_pl_dop_goal_guard }, { "$pl_list_guard", 1, "rt_pl_dop_list_guard", rt_pl_dop_list_guard }, { "$pl_declared", 2, "rt_pl_dop_pl_declared", rt_pl_dop_pl_declared },
        { "$term_string", 2, "rt_pl_dop_term_string", rt_pl_dop_term_string }, { "$atom_length", 2, "rt_pl_dop_atom_length", rt_pl_dop_atom_length },
        { "$atom_concat", 3, "rt_pl_dop_atom_concat", rt_pl_dop_atom_concat }, { "$atomic_concat", 3, "rt_pl_dop_atomic_concat", rt_pl_dop_atomic_concat }, { "$atom_chars", 2, "rt_pl_dop_atom_chars", rt_pl_dop_atom_chars },
        ...
        { "$current_prolog_flag", 2, "rt_pl_dop_current_prolog_flag", rt_pl_dop_current_prolog_flag }, { "$set_prolog_flag", 2, "rt_pl_dop_set_prolog_flag", rt_pl_dop_set_prolog_flag }, { "$telling", 1, "rt_pl_dop_telling", rt_pl_dop_telling }, { "$seeing", 1, "rt_pl_dop_seeing", rt_pl_dop_seeing },
        ...
        { "$write_s", 2, "rt_pl_dop_write_sb", rt_pl_dop_write_sb }, { "$writeq_s", 2, "rt_pl_dop_writeq_sb", rt_pl_dop_writeq_sb }, { "$write_canonical_s", 2, "rt_pl_dop_write_canonical_sb", rt_pl_dop_write_canonical_sb },
        { "$writeln_s", 2, "rt_pl_dop_writeln_sb", rt_pl_dop_writeln_sb }, { "$nl_s", 1, "rt_pl_dop_nl_sb", rt_pl_dop_nl_sb }, { "$tab_s", 2, "rt_pl_dop_tab_sb", rt_pl_dop_tab_sb }, { "$put_char_s", 2, "rt_pl_dop_put_char_sb", rt_pl_dop_put_char_sb },
        { "$flush_output_s", 1, "rt_pl_dop_flush_output_sb", rt_pl_dop_flush_output_sb }, { "$set_output", 1, "dop_pl_set_output", dop_pl_set_output }, { "$set_input", 1, "dop_pl_set_input", dop_pl_set_input },
        { "$close", 1, "rt_pl_dop_close", rt_pl_dop_close }, { "$close", 2, "rt_pl_dop_close", rt_pl_dop_close }, { "$read_s", 2, "rt_pl_dop_read_s", rt_pl_dop_read_s }, { "$get_char_s", 2, "rt_pl_dop_get_char_s", rt_pl_dop_get_char_s },
        ...
        { "$open", 3, "rt_pl_dop_open", rt_pl_dop_open }, { "$open4", 4, "rt_pl_dop_open4", rt_pl_dop_open4 }, { "$keysort", 2, "rt_pl_dop_keysort", rt_pl_dop_keysort }, { "$set_stream_position", 2, "rt_pl_dop_set_stream_position", rt_pl_dop_set_stream_position }, { "$format3", 3, "rt_pl_dop_format3", rt_pl_dop_format3 }, { "$write_term", 2, "rt_pl_dop_write_term", rt_pl_dop_write_term }, { "$write_term_s", 3, "rt_pl_dop_write_term_s", rt_pl_dop_write_term_s }, { "$op", 3, "rt_pl_dop_op", rt_pl_dop_op }, { "$pl_op_check", 3, "rt_pl_dop_pl_op_check", rt_pl_dop_pl_op_check }, { "$pl_sp_check", 2, "rt_pl_dop_pl_sp_check", rt_pl_dop_pl_sp_check }, { "$pl_ioarg", 2, "rt_pl_dop_pl_ioarg", rt_pl_dop_pl_ioarg },
