...
void * dop_direct_fp(const char * fn, int64_t narg, const char ** sym) {
    static const struct { const char * nm; int ar; const char * sy; DESCR_t (*fp)(DESCR_t *, int); } t[] = {
        ...
        { "$open", 3, "rt_pl_dop_open", rt_pl_dop_open }, { "$open4", 4, "rt_pl_dop_open4", rt_pl_dop_open4 }, { "$keysort", 2, "rt_pl_dop_keysort", rt_pl_dop_keysort }, { "$format3", 3, "rt_pl_dop_format3", rt_pl_dop_format3 }, { "$write_term", 2, "rt_pl_dop_write_term", rt_pl_dop_write_term }, { "$write_term_s", 3, "rt_pl_dop_write_term_s", rt_pl_dop_write_term_s }, { "$op", 3, "dop_pl_op", dop_pl_op },
