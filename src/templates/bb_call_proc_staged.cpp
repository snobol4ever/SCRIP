        ...
        return x86_alpha()
             ...
             + ((scc_z || (_.op_sval && bb_tiny_shim_ok(_.op_sval, (int)_.op_ival)))
                ...
                ? [&]() -> std::string {
                    ...
                    if (!_ntz && ({ extern int g_rt_fragment_emit; !g_rt_fragment_emit; }) && _.op_sval && bb_tiny_shim_ok(_.op_sval, (int)_.op_ival)) {   /* D-18b: fragments decline TINY -- see g_rt_fragment_emit in runtime_eval.c */   /* TINY-REAL s58; R-1 s94 (Fable 5): BOTH MEDIA -- the MEDIUM_TEXT conjunct is lifted, cross-chain reach = x86_jmp_via_cell */
    ...
    return x86_alpha()
         ...
         + ((scc || (_.op_sval && bb_tiny_shim_ok(_.op_sval, (int)_.op_ival))) && !c2
            ...
            ? [&]() -> std::string {
                ...
                if (!_ntiny && ({ extern int g_rt_fragment_emit; !g_rt_fragment_emit; }) && _.op_sval && bb_tiny_shim_ok(_.op_sval, (int)_.op_ival)) {   /* D-18b: fragments decline TINY -- see g_rt_fragment_emit in runtime_eval.c */   /* TINY-REAL s58; R-1 s94 (Fable 5): BOTH MEDIA -- the MEDIUM_TEXT conjunct is lifted, cross-chain reach = x86_jmp_via_cell */
