...
static long an_gu() { return _.op_sa < 0 && ZC_LIT_GUTS == ZC_LIT_GUTS_UNROLL; }
...
static std::string an_ndl_r8()  { return _.op_sa >= 0 ? x86("mov", "r8",  FRQ(_.op_sa + 8)) + x86("mov", "r9d", FR(_.op_sa + 4)) : x86("lea", "r8",  "[rip + __]", (uint64_t)(uintptr_t)(_.op_sval ? _.op_sval : ""), an_nlb) + x86("mov32", "r9d", CSK()); }
