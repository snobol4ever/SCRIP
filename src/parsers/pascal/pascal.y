...
selector:
    ...
    | selector ARROW { $$ = pas_is_tfile_node($1) ? mk_fnc1("__pas_fbuf_get", $1) : (($1 && $1->t == TT_VAR && $1->v.sval && pas_is_filevar($1->v.sval) && !pas_is_stdstream($1->v.sval)) ? mk_fnc1("__pas_tbuf_get", $1) : (($1 && $1->t == TT_VAR && $1->v.sval && pas_is_pcharvar($1->v.sval)) ? mk_fnc1("__pas_pchar_deref", $1) : mk_deref($1))); }
    | IDENT { $$ = mk_ident($1); }
    ;
expression_list:
