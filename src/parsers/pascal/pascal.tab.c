...
static void pas_pend_add(const char *f) {
    ...
    g_pas_pend_fields[g_pas_pend_nf++] = strdup(f); g_pas_pend_ptrtarget = NULL; g_pas_pend_arr_ischar = 0; g_pas_pend_ischar = 0; g_pas_pend_isarr = 0; g_pas_pend_istfile = 0; } }
...
{
       0,   798,   798,   814,   815,   818,   821,   822,   825,   826,
     827,   828,   829,   832,   833,   836,   837,   839,   840,   841,
     842,   843,   845,   845,   845,   846,   846,   846,   846,   848,
     849,   851,   853,   854,   855,   856,   857,   857,   858,   859,
     860,   865,   865,   867,   874,   875,   878,   881,   882,   885,
     886,   889,   890,   891,   894,   895,   898,   899,   902,   903,
     905,   907,   908,   909,   909,   913,   913,   917,   917,   923,
     926,   927,   930,   931,   934,   935,   936,   937,   940,   941,
     944,   947,   948,   951,   952,   957,   958,   959,   960,   961,
     962,   963,   964,   965,   966,   967,   970,   971,   974,   980,
     981,   984,   985,   986,   989,  1007,  1015,  1019,  1020,  1023,
    1024,  1027,  1030,  1035,  1036,  1039,  1039,  1049,  1050,  1053,
    1054,  1057,  1058,  1061,  1064,  1067,  1069,  1073,  1076,  1077,
    1084,  1085,  1086,  1087,  1088,  1089,  1090,  1091,  1094,  1095,
    1096,  1097,  1098,  1099,  1102,  1103,  1104,  1105,  1106,  1107,
    1110,  1116,  1117,  1118,  1119,  1120,  1121,  1122,  1123,  1126,
    1127,  1130,  1131
};
#endif
