...
DESCR_t rt_proc_call_epilogue_barrier_γ(DESCR_t frame0, long nsb);
DESCR_t rt_proc_call_epilogue_barrier_ω(long nsb);
...
void rt_pat_prim_land_γ(DESCR_t frame0, long word);
...
int rt_pl_wall_clock_cell(int ms, void *a_cell, struct pl_tr_ctx_s *cx);
