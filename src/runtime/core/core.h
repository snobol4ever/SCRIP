...
int core_icn_int_operand_ok_d(DESCR_t d);
...
typedef enum { TRK_VALUE = 0, TRK_ACCESS, TRK_LABEL, TRK_KEYWORD, TRK_FUNCTION, TRK_CALL, TRK_RETURN } trace_kind_t;
...
void core_icn_bi_pop(icn_bi_rec_t *r);
