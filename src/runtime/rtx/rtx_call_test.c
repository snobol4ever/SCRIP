...
extern void   rt_flat_wire_adopt(void *gw, void *ww, void *rsp, void *fb);
extern void   c_rt_flat_wire_adopt(void *gw, void *ww, void *rsp, void *fb);
...
extern void   rt_pcall_test_wire_set(int idx, void *gw, void *ww, void *rsp, void *fb, void *r12);
extern void   rt_pcall_test_wire_get(int idx, void **gw, void **ww, void **rsp, void **fb, void **r12);
extern void  *rt_pcall_test_snap_buf(void);
extern void   rt_pcall_test_snap_buf_set_all(unsigned char v);
extern void   rt_pcall_test_snap_buf_get(void **gw, void **ww, void **rsp, void **fb, void **r12);
...
static void test_adopt_live(void) {
    ...
    void *gw=(void *)0x1111,*ww=(void *)0x2222,*rsp=(void *)0x3333,*fb=(void *)0x4444;
    /* asm arm */
    rt_pcall_test_wire_null_set();
    rt_flat_wire_adopt(gw, ww, rsp, fb);
    void *agw,*aww,*arsp,*a___,*ar12; rt_pcall_test_wire_get(slot,&agw,&aww,&arsp,&a___,&ar12);
    /* C arm */
    rt_pcall_test_wire_null_set();
    c_rt_flat_wire_adopt(gw, ww, rsp, fb);
    void *cgw,*cww,*crsp,*c___,*cr12; rt_pcall_test_wire_get(slot,&cgw,&cww,&crsp,&c___,&cr12);
    pop();
    n++;
    if (agw!=cgw||aww!=cww||arsp!=crsp||a___!=c___||ar12!=cr12) {
        fails++;
        printf("  FAIL adopt live: asm{gw=%p ww=%p rsp=%p fb=%p r12=%p} c{gw=%p ww=%p rsp=%p fb=%p r12=%p}\n",agw,aww,arsp,a___,ar12,cgw,cww,crsp,c___,cr12);
        return;
    }
    if (agw!=gw||aww!=ww||arsp!=rsp||a___!=fb||ar12!=(void*)0) {
        fails++;
...
static void test_adopt_r12_zeroed(void) {
    ...
    void *gw,*ww,*rsp,*fb,*r12; rt_pcall_test_wire_get(slot,&gw,&ww,&rsp,&fb,&r12);
    pop();
    n++;
...
static void test_adopt_overwrite(void) {
    ...
    pop();
    n++;
    if (gw!=(void*)0xA||ww!=(void*)0xB||rsp!=(void*)0xC||fb!=(void*)0xD) {
...
static void test_snap_live(void) {
    push((void *)0);
    static int gw_target, ww_target, rsp_target, ____target;
    rt_pcall_test_wire_set(rt_pcall_test_top()-1,(void*)&gw_target,(void*)&ww_target,(void*)&rsp_target,(void*)&____target,(void*)0xCAFE);
    /* asm arm */
    rt_pcall_test_snap_buf_set_all(0xAB);
    void *ra = rt_flat_ret_snap();
    void *agw,*aww,*arsp,*a___,*ar12; rt_pcall_test_snap_buf_get(&agw,&aww,&arsp,&a___,&ar12);
    /* C arm */
    rt_pcall_test_snap_buf_set_all(0xCD);
    void *rc = c_rt_flat_ret_snap();
    void *cgw,*cww,*crsp,*c___,*cr12; rt_pcall_test_snap_buf_get(&cgw,&cww,&crsp,&c___,&cr12);
    pop();
    n++;
    ...
    if (agw!=cgw||aww!=cww||arsp!=crsp||a___!=c___||ar12!=cr12) {
        ...
        printf("    asm: gw=%p ww=%p rsp=%p fb=%p r12=%p\n",agw,aww,arsp,a___,ar12);
        printf("    c:   gw=%p ww=%p rsp=%p fb=%p r12=%p\n",cgw,cww,crsp,c___,cr12);
    }
}
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
...
static void test_snap_r12_preserved(void) {
    ...
    rt_flat_ret_snap();
    void *gw,*ww,*rsp,*fb,*r12; rt_pcall_test_snap_buf_get(&gw,&ww,&rsp,&fb,&r12);
    pop();
    n++;
