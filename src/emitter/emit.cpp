...
static int zd_wl_kind(IR_t * nd) {
    ...
    if (op == IR_DEFINE) return 1;   /* AB: self-framing block, zero ζ cells yielded; always admitted transparent -- its own push/pop is its own responsibility, not a spine cell */
