...
#undef RPO_VISITED
    ...
    if (g_emit.zframe_graph) { extern void xa_flat_zframe_epilogue_ω(void); xa_flat_zframe_epilogue_ω(); }   /* ICN-FR-2 CLASS ZF ω: same absolute-unwind shape; reads ω wire from [rbp+kt-16]. */
    else if (_blob_wire) { int _bk = g_emit.flat_frame_bytes;
