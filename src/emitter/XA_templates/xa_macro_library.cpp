/* xa_macro_library.cpp — XA templates for SM macro library open/close banners.
   XA_MACRO_LIBRARY_OPEN: emits the begin banner + .intel_syntax header.
   XA_MACRO_LIBRARY_CLOSE: emits the end banner.
   The driver (codegen_sm_x86 in emit_sm.c) owns the codegen_sm_dispatch loop between them. */
#include <string>
#include "emit_str.h"
extern "C" {
