...
int emit_arbno_rbp(void);   /* ⭐ ARBNO-RBP (Lon 2026-08-14): 1 when the rbp-framed ARBNO arm fires (SCRIP_ARBNO_RBP!=0, default ON per "ALWAYS").  Consulted by zd_k's ARBNO arm (16 -> 32) AND the IR_MATCH_ARBNO drive-case staging into g_emit.op_arbno_rbp — planner and template cannot disagree. */
