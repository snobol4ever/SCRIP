...
static inline int zw_rb_on(void)    { return 1; }   /* MECHANISM-2 UNCONDITIONAL (Lon 2026-08-07 REGIME DELETION): SCRIP_ZW_RB env gate DELETED -- RBP boundary arm for blob-clause programs is the only regime.  Prior default-OFF + killswitch history: git log this line. */
