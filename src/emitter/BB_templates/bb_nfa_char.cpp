/* bb_nfa_char.cpp — TEMPLATE-REVAMP bomb stub (Lon directive 2026-06-02).  The original box body used the
...
extern "C" void bb_nfa_char(IR_t * pBB) {
    (void)pBB;
    bb_emit_x86(x86_bomb("bb_nfa_char: TEMPLATE-REVAMP not yet converted (was offset-table)"));
}
