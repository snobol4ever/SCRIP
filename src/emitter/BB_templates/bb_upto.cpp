/* bb_upto.cpp — TEMPLATE-REVAMP bomb stub (Lon directive 2026-06-02).  The original box body used the
...
extern "C" void bb_upto(IR_t * pBB) {
    (void)pBB;
    bb_emit_x86(x86_bomb("bb_upto: TEMPLATE-REVAMP not yet converted (was offset-table)"));
}
