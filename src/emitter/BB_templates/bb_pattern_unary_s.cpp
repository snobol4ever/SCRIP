...
static std::string bb_pattern_unary_s_str() {
    if (PLATFORM_X86)
        return IF(MEDIUM_TEXT,
         ...
         + (x86("ins2", "mov", "rsi, qword ptr [rip + " + usl("_s") + "]")
         + x86("label", usl("_yml"))
         + x86("ins2", "mov", "cl, byte ptr [rsi]")
         + x86("ins2", "test", "cl, cl")
         + x86("ins2", "je", usl("_ynext"))
         + x86("ins2", "cmp", "cl, dl")
         + x86("ins2", "je", usl("_ystop"))
         + x86("ins1", "inc rsi")
         + x86("ins2", "jmp", usl("_yml")))
         ...
         + x86("ins2", "je", usl("_f"))
         + x86("ins2", "cmp", "cl, dl")
         + x86("ins2", "je", usl("_ahit"))
         + x86("ins1", "inc rsi")
         + x86("ins2", "jmp", usl("_aml")))
             + x86("label", usl("_ahit"))
             + x86("ins1", "inc r14d")
             + x86("ins2", "jmp", "qword ptr [rip + " + usl("_s") + " + 16]")
         ...
         + x86("ins2", "mov", "cl, byte ptr [rsi]")
         + x86("ins2", "test", "cl, cl")
         + x86("ins2", "je", usl("_nok"))
         + x86("ins2", "cmp", "cl, dl")
         + x86("ins2", "je", usl("_f"))
         + x86("ins1", "inc rsi")
         + x86("ins2", "jmp", usl("_nml")))
             + x86("label", usl("_nok"))
             + x86("ins1", "inc r14d")
             + x86("ins2", "jmp", "qword ptr [rip + " + usl("_s") + " + 16]")
         : !strcmp(us_kind(), "SPAN")
         ...
         + x86("ins2", "mov", "cl, byte ptr [rsi]")
         + x86("ins2", "test", "cl, cl")
         + x86("ins2", "je", usl("_sdone"))
         + x86("ins2", "cmp", "cl, dl")
         + x86("ins2", "je", usl("_smore"))
         + x86("ins1", "inc rsi")
         + x86("ins2", "jmp", usl("_sml")))
         ...
         + x86("ins2", "mov", "cl, byte ptr [rsi]")
         + x86("ins2", "test", "cl, cl")
         + x86("ins2", "je", usl("_xnext"))
         + x86("ins2", "cmp", "cl, dl")
         + x86("ins2", "je", usl("_xstop"))
         + x86("ins1", "inc rsi")
         + x86("ins2", "jmp", usl("_xml")))
         ...
         + x86("ins2", "mov", "cl, byte ptr [rsi]")
         + x86("ins2", "test", "cl, cl")
         + x86("ins2", "je", usl("_bnext"))
         + x86("ins2", "cmp", "cl, dl")
         + x86("ins2", "je", usl("_bstop"))
         + x86("ins1", "inc rsi")
         + x86("ins2", "jmp", usl("_bml")))
