/* bb_ref_invariant.cpp — TEMPLATE-REVAMP bomb stub (Lon directive 2026-06-02).  The original box body used the
...
#include "x86_asm.h"
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
extern "C" void bb_ref_invariant(IR_t * pBB) {
    (void)pBB;
    bb_emit_x86(x86_bomb("bb_ref_invariant: TEMPLATE-REVAMP not yet converted (was offset-table)"));
}
