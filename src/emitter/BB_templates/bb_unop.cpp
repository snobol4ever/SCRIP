/* bb_unop.cpp — grouped BB template for Icon value-producing unary operators.
   IBB-9-UNOP (Opus 4.8, 2026-05-29). Handles IR_NEG (-E), IR_POS (+E), IR_NONNULL (\E),
   IR_NULL_TEST (/E), IR_NOT (not E). The flat driver (flat_drive_unop in emit_bb.c) walks
   ...
   (cond of an if/while) point at the IR_IF router (lower_new_If_ag wires cond.γ==cond.ω==IR_IF),
