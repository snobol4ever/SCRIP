/* bb_lit_scalar.cpp — TEMPLATE-REVAMP bomb stub (Lon directive 2026-06-02).  The original box body used the
...
#include "x86_asm.h"
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
extern "C" void bb_lit_scalar(IR_t * pBB) {
    (void)pBB;
    bb_emit_x86(x86_bomb("bb_lit_scalar: TEMPLATE-REVAMP not yet converted (was offset-table)"));
}
