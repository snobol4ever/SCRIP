/* bb_case.cpp — TEMPLATE-REVAMP bomb stub (Lon directive 2026-06-02).  The original box body used the
...
extern "C" void bb_case_store(IR_t * pBB) {
    (void)pBB;
    bb_emit_x86(x86_bomb("bb_case_store: TEMPLATE-REVAMP not yet converted (was offset-table)"));
}
extern "C" void bb_case_gate(IR_t * pBB) {
    (void)pBB;
    bb_emit_x86(x86_bomb("bb_case_gate: TEMPLATE-REVAMP not yet converted (was offset-table)"));
}
