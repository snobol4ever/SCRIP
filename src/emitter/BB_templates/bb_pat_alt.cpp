/* bb_pat_alt.cpp — BB template for IR_PAT_ALT: SNOBOL4 pattern alternation.
   Driver flat_drive_alt (emit_bb.c) populates xa_bb_emit_pair_* with the
   alternation glue labels; this template emits them inline.
