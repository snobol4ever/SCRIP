...
extern int  rt_atom_string_pair(int k0, long i0, const char *s0, int k1, long i1, const char *s1);
...
extern int  rt_copy_term(int k0, long i0, const char *s0, int k1, long i1, const char *s1);
