...
std::string bb_assign_frame() {
    if (PLATFORM_X86) return IF(!g_gvar_flat_chain, x86_bomb("bb_assign_frame: gvar flat-chain only"))
                           ...
                           + x86("mov", RDQ("rcx", 16 + (int) _.op_ival * 16), 6L)
                           + x86("movabs", "rax", (uint64_t) _.op_a_ival_sg)
                           + x86("mov", RDQ("rcx", 16 + (int) _.op_ival * 16 + 8), "rax"))
                           + IF(_.bb_lk == 2,
                             frame_reach("rcx", (int) _.op_dval)
                           + x86("mov", RDQ("rcx", 16 + (int) _.op_ival * 16), 0L)
                           + x86("mov", RDQ("rcx", 16 + (int) _.op_ival * 16 + 8), 0L))
                           + IF(_.bb_lk == 3,
                             frame_reach("rcx", (int) _.op_dval)
                           + x86("mov", RDQ("rcx", 16 + (int) _.op_ival * 16), 1L)
                           ...
                           + IF(_.bb_lk == 5,
                             frame_reach("rax", (int) _.op_a_dval)
                           + x86("mov", "rsi", RDQ("rax", 16 + (int) _.op_a_ival_sg * 16))
                           + x86("mov", "rdi", RDQ("rax", 16 + (int) _.op_a_ival_sg * 16 + 8))
                           + frame_reach("rcx", (int) _.op_dval)
                           + x86("mov", RDQ("rcx", 16 + (int) _.op_ival * 16), "rsi")
                           + x86("mov", RDQ("rcx", 16 + (int) _.op_ival * 16 + 8), "rdi"))
                           + IF(_.bb_lk == 6,
                             frame_reach("rax", (int) _.op_a_dval)
