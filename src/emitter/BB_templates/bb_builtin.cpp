...
extern "C" void rt_write_var(int slot);
extern "C" void rt_write_term_ptr(void *t);
extern "C" void rt_writeq_term_ptr(void *t);
extern "C" void rt_write_canonical_term_ptr(void *t);
extern "C" int  rt_is(int dst_slot, const char *op, int lk, long li, int rk, long ri);
extern "C" int  rt_is_f(int dst_slot, const char *op, int lk, long li, double ld, int rk, long ri, double rd);
extern "C" int  rt_is_eval(void *lhs_bb, void *rhs_bb);
extern "C" int  rt_arith_cmp(const char *op, int k0, long i0, const char *s0, int k1, long i1, const char *s1);
extern "C" int  rt_term_cmp(const char *op, int k0, long i0, const char *s0, int k1, long i1, const char *s1);
...
extern "C" int  rt_univ_term(void *t0, int k1, long i1, const char *s1);
extern "C" int  rt_univ_term_list(int k0, long i0, const char *s0, void *t1);
extern "C" int  rt_univ_term_term(void *t0, void *t1);
extern "C" int  rt_atom_length(int k0, long i0, const char *s0, int k1, long i1, const char *s1);
extern "C" int  rt_upcase_atom(int k0, long i0, const char *s0, int k1, long i1, const char *s1);
extern "C" int  rt_downcase_atom(int k0, long i0, const char *s0, int k1, long i1, const char *s1);
extern "C" int  rt_atom_string_pair(int k0, long i0, const char *s0, int k1, long i1, const char *s1);
extern "C" int  rt_number_string_pair(int num_first, int k0, long i0, const char *s0, int k1, long i1, const char *s1);
extern "C" int  rt_format(int arity, int k0, long i0, const char *s0, int k1, long i1, const char *s1);
extern "C" int  rt_format_term(int arity, int k0, long i0, const char *s0, void *args_term_ptr);
extern "C" int  rt_term_to_atom_term(void *t0, int k1, long i1, const char *s1);
extern "C" int  rt_atomic_list_concat_term(void *list, int arity, int ksep, long isep, const char *ssep, int kres, long ires, const char *sres);
extern "C" int  rt_sort_msort(int do_msort, int k0, long i0, const char *s0, int k1, long i1, const char *s1);
extern "C" int  rt_sort_msort_term(int do_msort, void *t0, int k1, long i1, const char *s1);
extern "C" int  rt_copy_term(int k0, long i0, const char *s0, int k1, long i1, const char *s1);
extern "C" int  rt_copy_term_term(void *t0, int k1, long i1, const char *s1);
extern "C" int  rt_copy_term_terms(void *t0, void *t1);
extern "C" int  rt_nb_setval_term(void *key, void *val);
extern "C" int  rt_nb_getval_term(void *key, int kres, long ires, const char *sres);
extern "C" int  rt_aggregate_all_term(void *tmpl, void *goal, int kres, long ires, const char *sres);
extern "C" int  rt_atom_concat(int k0, long i0, const char *s0, int k1, long i1, const char *s1, int k2, long i2, const char *s2);
extern "C" int  rt_atom_chars_codes(int as_codes, int k0, long i0, const char *s0, int k1, long i1, const char *s1);
extern "C" int  rt_atom_chars_codes_term(int as_codes, int k0, long i0, const char *s0, void *t1);
extern "C" int  rt_char_type(int k0, long i0, const char *s0, const char *ty, int is_compound, int ki, long ii, const char *si);
extern "C" int  rt_numbervars_term(void *t0, long start, int k2, long i2, const char *s2);
extern "C" int  rt_succ(int k0, long i0, const char *s0, int k1, long i1, const char *s1);
extern "C" int  rt_plus(int k0, long i0, const char *s0, int k1, long i1, const char *s1, int k2, long i2, const char *s2);
extern "C" int  rt_findall(void *fs_ptr);
extern "C" int  rt_throw(void *alpha_ptr);}
#include "x86_asm.h"
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
/* PLG-9h (2026-06-01): is the `is/2` RHS evaluable functor one that needs the float evaluator
   rt_is_f? True for the transcendental/float-producing functors (sqrt/sin/.../float/
   ...
   INT when they do (6/2 = 3); rt_is_f makes that liv%riv decision exactly as the mode-2 oracle
   resolve_arith_eval does, so routing `/` here fixes the pre-existing mode-4 integer-division
   miscompile (the integer rt_arith arm gave 7/2 = 3, diverging from m2/m3 = 3.5). A plain
...
/* into its slot, then call rt_compound_build_n(functor_name, N, rsp). For leaves we route to          */
/* rt_node_to_term — same serialized-scalar shape used everywhere in CAT-D-*. Used by the IR_BUILTIN   */
/* ==/\==/@</@>/@=</@>= compound-arg path; the scalar-only CAT-D-9 fast path still handles                */
/* leaf-leaf compares. Both paths use the same op string and rt_term_cmp_terms decides the comparison. */
...
static std::string bb_builtin_str(IR_t * pBB) {
    if (PLATFORM_X86) {
        ...
        if (MEDIUM_BINARY) {
            ...
            /* then route through the quoting writer rt_writeq_term_ptr / rt_write_canonical_    */
            ...
            /* PLR-K-12 (2026-05-29): `Var is Expr` native arm — calls rt_is_eval(lhs_bb, rhs_bb)  */
            ...
            /* TERM_INT or TERM_FLOAT result. Supersedes the scalar rt_is flatten, which was         */
            ...
            /* CAT-D-9 MEDIUM_TEXT block. rt_arith_cmp / rt_term_cmp(op, k0,i0,s0, k1,i1,s1).   */
            ...
            /* rt_type_test(fn, k0, i0, s0): SysV rdi=fn rsi=k0 rdx=i0 rcx=s0 — 4 regs, no stack. */
            ...
            /* functor(Term, Name, Arity) — a0 compound literal → rt_functor_term(t0, k1,i1,s1, k2,i2,s2). */
            ...
            /* arg(N, Term, Arg) — a1 compound literal → rt_arg_term(k0,i0,s0, t1, k2,i2,s2). */
            ...
            /* across the goal build, then rt_aggregate_all_term(tmpl, goal, kres,ires,sres). 5 args */
            ...
            /* hold key in [rsp+0] across value's build, rt_nb_setval_term(key, val). getval: pass    */
            /* result-var scalars, rt_nb_getval_term(key, kres,ires,sres). sub rsp,16 (slot + align). */
            ...
            /* shared 6-scalar arm below cannot carry a tree (k0=IR_STRUCT → rt_node_to_term       */
            ...
            /* nothing); hold arg0 in a stack slot across arg1's build, then rt_copy_term_terms(t0,   */
            /* t1). Scalar arg1 → rt_copy_term_term(t0, k1,i1,s1). Scalar arg0 flows through the      */
            ...
            /* atom_length/upcase_atom/downcase_atom (+string_ aliases) → rt_atom_length/_upcase/      */
            /* _downcase; atom_string/string_to_atom → rt_atom_string_pair; copy_term → rt_copy_term. */
            ...
            /* double-jump-stub bug class — the result var never bound). rt_number_string_pair(num_first,*/
            ...
            /* rt_atom_concat(k0,i0,s0, k1,i1,s1, k2,i2,s2) — 9 scalars: first 6 in regs, last triplet  */
            ...
            /* MEDIUM_BINARY arm. Two paths mirror the TEXT arm: (A) scalar a1 → rt_atom_chars_codes    */
            ...
            /* rt_atom_chars_codes_term(as_codes,k0,i0,s0,Term*) — 5 args, all in regs. Path B uses an   */
            ...
            /* inner var → its (k,i,s) triplet. rt_char_type(k0,i0,s0, ty, is_compound, ki,ii,si):    */
            ...
            /* rt_numbervars_term(t0=rdi, start=rsi, k2=edx, i2=rcx, s2=r8). Std bin-patch tail.      */
            ...
            /* esi=k1 rdx=i1 rcx=s1; rt_term_to_atom_term(t0,k1,i1,s1). sub rsp,16: pl_term_to_string */
            ...
            /* emit_build_compound_term_bin into r8, call rt_format_term(arity,k0,i0,s0, args*).      */
            /* Path A (scalar/absent args1): rt_format(arity,k0,i0,s0, k1,i1,s1) — 7 scalars, s1 on   */
            ...
            /* helper (rt_findall) runs the goal sub-graph, copies the template per solution, builds the  */
            /* cons list, and unifies the result. sub rsp,16 keeps rsp 16-aligned across the call: the */
            /* arm begins with rsp 16-aligned, and rt_findall reaches bb_exec_node→snprintf, whose   */
            ...
            /* rt_succ(k0,i0,s0, k1,i1,s1) — edi/rsi/rdx, ecx/r8/r9, no stack. Was TEXT-only → in      */
            ...
            /* 9-scalar rt_plus(k0,i0,s0, k1,i1,s1, k2,i2,s2) — first 6 in regs, last triplet on the   */
            ...
            /* then rt_atomic_list_concat_term(list, arity, ksep,isep,ssep, kres,ires,sres). 8 args: */
            ...
            /*     via emit_build_compound_term_bin → rsi; rt_sort_msort_term(do_msort, Term*, k1,  */
            /*     i1, s1) with rdi=do_msort rsi=Term* edx=k1 rcx=i1 r8=s1.                            */
            /*   Path A (a0 scalar — IR_LOGICVAR bound to a list): 7-scalar rt_sort_msort(do_msort,   */
            ...
            /* PLR-K-6 (Opus 4.8, 2026-05-29): retract/1 + retractall/1. The rt_retract effect      */
            ...
            /* rt_throw(pBB->α) materializes the ball from the α term subtree (in-process pointer)   */
        ...
        /* then route through the quoting writer rt_writeq_term_ptr / rt_write_canonical_term_ptr    */
        ...
        /* emit_build_compound_term (→ rax → rdi), then rt_atomic_list_concat_term(list, arity, ksep,  */
        ...
        if ((strcmp(fn, "atomic_list_concat") == 0 || strcmp(fn, "concat_atom") == 0)
            ...
            return hdr
                 ...
                 + s_2asm("call", "rt_atomic_list_concat_term@PLT")
                 + s_2asm("add", "rsp, 16")
                 + s_2asm("test", "eax, eax")
                 + s_2asm("je",   _.lbl_ω)
                 + s_2asm("jmp",  _.lbl_γ)
        ...
        /* the PLR-K-12 MEDIUM_BINARY rt_is_eval arm (which passes in-process IR_t* pointers, dead in a */
        ...
        /* string is _.bb_op_lbl (bb_prepare now interns it for both the IR_ARITH and the IR_ATOM pi/e  */
        /* RHS). rt_is_f mirrors resolve_arith_eval's int-vs-float result decision and unifies the      */
        /* result Term into the dst slot in g_resolve_env — the per-activation home the consumer write     */
        /* reads directly. sub rsp,8 keeps 16-alignment across rt_is_f's libm calls (sqrt/pow touch     */
        ...
        /* α=operand, β=NULL, sval=fn-name (interned into _.bb_op_lbl). Reuse rt_is by passing    */
        /* the right-operand kind as -1 sentinel and ri=0 — rt_arith matches unary op names early    */
        ...
        /* via rt_node_to_term, applies the transform, unifies the result into arg1 under a trail    */
        ...
        /* Mapping: string_length → rt_atom_length; string_upper → rt_upcase_atom; string_lower → */
        /* rt_downcase_atom. ZERO new rt helpers — the existing CAT-D-1 ones cover both.              */
        if ((strcmp(fn,"atom_length")==0   || strcmp(fn,"upcase_atom")==0   || strcmp(fn,"downcase_atom")==0
          || strcmp(fn,"string_length")==0 || strcmp(fn,"string_upper")==0  || strcmp(fn,"string_lower")==0)
            && pBB->α && pBB->α->γ) {
            IR_t *a0 = pBB->α, *a1 = a0->γ;
        ...
        /* CAT-D-1 (6 scalars, no stack), different helper (rt_atom_string_pair) because the helper   */
        ...
        /* emit_build_compound_term: its IR_LOGICVARs alias the live env slots (rt_node_to_term writes   */
        /* an unbound var's fresh Term back to g_resolve_env[slot]), so rt_numbervars_term binding each  */
        /* TERM_VAR to '$VAR'(N) via unify mutates the very cells the later write rereads. Hold the term in */
        /* rdi across the start/End loads: rt_numbervars_term(t0=rdi, start=rsi, k2=edx, i2=rcx, s2=r8). */
        ...
        if (strcmp(fn, "numbervars") == 0 && pBB->ival == 3 && pBB->α && pBB->α->γ && pBB->α->γ->γ) {
            ...
            return hdr
                 ...
                 + s_2asm("call", "rt_numbervars_term@PLT")
                 + s_2asm("add", "rsp, 8")
                 + s_2asm("test", "eax, eax")
                 + s_2asm("je",   _.lbl_ω)
                 + s_2asm("jmp",  _.lbl_γ)
        ...
        /* compound arg0 (rt_node_to_term flattens an IR_STRUCT, losing intra-term var-sharing →         */
        ...
        /* fresh Term is written back to its env slot by rt_node_to_term, so a repeated occurrence        */
        /* rereads the SAME Term — sharing preserved, identical to the BINARY twin. If arg1 is ALSO          */
        /* compound, build it too (hold arg0 in a stack slot across arg1's build) then rt_copy_term_      */
        /* terms(t0,t1) — bb_copy_term deep-clones t0 with fresh-var rename and unifies into t1. Scalar      */
        /* arg1 → rt_copy_term_term(t0, k1,i1,s1). sub rsp,16 = the slot + 16B alignment across the       */
        ...
        if (strcmp(fn, "copy_term") == 0 && pBB->α && pBB->α->γ
            ...
            if (a1_compound) {
                b += emit_build_compound_term(a0)
                   ...
                   + s_2asm("call", "rt_copy_term_terms@PLT");
            } else {
                int  k1 = (int)a1->t;
                long i1 = (long)a1->ival;
                char s1lbl[64]; s1lbl[0] = 0;
                ...
                b += emit_build_compound_term(a0)
                   ...
                   + s_2asm("call", "rt_copy_term_term@PLT");
            }
        ...
        /* (rt_copy_term) that calls the static bb_copy_term (deep-clone, fresh-var rename) and       */
        ...
        if ((strcmp(fn,"number_string")==0 || strcmp(fn,"atom_number")==0)
            ...
            return hdr
                 ...
                 + s_2asm("mov", "qword ptr [rsp + 0], rax")
                 + s_2asm("call", "rt_number_string_pair@PLT")
                 + s_2asm("add", "rsp, 16")
                 + s_2asm("test", "eax, eax")
                 + s_2asm("je",   _.lbl_ω)
                 + s_2asm("jmp",  _.lbl_γ)
        ...
        /* esi=k1 rdx=i1 rcx=s1; rt_term_to_atom_term(t0,k1,i1,s1). pl_term_to_string operator-notation */
        ...
        if ((strcmp(fn, "term_to_atom") == 0 || strcmp(fn, "term_string") == 0)
            ...
            return hdr
                 ...
                 + s_2asm("mov rdx,",  emit_fmt("%ld", i1))
                 + (s1lbl[0] ? s_2asm("lea rcx,", emit_fmt("[rip + %s]", s1lbl)) : s_2asm("xor", "ecx, ecx"))
                 + s_2asm("call", "rt_term_to_atom_term@PLT")
                 + s_2asm("add", "rsp, 16")
                 + s_2asm("test", "eax, eax")
                 + s_2asm("je",   _.lbl_ω)
                 + s_2asm("jmp",  _.lbl_γ)
        ...
        if ((strcmp(fn,"atom_concat")==0 || strcmp(fn,"string_concat")==0)
            ...
            return hdr
                 ...
                 + s_2asm("call", "rt_atom_concat@PLT")
                 + s_2asm("add", "rsp, 32")
                 + s_2asm("test", "eax, eax")
                 + s_2asm("je",   _.lbl_ω)
                 + s_2asm("jmp",  _.lbl_γ)
        ...
        /* (A) a1 is a scalar (IR_LOGICVAR or IR_ATOM): 7-scalar call to rt_atom_chars_codes. System V: */
        ...
        /*     call rt_atom_chars_codes_term(as_codes, k0, i0, s0, Term*). System V: rdi=as_codes,    */
          ...
          || strcmp(fn,"string_chars")==0 || strcmp(fn,"string_codes")==0)
            ...
            if (a1->t == IR_STRUCT) {
                ...
                return hdr
                     ...
                     + s_2asm("mov rdx,",  emit_fmt("%ld", i0))
                     + (s0lbl[0] ? s_2asm("lea rcx,", emit_fmt("[rip + %s]", s0lbl)) : s_2asm("xor", "ecx, ecx"))
                     + s_2asm("call", "rt_atom_chars_codes_term@PLT")
                     + s_2asm("add", "rsp, 16")
                     + s_2asm("test", "eax, eax")
                     + s_2asm("je",   _.lbl_ω)
                     + s_2asm("jmp",  _.lbl_γ)
            ...
            return hdr
                 ...
                 + (s1lbl[0] ? s_2asm("lea rax,", emit_fmt("[rip + %s]", s1lbl)) : s_2asm("xor", "eax, eax"))
                 + s_2asm("mov", "qword ptr [rsp + 0], rax")
                 + s_2asm("call", "rt_atom_chars_codes@PLT")
                 + s_2asm("add", "rsp, 16")
                 + s_2asm("test", "eax, eax")
                 + s_2asm("je",   _.lbl_ω)
                 + s_2asm("jmp",  _.lbl_γ)
        ...
        /* rt_type_test(fn, k, i, s) — 4 args, all 4 regs (no stack).  Compound-literal arg (e.g.     */
        /* is_list([1,2,3])) builds Term* via emit_build_compound_term, then calls rt_type_test_term. */
          ...
          || strcmp(fn,"is_list")==0  || strcmp(fn,"ground")==0)) {
            ...
            if (a0->t == IR_STRUCT) {
                return hdr
                     ...
                     + s_2asm("call", "rt_type_test_term@PLT")
                     + s_2asm("add", "rsp, 16")
                     + s_2asm("test", "eax, eax")
                     + s_2asm("je",   _.lbl_ω)
                     + s_2asm("jmp",  _.lbl_γ)
        ...
        /* a1->α = inner var. rt_char_type(k0,i0,s0, ty, is_compound, ki,ii,si): rdi=k0 rsi=i0 rdx=s0  */
        ...
        /* (A) a0 scalar (IR_LOGICVAR bound to a list, future-proofing): 7-scalar call to rt_sort_msort.*/
        ...
        /*     rt_sort_msort_term(do_msort, Term*, k1, i1, s1). System V: rdi=do_msort, rsi=Term*,   */
        ...
        if ((strcmp(fn,"sort")==0 || strcmp(fn,"msort")==0) && pBB->α && pBB->α->γ) {
            ...
            if (a0->t == IR_STRUCT) {
                return hdr
                     ...
                     + s_2asm("call", "rt_sort_msort_term@PLT")
                     + s_2asm("add", "rsp, 16")
                     + s_2asm("test", "eax, eax")
                     + s_2asm("je",   _.lbl_ω)
                     + s_2asm("jmp",  _.lbl_γ)
        ...
        /* into two Term*'s held across the build via a stack slot, then call rt_term_cmp_terms(op,    */
        ...
        if (pBB->α && pBB->β
            ...
            return hdr
                 ...
                 + s_2asm("lea rdi,", emit_fmt("[rip + %s]", op_lbl))
                 + s_2asm("call", "rt_term_cmp_terms@PLT")
                 + s_2asm("add", "rsp, 16")
                 + s_2asm("test", "eax, eax")
                 + s_2asm("je",   _.lbl_ω)
                 + s_2asm("jmp",  _.lbl_γ)
        ...
        /* term-compare (==, \==, @<, @>, @=<, @>= → rt_term_cmp) and arith-compare (=:=, =\=, <,    */
        /* >, <=, >= → rt_arith_cmp). Both have the SAME 7-scalar shape: op-string + 2 × (k,i,s)    */
        ...
        /* Scalar path (no compound literal): pack all args as (k,i,s) triples and call rt_xxx with    */
        /* 9 (functor/arg) or 6 (univ) serializable scalars. Compound-literal path: build Term* via       */
        /* emit_build_compound_term, call rt_xxx_term variant. Helpers do all unification, trail       */
        ...
        /* rt_functor / rt_arg: 9 args = 3 stack args = sub rsp,32 (24B + 8B pad).                  */
        /* rt_functor_term / rt_arg_term: 7 args = 1 stack arg = sub rsp,16 (8B + 8B pad).           */
        /* rt_univ: 6 args = all in registers = sub rsp,8 (just alignment).                             */
        /* rt_univ_term / rt_univ_term_list: 5 args = all in registers = sub rsp,8.                  */
        /* rt_univ_term_term: 2 args = all in registers = sub rsp,8.                                     */
        if (strcmp(fn,"functor")==0 && pBB->ival==3 && pBB->α && pBB->α->γ && pBB->α->γ->γ) {
            IR_t *a0 = pBB->α, *a1 = a0->γ, *a2 = a1->γ;
        ...
        /* PROLOG-BB (2026-05-28): succ/2 — bidirectional. RESOLVE_BI_AB style: pBB->α = arg0 (X),
           pBB->β = arg1 (Y). Flatten each to (k,i,sval) scalars; call rt_succ which mirrors
        ...
        /* PROLOG-BB (2026-05-28): format/1 + format/2 — printf-style emit. Mirror mode-2
           ...
           Path A (scalar args1): rt_format(arity, k0,i0,s0, k1,i1,s1). Used when args1 is a
             variable or atom (format/1 falls here with arity=1 + dummy args1).
           Path B (compound args1): rt_format_term(arity, k0,i0,s0, Term*). Used when args1
        ...
        if (strcmp(fn, "format") == 0 && pBB->α && (pBB->ival == 1 || pBB->ival == 2)) {
            ...
            if (compound1) {
                ...
                return hdr
                     ...
                     + s_2asm("mov rdx,",  emit_fmt("%ld", i0))
                     + (s0lbl[0] ? s_2asm("lea rcx,", emit_fmt("[rip + %s]", s0lbl)) : s_2asm("xor", "ecx, ecx"))
                     + s_2asm("call", "rt_format_term@PLT")
                     + s_2asm("add", "rsp, 16")
                     + s_2asm("test", "eax, eax")
                     + s_2asm("je",   _.lbl_ω)
                     + s_2asm("jmp",  _.lbl_γ)
