...
typedef struct { IR_t * cond; IR_t * then_; IR_t * else_; IR_t * then_root; IR_t * else_root; IR_t * cond_root; } bb_ite_state_t;
...
typedef struct { void * graph_key; int base; int arity; int nlocals; int mark_slot; IR_t * body_head; IR_t * frame_node; void * lblA; void * lblB; } pl_gz_callee_t;
typedef struct { pl_gz_callee_t * callee; int nargs; IR_t * args[2]; } pl_gz_call_state_t;
