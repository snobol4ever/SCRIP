...
int main(int argc, char **argv)
{
    ...
    while (argi < argc && argv[argi][0] == '-' && argv[argi][1] == '-') {
        ...
        else if (strcmp(argv[argi], "--trace")         == 0) { extern long g_rk_trace; g_rk_trace = 2000000000L; argi++; }
        else if (strncmp(argv[argi], "--trace=", 8)    == 0) { extern long g_rk_trace; g_rk_trace = atol(argv[argi] + 8); argi++; }
        else break;
    }
