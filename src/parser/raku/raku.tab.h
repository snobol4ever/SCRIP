...
# define RAKU_YYTOKENTYPE
  enum raku_yytokentype
  {
    ...
    KW_HAS = 304,                  /* KW_HAS  */
    KW_NEW = 305,                  /* KW_NEW  */
    KW_GRAMMAR = 306,              /* KW_GRAMMAR  */
    KW_TOKEN = 307,                /* KW_TOKEN  */
    KW_RULE = 308,                 /* KW_RULE  */
    KW_REGEX = 309,                /* KW_REGEX  */
    OP_FATARROW = 310,             /* OP_FATARROW  */
    OP_RANGE = 311,                /* OP_RANGE  */
    OP_RANGE_EX = 312,             /* OP_RANGE_EX  */
