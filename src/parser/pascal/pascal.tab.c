...
static tree_t *mk_call(const char *name, PNodeList *args) {
    ...
    if (name && (!strcmp(name, "readln") || !strcmp(name, "read")) && args && args->count >= 1) {
        ...
        for (int i = start; i + 1 < args->count; i += 2) {
            ...
            int isc = v && v->t == TT_VAR && v->v.sval && pas_is_charvar(v->v.sval);
...
{
       0,   579,   579,   594,   595,   598,   601,   602,   605,   606,
     607,   608,   609,   612,   613,   616,   617,   619,   620,   621,
     622,   623,   625,   625,   625,   626,   626,   626,   626,   628,
     629,   631,   633,   634,   635,   636,   637,   637,   638,   639,
     641,   641,   643,   650,   651,   654,   657,   658,   661,   662,
     665,   666,   667,   670,   671,   674,   675,   678,   679,   681,
     683,   684,   685,   685,   689,   689,   695,   698,   699,   702,
     703,   706,   707,   708,   709,   712,   713,   716,   719,   720,
     723,   724,   729,   730,   731,   732,   733,   734,   735,   736,
     737,   738,   739,   742,   743,   746,   749,   750,   753,   754,
     755,   758,   784,   785,   788,   789,   792,   793,   796,   799,
     804,   805,   808,   808,   818,   819,   822,   823,   826,   827,
     830,   833,   836,   838,   842,   845,   846,   853,   854,   855,
     856,   857,   858,   859,   860,   863,   864,   865,   866,   867,
     868,   871,   872,   873,   874,   875,   876,   879,   880,   881,
     882,   883,   884,   885,   886,   889,   890
};
#endif
...
tree_t *pascal_parse_string(const char *src) {
    ...
    g_pas_nchararr = 0; g_pas_pend_arr_ischar = 0; g_pas_nrconst = 0; g_pas_nsconst = 0; g_pas_narrrec = 0; g_pas_ncafield = 0; g_pas_narrptr = 0; g_pas_pend_arr_ptrto = NULL;
