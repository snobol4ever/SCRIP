...
struct BB_t *lower_expr_threaded(struct IR_graph_t *bbg, struct tree_t *e,
                                     struct BB_t *γ_in, struct BB_t *ω_in,
                                     struct BB_t **α_out, struct BB_t **β_out);
struct BB_t *lower_expr_threaded_b(struct IR_graph_t *bbg, struct tree_t *e,
                                       struct BB_t *γ_in, struct BB_t *ω_in,
                                       struct BB_t **α_out, struct BB_t **β_out, int bounded);
struct BB_t *gen_leaf(struct BB_t *bb, struct BB_t *γ_in, struct BB_t *ω_in,
                      struct BB_t **α_out, struct BB_t **β_out, int bounded);
BB_t *lower_expr_node(IR_graph_t *bbg, struct tree_t *e);
